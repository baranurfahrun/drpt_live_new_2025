...
import whoantro.RMPenilaianAwalMedisRalanAnak;
...
public final class DlgRawatJalan extends javax.swing.JDialog {
    ...
    private final DefaultTableModel tabMode, tabModeDr, tabModePr, tabModeDrPr,
            ...
            TabModeTindakan, TabModeTindakan2, TabModeTindakan3, TabModeCatatan, tabModePemeriksaanSbar, tabModePemeriksaanTbak, tabModeCatatanPerawatIGD;
    private Connection koneksi = koneksiDB.condb();
    private sekuel Sequel = new sekuel();
    private String asalPemanggil = "";
    ...
    private String aktifkanparsial = "no", kode_poli = "", kd_pj = "", poli_ralan = "No", cara_bayar_ralan = "No",
            ...
            Beban_Jasa_Menejemen_Tindakan_Ralan = "", Utang_Jasa_Menejemen_Tindakan_Ralan = "", poli = "", mode = "", variabel = "";
                ...
                if (akses.getform().equals("DlgRawatJalan")) {
                    if (petugas.getTable().getSelectedRow() != -1) {
                        if (TabRawat.getSelectedIndex() == 1) {
                            ...
                            kdptg3.setText(petugas.getTable().getValueAt(petugas.getTable().getSelectedRow(), 0).toString());
                            TPerawat3.setText(petugas.getTable().getValueAt(petugas.getTable().getSelectedRow(), 1).toString());
                            kdptg3.requestFocus();
                        }
                    }
    ...
    private void initComponents() {
        ...
        BtnStatusLokalis = new widget.Button();
        ...
        jLabel25.setBounds(450, 10, 60, 23);
        ...
        jLabel15.setBounds(610, 10, 50, 23);
        ...
        jLabel28.setBounds(480, 40, 60, 23);

        jLabel26.setText("Plan :");
        jLabel26.setName("jLabel26"); // NOI18N
        panelGlass12.add(jLabel26);
        jLabel26.setBounds(500, 85, 40, 23);
        ...
        TAlergi.setBounds(670, 10, 206, 23);
        ...
        LingkarPerut.setBounds(520, 10, 55, 23);
        ...
        Btn5Soap.setBounds(374, 40, 120, 23);

        BtnBerkasRawat.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/190.png"))); // NOI18N
        BtnBerkasRawat.setMnemonic('4');
        BtnBerkasRawat.setToolTipText("ALt+4");
        BtnBerkasRawat.setName("BtnBerkasRawat"); // NOI18N
        BtnBerkasRawat.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnBerkasRawatActionPerformed(evt);
            }
        });
        panelGlass12.add(BtnBerkasRawat);
        BtnBerkasRawat.setBounds(450, 120, 28, 23);
        ...
        BtnTemplateResep.setBounds(1100, 110, 200, 30);

        BtnTemplatePemberianObat.setForeground(new java.awt.Color(0, 0, 0));
        BtnTemplatePemberianObat.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/Agenda-1-16x16.png"))); // NOI18N
        BtnTemplatePemberianObat.setMnemonic('4');
        BtnTemplatePemberianObat.setText("Template Pemberian Obat");
        ...
        BtnTemplatePemberianObat.setBounds(1100, 140, 200, 30);

        BtnTemplateResep1.setForeground(new java.awt.Color(0, 0, 0));
        BtnTemplateResep1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/Agenda-1-16x16.png"))); // NOI18N
        BtnTemplateResep1.setMnemonic('4');
        BtnTemplateResep1.setText("Input Resep");
        BtnTemplateResep1.setToolTipText("");
        BtnTemplateResep1.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        BtnTemplateResep1.setGlassColor(new java.awt.Color(255, 153, 153));
        BtnTemplateResep1.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        BtnTemplateResep1.setName("BtnTemplateResep1"); // NOI18N
        BtnTemplateResep1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnTemplateResep1ActionPerformed(evt);
            }
        });
        panelGlass12.add(BtnTemplateResep1);
        BtnTemplateResep1.setBounds(910, 190, 160, 30);

        BtnTemplatePemberianObat1.setForeground(new java.awt.Color(0, 0, 0));
        BtnTemplatePemberianObat1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/Agenda-1-16x16.png"))); // NOI18N
        BtnTemplatePemberianObat1.setMnemonic('4');
        BtnTemplatePemberianObat1.setText("Input Resep Pilih Depo");
        BtnTemplatePemberianObat1.setToolTipText("");
        BtnTemplatePemberianObat1.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        BtnTemplatePemberianObat1.setGlassColor(new java.awt.Color(255, 153, 153));
        BtnTemplatePemberianObat1.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        BtnTemplatePemberianObat1.setName("BtnTemplatePemberianObat1"); // NOI18N
        BtnTemplatePemberianObat1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnTemplatePemberianObat1ActionPerformed(evt);
            }
        });
        panelGlass12.add(BtnTemplatePemberianObat1);
        BtnTemplatePemberianObat1.setBounds(1100, 170, 200, 30);
        ...
        BtnPenunjang.setGlassColor(new java.awt.Color(255, 153, 153));
        ...
        BtnPenunjang.setBounds(910, 100, 160, 26);
        ...
        BtnHasilPengobatan.setBounds(910, 130, 160, 26);
        ...
        BtnHasilPengobatan1.setBounds(910, 160, 160, 26);
        ...
        BtnInputLAB.setBounds(1310, 10, 160, 26);
        ...
        BtnInputRAD.setBounds(1310, 50, 160, 26);
        ...
        BtnInputTerimaPasienAntarRuang.setPreferredSize(new java.awt.Dimension(196, 30));
        ...
        BtnInputTerimaPasienAntarRuang.setBounds(1100, 50, 200, 26);
        ...
        BtnInputKonsul1.setGlassColor(new java.awt.Color(255, 153, 153));
        ...
        BtnInputKonsul1.setBounds(1100, 80, 200, 26);
        ...
        BtnTemplatePemberianObat2.setGlassColor(new java.awt.Color(255, 153, 153));
        ...
        panelGlass12.add(BtnTemplatePemberianObat2);
        BtnTemplatePemberianObat2.setBounds(1100, 10, 200, 30);
        ...
        BtnDicom.setBounds(1100, 210, 200, 26);
        ...
        BtnResepRanap.setBounds(910, 220, 160, 26);
        ...
        BtnSuratRujukanBalik.setForeground(new java.awt.Color(0, 0, 0));
        BtnSuratRujukanBalik.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/file-edit-32x32.png"))); // NOI18N
        BtnSuratRujukanBalik.setMnemonic('4');
        BtnSuratRujukanBalik.setText("Surat Rujukan Balik");
        BtnSuratRujukanBalik.setToolTipText("");
        BtnSuratRujukanBalik.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        BtnSuratRujukanBalik.setGlassColor(new java.awt.Color(255, 153, 153));
        BtnSuratRujukanBalik.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        BtnSuratRujukanBalik.setName("BtnSuratRujukanBalik"); // NOI18N
        BtnSuratRujukanBalik.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnSuratRujukanBalikActionPerformed(evt);
            }
        });
        panelGlass12.add(BtnSuratRujukanBalik);
        BtnSuratRujukanBalik.setBounds(840, 250, 160, 26);

        BtnCopyDiagnosa.setForeground(new java.awt.Color(0, 0, 0));
        BtnCopyDiagnosa.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/42a.png"))); // NOI18N
        BtnCopyDiagnosa.setMnemonic('4');
        BtnCopyDiagnosa.setText("Copy Diagnosa");
        BtnCopyDiagnosa.setToolTipText("");
        BtnCopyDiagnosa.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        BtnCopyDiagnosa.setGlassColor(new java.awt.Color(255, 153, 153));
        BtnCopyDiagnosa.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        BtnCopyDiagnosa.setName("BtnCopyDiagnosa"); // NOI18N
        BtnCopyDiagnosa.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnCopyDiagnosaActionPerformed(evt);
            }
        });
        panelGlass12.add(BtnCopyDiagnosa);
        BtnCopyDiagnosa.setBounds(1000, 250, 160, 26);

        BtnStatusLokalis.setForeground(new java.awt.Color(0, 0, 0));
        BtnStatusLokalis.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/Thermometer.png"))); // NOI18N
        BtnStatusLokalis.setMnemonic('4');
        BtnStatusLokalis.setText("Status Lokalis Custom");
        BtnStatusLokalis.setToolTipText("");
        BtnStatusLokalis.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        BtnStatusLokalis.setGlassColor(new java.awt.Color(255, 153, 153));
        BtnStatusLokalis.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        BtnStatusLokalis.setName("BtnStatusLokalis"); // NOI18N
        BtnStatusLokalis.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnStatusLokalisActionPerformed(evt);
            }
        });
        panelGlass12.add(BtnStatusLokalis);
        BtnStatusLokalis.setBounds(1170, 250, 160, 26);

        BtnPeriksa.setForeground(new java.awt.Color(0, 0, 0));
        BtnPeriksa.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/edit_f2.png"))); // NOI18N
        BtnPeriksa.setMnemonic('4');
        BtnPeriksa.setText("Cetak Hasil Lab");
        BtnPeriksa.setToolTipText("");
        BtnPeriksa.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        BtnPeriksa.setGlassColor(new java.awt.Color(255, 153, 153));
        BtnPeriksa.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        ...
        panelGlass12.add(BtnPeriksa);
        BtnPeriksa.setBounds(1310, 90, 160, 26);
        ...
        BtnPeriksaRad.setBounds(1310, 120, 160, 26);

        BtnTemplatePemeriksaan1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/190.png"))); // NOI18N
        ...
        panelGlass12.add(BtnTemplatePemeriksaan1);
        BtnTemplatePemeriksaan1.setBounds(450, 80, 28, 23);
    ...
    // bara
    public void setAsalPemanggil(String asal) {
        this.asalPemanggil = asal;
    }
                ...
                case 3:
                    if ((!TKeluhan.getText().trim().equals("")) || (!TPemeriksaan.getText().trim().equals("")) || (!TSuhu.getText().trim().equals(""))
                        ...
                        if (KdPeg.getText().trim().equals("") || TPegawai.getText().trim().equals("")) {
                            ...
                            /*
                            // Ambil kode penjamin (kd_pj) dari reg_periksa berdasarkan no_rawat
                            String kdPJ = Sequel.cariIsi("SELECT kd_pj FROM reg_periksa WHERE no_rawat=?", TNoRw.getText());

                            // Lakukan validasi hanya jika kode penjamin adalah 'BPJ'
                            if (kdPJ.equalsIgnoreCase("BPJ")) {
                                // Cek apakah SEP sudah terbit (tidak kosong dan tglsep sudah ada)
                                String sep = Sequel.cariIsi("SELECT no_sep FROM bridging_sep WHERE no_rawat=? AND tglsep IS NOT NULL AND no_sep<>''", TNoRw.getText());

                                if (sep.equals("")) {
                                    // Tampilkan pesan bahwa SEP belum terbit
                                    JOptionPane.showMessageDialog(null,
                                            "SOAPIE gagal simpan, SEP BELUM TERBIT untuk pasien:\n"
                                            + "No. RM     : " + TNoRM.getText() + "\n"
                                            + "Nama       : " + TPasien.getText() + "\n"
                                            + "No. Rawat  : " + TNoRw.getText(),
                                            "Validasi SEP", JOptionPane.WARNING_MESSAGE);
                                    return; // hentikan proses simpan
                                }
                            }
                            // bara
                             
                            if ("KasirRalan".equalsIgnoreCase(asalPemanggil) && !"IGD".equalsIgnoreCase(asalPemanggil)) {
                                // Ambil kode penjamin (kd_pj) dari reg_periksa berdasarkan no_rawat
                                String kdPJ = Sequel.cariIsi("SELECT kd_pj FROM reg_periksa WHERE no_rawat=?", TNoRw.getText());
                                ...
                                if (kdPJ.equalsIgnoreCase("BPJ")) {
                                    // Cek apakah SEP sudah terbit (tidak kosong dan tglsep sudah ada)
                                    String sep = Sequel.cariIsi(
                                            "SELECT no_sep FROM bridging_sep WHERE no_rawat=? AND tglsep IS NOT NULL AND no_sep<>''",
                                            TNoRw.getText()
                                    );
                ...
                case 3:
                    if ((!TKeluhan.getText().trim().equals("")) || (!TPemeriksaan.getText().trim().equals("")) || (!TSuhu.getText().trim().equals(""))
                        ...
                        if (KdPeg.getText().trim().equals("") || TPegawai.getText().trim().equals("")) {
                            ...
                            /*
                            if ("KasirRalan".equalsIgnoreCase(asalPemanggil) && !"IGD".equalsIgnoreCase(asalPemanggil)) {
                                // Ambil kode penjamin (kd_pj) dan kode poli (kd_poli) dari reg_periksa berdasarkan no_rawat
                                String kdPJ = Sequel.cariIsi("SELECT kd_pj FROM reg_periksa WHERE no_rawat=?", TNoRw.getText());
                                String kdPoli = Sequel.cariIsi("SELECT kd_poli FROM reg_periksa WHERE no_rawat=?", TNoRw.getText());

                                // Lakukan validasi hanya jika kode penjamin adalah 'BPJ' DAN bukan poli 'IGDP'
                                if (kdPJ.equalsIgnoreCase("BPJ") && !kdPoli.equalsIgnoreCase("IGDP")) {
                                    // Cek apakah SEP sudah terbit (tidak kosong dan tglsep sudah ada)
                                    String sep = Sequel.cariIsi(
                                            "SELECT no_sep FROM bridging_sep WHERE no_rawat=? AND tglsep IS NOT NULL AND no_sep<>''",
                                            TNoRw.getText()
                            ...
                            if ("KasirRalan".equalsIgnoreCase(asalPemanggil) && !"IGD".equalsIgnoreCase(asalPemanggil)) {
                                ...
                                // Null-safe: pastikan tidak error jika hasil query null
                                kdPJ = (kdPJ == null) ? "" : kdPJ.trim();
                                kdPoli = (kdPoli == null) ? "" : kdPoli.trim();

                                // Lakukan validasi hanya jika kode penjamin adalah 'BPJ' DAN bukan poli IGD/IGDP/IGDK/UGD
                                if (kdPJ.equalsIgnoreCase("BPJ")
                                        && !kdPoli.equalsIgnoreCase("IGD")
                                        && !kdPoli.equalsIgnoreCase("IGDP")
                                        && !kdPoli.equalsIgnoreCase("IGDK")
                                        && !kdPoli.equalsIgnoreCase("UGD")) {
                            ...
                            System.out.println("Validasi SEP - Penjamin: " + kdPJ + ", Poli: " + kdPoli);
                            if (kdPJ.equalsIgnoreCase("BPJ") && kdPoli.equalsIgnoreCase("IGDP")) {
                                System.out.println("✓ Validasi SEP dilewati untuk poli IGDP");
                            }
                        }
...
case 4:
                ...
                case 9:
                    ...
                    break;
                case 10:
                    if ((!kdptg3.getText().trim().equals("")) && (!TPerawat3.getText().trim().equals("")) && (!Catatan1.getText().trim().equals(""))) {
            ...
            case 10:
                ...
                if (tbCatatanPerawatIGD.getSelectedRow() > -1) {
                    if (akses.getkode().equals("Admin Utama")) {
                        ...
                        if (kdptg3.getText().equals(tbCatatanPerawatIGD.getValueAt(tbCatatanPerawatIGD.getSelectedRow(), 9).toString())) {
                            hapusCatatanPerawatIGD();
                        } else {
...
private void BtnEditKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnEditKeyPressed
    ...
    private void BtnBerkasRawatActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnBerkasRawatActionPerformed
        if (TPasien.getText().trim().equals("") || TNoRw.getText().trim().equals("")) {
            JOptionPane.showMessageDialog(null, "Maaf, Silahkan anda pilih dulu dengan menklik data pada table...!!!");
            TCari.requestFocus();
        } else if (TPegawai.getText().trim().equals("") || KdPeg.getText().trim().equals("")) {
    ...
    }//GEN-LAST:event_BtnBerkasRawatActionPerformed
    ...
    private void BtnTemplateResep1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnTemplateResep1ActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_BtnTemplateResep1ActionPerformed

    private void BtnTemplatePemberianObat1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnTemplatePemberianObat1ActionPerformed
        if (TNoRw.getText().trim().equals("")) {
            JOptionPane.showMessageDialog(null, "Maaf, Silahkan anda pilih dulu dengan menklik data pada table...!!!");
            TCari.requestFocus();
        } else {
    ...
    }//GEN-LAST:event_BtnTemplatePemberianObat1ActionPerformed
    ...
    private void kdptg3KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_kdptg3KeyPressed
        if (evt.getKeyCode() == KeyEvent.VK_PAGE_DOWN) {
    ...
    }//GEN-LAST:event_kdptg3KeyPressed
    ...
    private void tbCatatanPerawatIGDMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbCatatanPerawatIGDMouseClicked
    ...
    }//GEN-LAST:event_tbCatatanPerawatIGDMouseClicked

    private void tbCatatanPerawatIGDKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_tbCatatanPerawatIGDKeyReleased
        if (tabModeCatatanPerawatIGD.getRowCount() != 0) {
            if ((evt.getKeyCode() == KeyEvent.VK_ENTER) || (evt.getKeyCode() == KeyEvent.VK_UP) || (evt.getKeyCode() == KeyEvent.VK_DOWN)) {
                try {
                    getDataCatatanPerawatIGD();
    ...
    }//GEN-LAST:event_tbCatatanPerawatIGDKeyReleased

    private void Scroll17MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_Scroll17MouseClicked
        // TODO add your handling code here:
    }//GEN-LAST:event_Scroll17MouseClicked
    ...
    private void BtnSoapDokter1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSoapDokter1ActionPerformed
        akses.setform("DlgRawatJalan");
    ...
    }//GEN-LAST:event_BtnSoapDokter1ActionPerformed
    ...
    private void BtnSuratRujukanBalikActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSuratRujukanBalikActionPerformed
        if (TNoRw.getText().trim().equals("")) {
            JOptionPane.showMessageDialog(null, "Maaf, Silahkan anda pilih dulu dengan menklik data pada table...!!!");
            TCari.requestFocus();
        } else {
    ...
    }//GEN-LAST:event_BtnSuratRujukanBalikActionPerformed

    private void BtnCopyDiagnosaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnCopyDiagnosaActionPerformed
        if (TPasien.getText().trim().equals("") || TNoRw.getText().trim().equals("")) {
            JOptionPane.showMessageDialog(null, "Maaf, Silahkan anda pilih dulu dengan menklik data pada table...!!!");
            TCari.requestFocus();
            /*   } else if (TPegawai.getText().trim().equals("") || KdPeg.getText().trim().equals("")) {
    ...
    }//GEN-LAST:event_BtnCopyDiagnosaActionPerformed

    private void BtnStatusLokalisActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnStatusLokalisActionPerformed
        DlgMarkingImageSoapRalan form = new DlgMarkingImageSoapRalan(null, false);
        form.setNoRw(TNoRw.getText());
        form.setVisible(true);

    }//GEN-LAST:event_BtnStatusLokalisActionPerformed
    ...
    private void BtnLayananKedokteranFisikActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnLayananKedokteranFisikActionPerformed
        if (TPasien.getText().trim().equals("") || TNoRw.getText().trim().equals("")) {
            JOptionPane.showMessageDialog(null, "Maaf, Silahkan anda pilih dulu dengan menklik data pada table...!!!");
            TCari.requestFocus();
        } else {
    ...
    }//GEN-LAST:event_BtnLayananKedokteranFisikActionPerformed
...
public void windowClosing(java.awt.event.WindowEvent e) {
    ...
    private widget.Button BtnBerkasRawat;
    ...
    private widget.Button BtnStatusLokalis;
    ...
    private widget.Button BtnTemplateResep1;
    ...
    public widget.TextArea TKeluhan;
    ...
    public void isCek() {
        ...
        BtnBerkasRawat.setEnabled(akses.gettemplate_pemeriksaan());
...
//        } else {
        ...
        diagnosa.isCek();
        diagnosa.setDokter(KdPeg.getText(), Valid.SetTgl(DTPTgl.getSelectedItem() + ""), cmbJam.getSelectedItem() + ":" + cmbMnt.getSelectedItem() + ":" + cmbDtk.getSelectedItem(), TNoRw.getText(), TNoRM.getText());
...
//                            + "order by catatan_keperawatan_ralan.tanggal");
    ...
    private void hapusCatatanPerawatIGD() {
        if (Sequel.queryu2tf("delete from catatan_keperawatan_ralan where tanggal=? and jam=? and no_rawat=?", 3, new String[]{
            tbCatatanPerawatIGD.getValueAt(tbCatatanPerawatIGD.getSelectedRow(), 6).toString(), tbCatatanPerawatIGD.getValueAt(tbCatatanPerawatIGD.getSelectedRow(), 7).toString(), tbCatatanPerawatIGD.getValueAt(tbCatatanPerawatIGD.getSelectedRow(), 0).toString()
        }) == true) {
            tampilCatatanPerawatIGD();
//            emptTeks();
    ...
    private void gantiCatatanPerawatIGD() {
        Sequel.mengedit("catatan_keperawatan_ralan", "tanggal=? and jam=? and no_rawat=?", "no_rawat=?,tanggal=?,jam=?,uraian=?,nip=?", 8, new String[]{
            TNoRw.getText(), Valid.SetTgl(DTPTgl.getSelectedItem() + ""), cmbJam.getSelectedItem() + ":" + cmbMnt.getSelectedItem() + ":" + cmbDtk.getSelectedItem(),
            Catatan1.getText(), kdptg3.getText(), tbCatatanPerawatIGD.getValueAt(tbCatatanPerawatIGD.getSelectedRow(), 6).toString(), tbCatatanPerawatIGD.getValueAt(tbCatatanPerawatIGD.getSelectedRow(), 7).toString(),
...
//            TPerawat3.setText(tbCatatanPerawatIGD.getValueAt(tbCatatanPerawatIGD.getSelectedRow(),10).toString());
            ...
            cmbJam.setSelectedItem(tbCatatanPerawatIGD.getValueAt(tbCatatanPerawatIGD.getSelectedRow(), 7).toString().substring(0, 2));
            cmbMnt.setSelectedItem(tbCatatanPerawatIGD.getValueAt(tbCatatanPerawatIGD.getSelectedRow(), 7).toString().substring(3, 5));
            cmbDtk.setSelectedItem(tbCatatanPerawatIGD.getValueAt(tbCatatanPerawatIGD.getSelectedRow(), 7).toString().substring(6, 8));
