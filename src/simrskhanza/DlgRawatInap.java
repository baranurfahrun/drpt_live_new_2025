...
import bridging.OrthancViewerHybridSplitSOAPIERanap;
...
import inventory.DlgTemplatePemberianObatRanap;
...
import permintaan.DlgPermintaanKonsul;
...
import rekammedis.AsesmenNyeriPasienInfantNIPS;
import rekammedis.CustomDerajatKetergantunganAnak;
import rekammedis.CustomFormKriteriaDiagnosisMalnutrisi;
import rekammedis.CustomFormTatalaksanaPasienMalnutrisi;
import rekammedis.DlgSOAPOld;
import rekammedis.DlgTBAK;
import rekammedis.EWSBalanceCairan;
import rekammedis.KonsultasiInternal;
import rekammedis.KonsultasiJawab;
import rekammedis.MasterCariTemplateSOAPIE;
import rekammedis.MasterCariTemplateSOAPIEPerawat;
import rekammedis.RM73MonitoringNyeri;
import rekammedis.RMAsesmenNyeriPasienDewasaAnakFLACC;
import rekammedis.RMAsesmenNyeriPasienNeonatusInfant;
...
import rekammedis.RMFormulirDokumentasiEkstravasasiObatSitostatika;
...
import rekammedis.RMLembarObservasiEkstravasasi;
...
import rekammedis.RMPenatalaksanaanKegawatdaruratanEksravasasi;
...
import rekammedis.RMPenilaianAwalRisikoJatuhNeonatus;
import rekammedis.RMPenilaianFisioterapi;
import rekammedis.RMPenilaianKorbanKekerasan;
import rekammedis.RMPenilaianLanjutanMonitoringRisikoJatuhDewasa;
...
public final class DlgRawatInap extends javax.swing.JDialog {
    ...
    private OrthancViewerHybridSplitSOAPIERanap dicomViewer = new OrthancViewerHybridSplitSOAPIERanap(null, false);
    ...
    public DlgRawatInap(java.awt.Frame parent, boolean modal) {
        ...
        tabModePemeriksaanTbak = new DefaultTableModel(null, new Object[]{
            "P", "No.Rawat", "No.R.M.", "Nama Pasien", "Tgl.Rawat", "Jam",
            "Instruksi", "Background", "Assesment", "Recommendation", "NIP", "Dokter/Paramedis", "Profesi/Jabatan", "Status Verifikasi", "Kode Dokter", "Nama Dokter"}) {
            @Override
            public boolean isCellEditable(int rowIndex, int colIndex) {
                boolean a = false;
                if (colIndex == 0) {
        ...
        soapterakhiradime.addWindowListener(new WindowListener() {
            @Override
            public void windowOpened(WindowEvent e) {
            }
            ...
            @Override
            public void windowClosed(WindowEvent e) {
                if (soapterakhiradime.getTable().getSelectedRow() != -1) {
                    Asesmen.setText(soapterakhiradime.getTable().getValueAt(soapterakhiradime.getTable().getSelectedRow(), 2).toString());
                    Diagnosis.setText(soapterakhiradime.getTable().getValueAt(soapterakhiradime.getTable().getSelectedRow(), 3).toString());
                    Intervensi.setText(soapterakhiradime.getTable().getValueAt(soapterakhiradime.getTable().getSelectedRow(), 4).toString());
                    Monitoring.setText(soapterakhiradime.getTable().getValueAt(soapterakhiradime.getTable().getSelectedRow(), 5).toString());
                    Evaluasi.setText(soapterakhiradime.getTable().getValueAt(soapterakhiradime.getTable().getSelectedRow(), 6).toString());
                    Instruksi.setText(soapterakhiradime.getTable().getValueAt(soapterakhiradime.getTable().getSelectedRow(), 7).toString());
        ...
        templatesoapieperawat.addWindowListener(new WindowListener() {
            ...
            public void windowClosed(WindowEvent e) {
                if (templatesoapieperawat.getTable().getSelectedRow() != -1) {
                    TKeluhan.setText(templatesoapieperawat.getTable().getValueAt(templatesoapieperawat.getTable().getSelectedRow(), 1).toString());
                    TPemeriksaan.setText(templatesoapieperawat.getTable().getValueAt(templatesoapieperawat.getTable().getSelectedRow(), 2).toString());
                    TPenilaian.setText(templatesoapieperawat.getTable().getValueAt(templatesoapieperawat.getTable().getSelectedRow(), 3).toString());
                    TindakLanjut.setText(templatesoapieperawat.getTable().getValueAt(templatesoapieperawat.getTable().getSelectedRow(), 4).toString());
                    TInstruksi.setText(templatesoapieperawat.getTable().getValueAt(templatesoapieperawat.getTable().getSelectedRow(), 5).toString());
                    TEvaluasi.setText(templatesoapieperawat.getTable().getValueAt(templatesoapieperawat.getTable().getSelectedRow(), 6).toString());
            ...
            public void windowClosed(WindowEvent e) {
                if (akses.getform().equals("DlgRawatJalan")) {
                    if (pegawaiadime.getTable().getSelectedRow() != -1) {
                        ...
                        KdPetugas.setText(pegawaiadime.getTable().getValueAt(pegawaiadime.getTable().getSelectedRow(), 0).toString());
                        NmPetugas.setText(pegawaiadime.getTable().getValueAt(pegawaiadime.getTable().getSelectedRow(), 1).toString());
                ...
                if (akses.getform().equals("DlgRawatInap")) {
                    if (perawatan.dokter.getTable().getSelectedRow() != -1) {
                        if (TabRawat.getSelectedIndex() == 0) {
                            ...
                            KdDok3.setText(perawatan.dokter.getTable().getValueAt(perawatan.dokter.getTable().getSelectedRow(), 0).toString());
                            TDokter3.setText(perawatan.dokter.getTable().getValueAt(perawatan.dokter.getTable().getSelectedRow(), 1).toString());
                            KdDok3.requestFocus();
                        }
                    }
                }
    ...
    private void initComponents() {
        ...
        BtnVerifSbar5 = new widget.Button();
        ...
        BtnRiwayatKonsulDPJP = new widget.Button();
        BtnRiwayatSBAR = new widget.Button();
        BtnStatusVerifikasiSBAR = new widget.Button();
        BtnKonsulDPJP = new widget.Button();
        BtnGrafikTTV = new widget.Button();
        BtnDicom = new widget.Button();
        BtnValidasiSbar1 = new widget.Button();
        ...
        BtnSoapPerawat = new widget.Button();
        BtnHandOver = new widget.Button();
        BtnPeriksaLab = new widget.Button();
        BtnPeriksaRad = new widget.Button();
        BtnJawabKonsulDPJP1 = new widget.Button();
        Btn5Soap4 = new widget.Button();
        ...
        RMPenilaianAwalKeperawatanRanapNeonatus = new widget.Button();
        ...
        jLabel66.setText("No SEP:");
        jLabel66.setName("jLabel66"); // NOI18N
        panelGlass10.add(jLabel66);

        NoSEP.setHighlighter(null);
        NoSEP.setName("NoSEP"); // NOI18N
        NoSEP.setPreferredSize(new java.awt.Dimension(273, 23));
        NoSEP.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                NoSEPKeyPressed(evt);
            }
        });
        panelGlass10.add(NoSEP);

        jLabel106.setText("Hak Kelas:");
        jLabel106.setName("jLabel106"); // NOI18N
        panelGlass10.add(jLabel106);

        Kelas.setHighlighter(null);
        Kelas.setName("Kelas"); // NOI18N
        Kelas.setPreferredSize(new java.awt.Dimension(100, 23));
        Kelas.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                KelasKeyPressed(evt);
            }
        });
        panelGlass10.add(Kelas);
        ...
        Btn5Soap.setBounds(440, 120, 28, 23);
        ...
        BtnInputKonsul.setBounds(1080, 120, 160, 30);
        ...
        BtnVerifikasiSOAP.setBounds(1080, 60, 160, 30);
        ...
        BtnInputJadwalOP1.setBounds(1070, 90, 160, 30);
        ...
        BtnTemplateResep.setBounds(1080, 0, 160, 30);

        BtnTemplatePemberianObat.setForeground(new java.awt.Color(0, 0, 0));
        BtnTemplatePemberianObat.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/ICO24.png"))); // NOI18N
        BtnTemplatePemberianObat.setMnemonic('4');
        BtnTemplatePemberianObat.setText("Template Obat");
        BtnTemplatePemberianObat.setToolTipText("");
        BtnTemplatePemberianObat.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        BtnTemplatePemberianObat.setGlassColor(new java.awt.Color(255, 153, 153));
        BtnTemplatePemberianObat.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        BtnTemplatePemberianObat.setName("BtnTemplatePemberianObat"); // NOI18N
        BtnTemplatePemberianObat.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnTemplatePemberianObatActionPerformed(evt);
            }
        });
        panelGlass12.add(BtnTemplatePemberianObat);
        BtnTemplatePemberianObat.setBounds(1080, 30, 160, 30);

        BtnBalanceCairan.setForeground(new java.awt.Color(0, 0, 0));
        BtnBalanceCairan.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/Add patient.png"))); // NOI18N
        BtnBalanceCairan.setMnemonic('4');
        BtnBalanceCairan.setText("Balance Cairan");
        BtnBalanceCairan.setToolTipText("");
        BtnBalanceCairan.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        BtnBalanceCairan.setGlassColor(new java.awt.Color(255, 153, 153));
        BtnBalanceCairan.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        BtnBalanceCairan.setName("BtnBalanceCairan"); // NOI18N
        BtnBalanceCairan.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnBalanceCairanActionPerformed(evt);
            }
        });
        panelGlass12.add(BtnBalanceCairan);
        BtnBalanceCairan.setBounds(1080, 150, 160, 30);

        BtnVerifSbar5.setForeground(new java.awt.Color(0, 0, 0));
        BtnVerifSbar5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/attachment.png"))); // NOI18N
        BtnVerifSbar5.setMnemonic('4');
        BtnVerifSbar5.setText("Riwayat Perawatan");
        BtnVerifSbar5.setToolTipText("ALt+4");
        BtnVerifSbar5.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        BtnVerifSbar5.setGlassColor(new java.awt.Color(0, 255, 0));
        BtnVerifSbar5.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        BtnVerifSbar5.setName("BtnVerifSbar5"); // NOI18N
        BtnVerifSbar5.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnVerifSbar5ActionPerformed(evt);
            }
        });
        panelGlass12.add(BtnVerifSbar5);
        BtnVerifSbar5.setBounds(910, 0, 160, 26);
        ...
        Btn5Soap1.setGlassColor(new java.awt.Color(0, 255, 0));
        ...
        Btn5Soap1.setBounds(910, 30, 160, 26);
        ...
        Btn5Soap2.setGlassColor(new java.awt.Color(0, 255, 0));
        ...
        Btn5Soap2.setBounds(910, 60, 160, 26);

        BtnPenunjang.setForeground(new java.awt.Color(0, 0, 0));
        BtnPenunjang.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/TestTubes.png"))); // NOI18N
        BtnPenunjang.setMnemonic('4');
        BtnPenunjang.setText("Riwayat Penunjang");
        BtnPenunjang.setToolTipText("");
        BtnPenunjang.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        BtnPenunjang.setGlassColor(new java.awt.Color(0, 255, 0));
        ...
        panelGlass12.add(BtnPenunjang);
        BtnPenunjang.setBounds(910, 90, 160, 26);

        BtnHasilPengobatan.setForeground(new java.awt.Color(0, 0, 0));
        ...
        BtnHasilPengobatan.setGlassColor(new java.awt.Color(0, 255, 0));
        ...
        BtnHasilPengobatan.setBounds(910, 120, 160, 26);

        BtnHasilPengobatan1.setForeground(new java.awt.Color(0, 0, 0));
        ...
        BtnHasilPengobatan1.setGlassColor(new java.awt.Color(0, 255, 0));
        ...
        BtnHasilPengobatan1.setBounds(910, 150, 160, 26);

        BtnRiwayatKonsulDPJP.setForeground(new java.awt.Color(0, 0, 0));
        BtnRiwayatKonsulDPJP.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/add_to_folder.png"))); // NOI18N
        BtnRiwayatKonsulDPJP.setMnemonic('4');
        BtnRiwayatKonsulDPJP.setText("Riwayat Konsul DPJP");
        BtnRiwayatKonsulDPJP.setToolTipText("ALt+4");
        BtnRiwayatKonsulDPJP.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        BtnRiwayatKonsulDPJP.setGlassColor(new java.awt.Color(0, 255, 0));
        BtnRiwayatKonsulDPJP.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        BtnRiwayatKonsulDPJP.setMaximumSize(new java.awt.Dimension(124, 30));
        BtnRiwayatKonsulDPJP.setMinimumSize(new java.awt.Dimension(124, 30));
        BtnRiwayatKonsulDPJP.setName("BtnRiwayatKonsulDPJP"); // NOI18N
        BtnRiwayatKonsulDPJP.setPreferredSize(new java.awt.Dimension(124, 30));
        BtnRiwayatKonsulDPJP.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnRiwayatKonsulDPJPActionPerformed(evt);
            }
        });
        panelGlass12.add(BtnRiwayatKonsulDPJP);
        BtnRiwayatKonsulDPJP.setBounds(910, 180, 160, 26);

        BtnRiwayatSBAR.setForeground(new java.awt.Color(0, 0, 0));
        BtnRiwayatSBAR.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/History.png"))); // NOI18N
        BtnRiwayatSBAR.setMnemonic('4');
        BtnRiwayatSBAR.setText("Riwayat SBAR");
        BtnRiwayatSBAR.setToolTipText("ALt+4");
        BtnRiwayatSBAR.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        BtnRiwayatSBAR.setGlassColor(new java.awt.Color(0, 255, 0));
        BtnRiwayatSBAR.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        BtnRiwayatSBAR.setMaximumSize(new java.awt.Dimension(124, 30));
        BtnRiwayatSBAR.setMinimumSize(new java.awt.Dimension(124, 30));
        BtnRiwayatSBAR.setName("BtnRiwayatSBAR"); // NOI18N
        BtnRiwayatSBAR.setPreferredSize(new java.awt.Dimension(124, 30));
        BtnRiwayatSBAR.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnRiwayatSBARActionPerformed(evt);
            }
        });
        panelGlass12.add(BtnRiwayatSBAR);
        BtnRiwayatSBAR.setBounds(910, 210, 160, 26);

        BtnStatusVerifikasiSBAR.setForeground(new java.awt.Color(0, 0, 0));
        BtnStatusVerifikasiSBAR.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/peminjaman.png"))); // NOI18N
        BtnStatusVerifikasiSBAR.setMnemonic('4');
        BtnStatusVerifikasiSBAR.setText("Status Verifikasi SBAR");
        BtnStatusVerifikasiSBAR.setToolTipText("ALt+4");
        BtnStatusVerifikasiSBAR.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        BtnStatusVerifikasiSBAR.setGlassColor(new java.awt.Color(0, 0, 255));
        BtnStatusVerifikasiSBAR.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        BtnStatusVerifikasiSBAR.setName("BtnStatusVerifikasiSBAR"); // NOI18N
        BtnStatusVerifikasiSBAR.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnStatusVerifikasiSBARActionPerformed(evt);
            }
        });
        panelGlass12.add(BtnStatusVerifikasiSBAR);
        BtnStatusVerifikasiSBAR.setBounds(910, 280, 160, 26);

        BtnKonsulDPJP.setForeground(new java.awt.Color(0, 0, 0));
        BtnKonsulDPJP.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/whatsapp (1).png"))); // NOI18N
        BtnKonsulDPJP.setMnemonic('4');
        BtnKonsulDPJP.setText("Konsul DPJP");
        BtnKonsulDPJP.setToolTipText("ALt+4");
        BtnKonsulDPJP.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        BtnKonsulDPJP.setGlassColor(new java.awt.Color(0, 0, 255));
        ...
        panelGlass12.add(BtnKonsulDPJP);
        BtnKonsulDPJP.setBounds(1250, 160, 160, 26);
        ...
        BtnGrafikTTV.setBounds(1080, 180, 160, 30);

        BtnDicom.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/XRay.png"))); // NOI18N
        ...
        BtnDicom.setBounds(1250, 0, 200, 26);

        BtnValidasiSbar1.setForeground(new java.awt.Color(0, 0, 0));
        BtnValidasiSbar1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/peminjaman.png"))); // NOI18N
        BtnValidasiSbar1.setMnemonic('4');
        BtnValidasiSbar1.setText("Validasi SBAR");
        BtnValidasiSbar1.setToolTipText("ALt+4");
        BtnValidasiSbar1.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        BtnValidasiSbar1.setGlassColor(new java.awt.Color(0, 0, 255));
        BtnValidasiSbar1.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        BtnValidasiSbar1.setName("BtnValidasiSbar1"); // NOI18N
        BtnValidasiSbar1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnValidasiSbar1ActionPerformed(evt);
            }
        });
        panelGlass12.add(BtnValidasiSbar1);
        BtnValidasiSbar1.setBounds(910, 240, 160, 26);
        ...
        BtnAsuhanKeperawatan.setGlassColor(new java.awt.Color(255, 153, 153));
        ...
        BtnAsuhanKeperawatan.setBounds(1250, 40, 200, 26);
        ...
        ChkTemplatePerawat.addItemListener(new java.awt.event.ItemListener() {
            public void itemStateChanged(java.awt.event.ItemEvent evt) {
                ChkTemplatePerawatItemStateChanged(evt);
            }
        });
        panelGlass12.add(ChkTemplatePerawat);
        ChkTemplatePerawat.setBounds(610, 250, 23, 23);

        BtnSoapPerawat.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/Surgeon SH.png"))); // NOI18N
        BtnSoapPerawat.setMnemonic('4');
        BtnSoapPerawat.setText("Buka Template SOAP Perawat");
        BtnSoapPerawat.setToolTipText("");
        BtnSoapPerawat.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        BtnSoapPerawat.setGlassColor(new java.awt.Color(255, 153, 153));
        BtnSoapPerawat.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        BtnSoapPerawat.setName("BtnSoapPerawat"); // NOI18N
        BtnSoapPerawat.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnSoapPerawatActionPerformed(evt);
            }
        });
        panelGlass12.add(BtnSoapPerawat);
        BtnSoapPerawat.setBounds(630, 250, 200, 26);
        ...
        BtnHandOver.setBounds(1250, 70, 200, 26);

        BtnPeriksaLab.setForeground(new java.awt.Color(0, 0, 0));
        BtnPeriksaLab.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/edit_f2.png"))); // NOI18N
        BtnPeriksaLab.setMnemonic('4');
        BtnPeriksaLab.setText("Cetak Hasil Lab");
        BtnPeriksaLab.setToolTipText("");
        BtnPeriksaLab.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        BtnPeriksaLab.setGlassColor(new java.awt.Color(255, 153, 153));
        ...
        BtnPeriksaLab.setBounds(1250, 100, 200, 26);

        BtnPeriksaRad.setForeground(new java.awt.Color(0, 0, 0));
        BtnPeriksaRad.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/edit_f2.png"))); // NOI18N
        BtnPeriksaRad.setMnemonic('4');
        BtnPeriksaRad.setText("Cetak Hasil Rad");
        BtnPeriksaRad.setToolTipText("");
        BtnPeriksaRad.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        BtnPeriksaRad.setGlassColor(new java.awt.Color(255, 153, 153));
        ...
        panelGlass12.add(BtnPeriksaRad);
        BtnPeriksaRad.setBounds(1250, 130, 190, 26);

        BtnJawabKonsulDPJP1.setForeground(new java.awt.Color(0, 0, 0));
        BtnJawabKonsulDPJP1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/DutyRoster.png"))); // NOI18N
        BtnJawabKonsulDPJP1.setMnemonic('4');
        BtnJawabKonsulDPJP1.setText("Jawab Konsul DPJP");
        BtnJawabKonsulDPJP1.setToolTipText("ALt+4");
        BtnJawabKonsulDPJP1.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        BtnJawabKonsulDPJP1.setGlassColor(new java.awt.Color(0, 0, 255));
        BtnJawabKonsulDPJP1.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        BtnJawabKonsulDPJP1.setName("BtnJawabKonsulDPJP1"); // NOI18N
        BtnJawabKonsulDPJP1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnJawabKonsulDPJP1ActionPerformed(evt);
            }
        });
        panelGlass12.add(BtnJawabKonsulDPJP1);
        BtnJawabKonsulDPJP1.setBounds(1250, 190, 160, 26);

        Btn5Soap4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/190.png"))); // NOI18N
        Btn5Soap4.setMnemonic('4');
        Btn5Soap4.setToolTipText("ALt+4");
        Btn5Soap4.setName("Btn5Soap4"); // NOI18N
        Btn5Soap4.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                Btn5Soap4ActionPerformed(evt);
            }
        });
        panelGlass12.add(Btn5Soap4);
        Btn5Soap4.setBounds(405, 40, 28, 23);
        ...
        TPembukaan.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                TPembukaanActionPerformed(evt);
            }
        });
        ...
        BtnVerifSbar2.setBounds(450, 120, 38, 23);

        jLabel25.setText("DPJP:");
        jLabel25.setName("jLabel25"); // NOI18N
        panelGlass17.add(jLabel25);
        jLabel25.setBounds(440, 200, 50, 23);
        ...
        panelGlass17.add(KdDok3);
        KdDok3.setBounds(490, 200, 100, 23);

        TDokter3.setEditable(false);
        TDokter3.setHighlighter(null);
        TDokter3.setName("TDokter3"); // NOI18N
        panelGlass17.add(TDokter3);
        TDokter3.setBounds(596, 200, 250, 23);
        ...
        panelGlass17.add(BtnSeekDokter3);
        BtnSeekDokter3.setBounds(850, 200, 28, 23);
        ...
        PanelInput6.setPreferredSize(new java.awt.Dimension(192, 300));
        ...
        panelGlass18.add(KdPetugas);
        KdPetugas.setBounds(73, 10, 115, 23);

        NmPetugas.setEditable(false);
        NmPetugas.setHighlighter(null);
        NmPetugas.setName("NmPetugas"); // NOI18N
        panelGlass18.add(NmPetugas);
        NmPetugas.setBounds(190, 10, 250, 23);
        ...
        DTPTgl.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "09-08-2025" }));
        ...
        jLabel63.setBounds(950, 10, 70, 23);
        ...
        TglLahir.setBounds(1020, 10, 125, 23);

        jLabel65.setText("Umur:");
        jLabel65.setName("jLabel65"); // NOI18N
        FormInput.add(jLabel65);
        jLabel65.setBounds(1160, 10, 40, 23);
        ...
        RMPenilaianAwalKeperawatanRanapNeonatus.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/item.png"))); // NOI18N
        RMPenilaianAwalKeperawatanRanapNeonatus.setText("Keperawatan Neonatus");
        RMPenilaianAwalKeperawatanRanapNeonatus.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        RMPenilaianAwalKeperawatanRanapNeonatus.setGlassColor(new java.awt.Color(255, 255, 255));
        RMPenilaianAwalKeperawatanRanapNeonatus.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        RMPenilaianAwalKeperawatanRanapNeonatus.setMargin(new java.awt.Insets(1, 1, 1, 1));
        RMPenilaianAwalKeperawatanRanapNeonatus.setName("RMPenilaianAwalKeperawatanRanapNeonatus"); // NOI18N
        RMPenilaianAwalKeperawatanRanapNeonatus.setPreferredSize(new java.awt.Dimension(190, 23));
        RMPenilaianAwalKeperawatanRanapNeonatus.setRoundRect(false);
        RMPenilaianAwalKeperawatanRanapNeonatus.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                RMPenilaianAwalKeperawatanRanapNeonatusActionPerformed(evt);
            }
        });
        FormMenu.add(RMPenilaianAwalKeperawatanRanapNeonatus);
        ...
        if (TNoRw.getText().trim().equals("") || TPasien.getText().trim().equals("")) {
            ...
            switch (TabRawat.getSelectedIndex()) {
                ...
                case 7:
                    ...
                    break;
                case 8:
                    if ((!Asesmen.getText().trim().equals("")) || (!Diagnosis.getText().trim().equals("")) || (!TSuhu1.getText().trim().equals(""))
                            ...
                            || (!TGCS1.getText().trim().equals("")) || (!Monitoring.getText().trim().equals("")) || (!Intervensi.getText().trim().equals(""))
                            || (!Evaluasi.getText().trim().equals("")) || (!SpO3.getText().trim().equals("")) || (!Instruksi.getText().trim().equals(""))) {
                        if (KdPetugas.getText().trim().equals("") || NmPetugas.getText().trim().equals("")) {
                            Valid.textKosong(KdPetugas, "Dokter/Paramedis masih kosong...!!");
                        } else {
                            if (akses.getkode().equals("Admin Utama")) {
                                Sequel.menyimpan("catatan_adime_gizi", "?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?", "Data", 20, new String[]{
                                    ...
                                    Intervensi.getText(), Monitoring.getText(), Evaluasi.getText(), Instruksi.getText(), KdPetugas.getText()
                                });
                                tampilPemeriksaanAdime();
                                BtnBatalActionPerformed(evt);
                            } else {
...
private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
    if (TNoRw.getText().trim().equals("") || TPasien.getText().trim().equals("")) {
        ...
        switch (TabRawat.getSelectedIndex()) {
            ...
            case 8:
                if ((!Asesmen.getText().trim().equals("")) || (!Diagnosis.getText().trim().equals("")) || (!TSuhu1.getText().trim().equals(""))
                        || (!TTensi1.getText().trim().equals("")) || (!TAlergi1.getText().trim().equals("")) || (!TTinggi1.getText().trim().equals(""))
                        || (!TBerat1.getText().trim().equals("")) || (!TRespirasi1.getText().trim().equals("")) || (!TNadi1.getText().trim().equals(""))
                        || (!TGCS1.getText().trim().equals("")) || (!Monitoring.getText().trim().equals("")) || (!Intervensi.getText().trim().equals(""))
                        || (!KdPetugas.getText().trim().equals("")) || (!NmPetugas.getText().trim().equals("")) || (!Evaluasi.getText().trim().equals(""))
                        || (!SpO3.getText().trim().equals("")) || (!Instruksi.getText().trim().equals(""))) {
                    if (tbPemeriksaan1.getSelectedRow() > -1) {
                        if (akses.getkode().equals("Admin Utama")) {
                            Sequel.mengedit("pemeriksaan_ranap", "no_rawat='" + tbPemeriksaan1.getValueAt(tbPemeriksaan1.getSelectedRow(), 1)
                                    + "' and tgl_perawatan='" + tbPemeriksaan1.getValueAt(tbPemeriksaan1.getSelectedRow(), 4)
                                    + "' and jam_rawat='" + tbPemeriksaan1.getValueAt(tbPemeriksaan1.getSelectedRow(), 5) + "'",
                                    ...
                                    + "jam_rawat='" + cmbJam.getSelectedItem() + ":" + cmbMnt.getSelectedItem() + ":" + cmbDtk.getSelectedItem() + "',"
                                    + "rtl='" + Monitoring.getText() + "',penilaian='" + Intervensi.getText() + "',instruksi='" + Evaluasi.getText() + "',evaluasi='" + Instruksi.getText() + "',nip='" + KdPetugas.getText() + "'");
                            tampilPemeriksaanAdime();
                            BtnBatalActionPerformed(evt);
                        } else {
                            if (akses.getkode().equals(tbPemeriksaan1.getValueAt(tbPemeriksaan1.getSelectedRow(), 22).toString())) {
                                Sequel.mengedit("pemeriksaan_ranap", "no_rawat='" + tbPemeriksaan1.getValueAt(tbPemeriksaan1.getSelectedRow(), 1)
                                        + "' and tgl_perawatan='" + tbPemeriksaan1.getValueAt(tbPemeriksaan1.getSelectedRow(), 4)
                                        + "' and jam_rawat='" + tbPemeriksaan1.getValueAt(tbPemeriksaan1.getSelectedRow(), 5) + "'",
                                        "no_rawat='" + TNoRw.getText() + "',suhu_tubuh='" + TSuhu1.getText() + "',tensi='" + TTensi1.getText() + "',"
                                        ...
                                        + "gcs='" + TGCS1.getText() + "',kesadaran='" + cmbKesadaran1.getSelectedItem() + "',alergi='" + TAlergi1.getText() + "',tgl_perawatan='" + Valid.SetTgl(DTPTgl.getSelectedItem() + "") + "',"
                                        + "jam_rawat='" + cmbJam.getSelectedItem() + ":" + cmbMnt.getSelectedItem() + ":" + cmbDtk.getSelectedItem() + "',"
                                        + "rtl='" + Monitoring.getText() + "',penilaian='" + Intervensi.getText() + "',instruksi='" + Evaluasi.getText() + "',evaluasi='" + Instruksi.getText() + "'");
                                tampilPemeriksaanAdime();
                                BtnBatalActionPerformed(evt);
                            } else {
                                JOptionPane.showMessageDialog(null, "Hanya bisa diganti oleh dokter/petugas yang bersangkutan..!!");
...
private void BtnEditKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnEditKeyPressed
    ...
    private void Btn5SoapActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Btn5SoapActionPerformed
        if (TPasien.getText().trim().equals("") || TNoRw.getText().trim().equals("")) {
            ...
            // Memanggil DlgBerkasRawat dengan pola yang sama seperti contoh
            DlgBerkasRawat berkas = new DlgBerkasRawat(null, true);
            berkas.setJudul("::[ Berkas Digital Perawatan ]::", "berkasrawat/pages");
    ...
    private void BtnInputKonsulActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnInputKonsulActionPerformed
        if (TNoRw.getText().trim().equals("")) {
            ...
            this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
            DlgPermintaanKonsul form = new DlgPermintaanKonsul(null, false);
            form.isCek();
            form.setSize(internalFrame1.getWidth(), internalFrame1.getHeight());
            form.setLocationRelativeTo(internalFrame1);
            form.emptTeks();
    ...
    private void BtnSeekPegawai2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSeekPegawai2ActionPerformed
        ...
        pegawai2.setSize(internalFrame1.getWidth() - 20, internalFrame1.getHeight() - 20);
        pegawai2.setLocationRelativeTo(internalFrame1);
        pegawai2.setVisible(true);// TODO add your handling code here:
    ...
    private void Btn5Soap3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Btn5Soap3ActionPerformed
        if (TPasien.getText().trim().equals("") || TNoRw.getText().trim().equals("")) {
            JOptionPane.showMessageDialog(null, "Maaf, Silahkan anda pilih dulu dengan menklik data pada table...!!!");
            TCari.requestFocus();
        } else if (NmPetugas.getText().trim().equals("") || KdPetugas.getText().trim().equals("")) {
            JOptionPane.showMessageDialog(null, "Maaf, Silahkan anda pilih dulu petugas/dokter pemberi asuhan...!!!");
            TCari.requestFocus();
        } else {
            this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
            soapterakhiradime.setNoRM(TNoRM.getText(), KdPetugas.getText(), "Ranap");
    ...
    private void BtnTemplatePemberianObatActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnTemplatePemberianObatActionPerformed
        if (TNoRw.getText().trim().equals("")) {
            JOptionPane.showMessageDialog(null, "Maaf, Silahkan anda pilih dulu dengan menklik data pada table...!!!");
            TCari.requestFocus();
        } else {
            this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
            DlgTemplatePemberianObatRanap template = new DlgTemplatePemberianObatRanap(null, false);
            template.isCek();
    ...
    }//GEN-LAST:event_BtnTemplatePemberianObatActionPerformed

    private void BtnBalanceCairanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnBalanceCairanActionPerformed
        if (TPasien.getText().trim().equals("") || TNoRw.getText().trim().equals("")) {
            JOptionPane.showMessageDialog(null, "Maaf, Silahkan anda pilih dulu dengan menklik data pada table...!!!");
            TCari.requestFocus();
        } else {
            this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
            EWSBalanceCairan form = new EWSBalanceCairan(null, false);
            form.isCek();
            form.emptTeks();
            form.setNoRm(TNoRw.getText(), DTPCari2.getDate());
            form.tampil();
    ...
    }//GEN-LAST:event_BtnBalanceCairanActionPerformed

    private void BtnVerifSbar5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnVerifSbar5ActionPerformed
        if (TNoRw.getText().trim().equals("")) {
            JOptionPane.showMessageDialog(null, "Maaf, Silahkan anda pilih dulu pasien...!!!");
            TCari.requestFocus();
        } else {
    ...
    }//GEN-LAST:event_BtnVerifSbar5ActionPerformed
    ...
    private void BtnRiwayatKonsulDPJPActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnRiwayatKonsulDPJPActionPerformed
        if (TNoRw.getText().trim().equals("")) {
            JOptionPane.showMessageDialog(null, "Maaf, Silahkan anda pilih dulu dengan menklik data pada table...!!!");
            TCari.requestFocus();
        } else {
            this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
            KonsultasiInternal konsul = new KonsultasiInternal(null, false);
            konsul.setNoRawat(TNoRw.getText(), TNoRw.getText());
            konsul.setSize(internalFrame1.getWidth(), internalFrame1.getHeight());
            konsul.setLocationRelativeTo(internalFrame1);
            konsul.setVisible(true);
            this.setCursor(Cursor.getDefaultCursor());
        }        // TODO add your handling code here:
    }//GEN-LAST:event_BtnRiwayatKonsulDPJPActionPerformed

    private void BtnRiwayatSBARActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnRiwayatSBARActionPerformed
        if (TNoRw.getText().trim().equals("")) {
            JOptionPane.showMessageDialog(null, "Maaf, Silahkan anda pilih dulu dengan menklik data pada table...!!!");
            TCari.requestFocus();
        } else {
    ...
    }//GEN-LAST:event_BtnRiwayatSBARActionPerformed

    private void BtnStatusVerifikasiSBARActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnStatusVerifikasiSBARActionPerformed
        if (TPasien.getText().trim().equals("") || TNoRw.getText().trim().equals("")) {
            JOptionPane.showMessageDialog(null, "Maaf, Silahkan anda pilih dulu dengan menklik data pada table...!!!");
            TCari.requestFocus();
        } else {
    ...
    }//GEN-LAST:event_BtnStatusVerifikasiSBARActionPerformed
    ...
    private void BtnKonsulDPJPActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnKonsulDPJPActionPerformed
        if (TNoRw.getText().trim().equals("")) {
            ...
            this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
            KonsultasiJawab jawab = new KonsultasiJawab(null, false);
            jawab.isCek();
            //            jawab.autoNomor();
            jawab.setSize(internalFrame1.getWidth() - 20, internalFrame1.getHeight() - 20);
            jawab.setLocationRelativeTo(internalFrame1);
            jawab.setNoRm(TNoRw.getText(), DTPCari2.getDate(), KdDok.getText());
            jawab.tampil();
            ...
            this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
            WaKonsulDPJP kirim = new WaKonsulDPJP(null, false);
            kirim.setNoRw(TNoRw.getText());
    ...
    private void BtnValidasiSbar1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnValidasiSbar1ActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_BtnValidasiSbar1ActionPerformed
    ...
    private void BtnAsuhanKeperawatanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnAsuhanKeperawatanActionPerformed
        if (TNoRw.getText().trim().equals("")) {
            JOptionPane.showMessageDialog(null, "Maaf, Silahkan anda pilih dulu dengan menklik data pada table...!!!");
            TCari.requestFocus();
        } else {
    ...
    }//GEN-LAST:event_BtnAsuhanKeperawatanActionPerformed
    ...
    private void BtnSoapDokterActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSoapDokterActionPerformed
        akses.setform("DlgRawatJalan");
    ...
    }//GEN-LAST:event_BtnSoapDokterActionPerformed

    private void ChkTemplatePerawatItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_ChkTemplatePerawatItemStateChanged
        // TODO add your handling code here:
    }//GEN-LAST:event_ChkTemplatePerawatItemStateChanged

    private void BtnSoapPerawatActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSoapPerawatActionPerformed
        akses.setform("DlgRawatJalan");
    ...
    }//GEN-LAST:event_BtnSoapPerawatActionPerformed

    private void KdNoRawatKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_KdNoRawatKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_KdNoRawatKeyPressed

    private void TPembukaanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_TPembukaanActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_TPembukaanActionPerformed
    ...
    private void BtnPeriksaLabActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPeriksaLabActionPerformed
        if (TPasien.getText().trim().equals("") || TNoRw.getText().trim().equals("")) {
            JOptionPane.showMessageDialog(null, "Maaf, Silahkan anda pilih dulu dengan menklik data pada table...!!!");
            TCari.requestFocus();
        } else {
        ...
        // TODO add your handling code here:
    }//GEN-LAST:event_BtnPeriksaLabActionPerformed
    ...
    private void BtnPeriksaRadActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPeriksaRadActionPerformed
        if (TPasien.getText().trim().equals("") || TNoRw.getText().trim().equals("")) {
            ...
            form.setLocationRelativeTo(internalFrame1);
            form.setVisible(true);
            form.tampilDicomServer(Valid.SetTgl(DTPCari1.getDate() + " "), Valid.SetTgl(DTPCari2.getDate() + " "), TNoRM.getText(), TNoRw.getText());
            this.setCursor(Cursor.getDefaultCursor());
        }
    }//GEN-LAST:event_BtnPeriksaRadActionPerformed

    private void BtnJawabKonsulDPJP1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnJawabKonsulDPJP1ActionPerformed
        if (TNoRw.getText().trim().equals("")) {
            JOptionPane.showMessageDialog(null, "Maaf, Silahkan anda pilih dulu dengan menklik data pada table...!!!");
            TCari.requestFocus();
        } else {
    ...
    }//GEN-LAST:event_BtnJawabKonsulDPJP1ActionPerformed

    private void RMPenilaianAwalKeperawatanRanapNeonatusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_RMPenilaianAwalKeperawatanRanapNeonatusActionPerformed
        // TODO add your handling code here:
        if (TPasien.getText().trim().equals("") || TNoRw.getText().trim().equals("")) {
            JOptionPane.showMessageDialog(null, "Maaf, Silahkan anda pilih dulu dengan menklik data pada table...!!!");
            TCari.requestFocus();
    ...
    }//GEN-LAST:event_RMPenilaianAwalKeperawatanRanapNeonatusActionPerformed

    private void Btn5Soap4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Btn5Soap4ActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_Btn5Soap4ActionPerformed
    ...
    private widget.Button Btn5Soap4;
    ...
    private widget.Button BtnBalanceCairan;
    ...
    private widget.Button BtnJawabKonsulDPJP1;
    ...
    private widget.Button BtnRiwayatKonsulDPJP;
    private widget.Button BtnRiwayatSBAR;
    ...
    private widget.Button BtnSoapPerawat;
    private widget.Button BtnStatusVerifikasiSBAR;
    private widget.Button BtnTemplatePemberianObat;
    ...
    private widget.Button BtnValidasiSbar1;
    ...
    private widget.Button RMPenilaianAwalKeperawatanRanapNeonatus;
    ...
    private void isRawat() {
        ...
        Sequel.cariIsi("select bridging_sep.klsrawat from bridging_sep where bridging_sep.no_rawat=? ", Kelas, TNoRw.getText());
    }
    ...
    private void getDataPemeriksaanAdime() {
        if (tbPemeriksaan1.getSelectedRow() != -1) {
            ...
            Asesmen.setText(tbPemeriksaan1.getValueAt(tbPemeriksaan1.getSelectedRow(), 15).toString());
            Diagnosis.setText(tbPemeriksaan1.getValueAt(tbPemeriksaan1.getSelectedRow(), 16).toString());
            TAlergi1.setText(tbPemeriksaan1.getValueAt(tbPemeriksaan1.getSelectedRow(), 17).toString());
            Intervensi.setText(tbPemeriksaan1.getValueAt(tbPemeriksaan1.getSelectedRow(), 18).toString());
            Monitoring.setText(tbPemeriksaan1.getValueAt(tbPemeriksaan1.getSelectedRow(), 19).toString());
            Evaluasi.setText(tbPemeriksaan1.getValueAt(tbPemeriksaan1.getSelectedRow(), 20).toString());
            Instruksi.setText(tbPemeriksaan1.getValueAt(tbPemeriksaan1.getSelectedRow(), 21).toString());
    ...
    private void tampilPemeriksaanAdime() {
        ...
        try {
            ps4 = koneksi.prepareStatement("select catatan_adime_gizi.no_rawat,reg_periksa.no_rkm_medis,pasien.nm_pasien,"
                    + "catatan_adime_gizi.tanggal,catatan_adime_gizi.jam,catatan_adime_gizi.suhu_tubuh,catatan_adime_gizi.tensi, "
                    + "catatan_adime_gizi.nadi,catatan_adime_gizi.respirasi,catatan_adime_gizi.tinggi, "
                    + "catatan_adime_gizi.berat,catatan_adime_gizi.spo2,catatan_adime_gizi.gcs,catatan_adime_gizi.kesadaran,catatan_adime_gizi.asesmen, "
                    + "catatan_adime_gizi.diagnosis,catatan_adime_gizi.alergi,catatan_adime_gizi.intervensi,catatan_adime_gizi.monitoring,"
                    + "catatan_adime_gizi.evaluasi,catatan_adime_gizi.instruksi,catatan_adime_gizi.nip,pegawai.nama,pegawai.jbtn "
                    + "from pasien inner join reg_periksa on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "
                    ...
                    + "order by catatan_adime_gizi.no_rawat,catatan_adime_gizi.tanggal,catatan_adime_gizi.jam desc");
            try {
                ps4.setString(1, Valid.SetTgl(DTPCari1.getSelectedItem() + ""));
                ps4.setString(2, Valid.SetTgl(DTPCari2.getSelectedItem() + ""));
                ps4.setString(3, "%" + TCariPasien.getText() + "%");
        ...
        if (ChkTemplate.isSelected() == true) {
            ...
            if (KdNoRawat.getText().trim().equals("")) {
                ...
                if (Sequel.menyimpantf("template_pemeriksaan_dokter", "?,?,?,?,?,?,?,?", "No.Template", 8, new String[]{
                    KdNoRawat.getText(), KdDok.getText(), TKeluhan.getText(), TPemeriksaan.getText(), TPenilaian.getText(), TindakLanjut.getText(),
        ...
        if (ChkTemplatePerawat.isSelected() == true) {
            ...
            if (KdNoRawat.getText().trim().equals("")) {
                ...
                if (Sequel.menyimpantf("template_soapie_perawat", "?,?,?,?,?,?,?", "No.Template", 7, new String[]{
                    KdNoRawat.getText(), TKeluhan.getText(), TPemeriksaan.getText(), TPenilaian.getText(), TindakLanjut.getText(),
                    TInstruksi.getText(), TEvaluasi.getText()
                }) == true) {
                    JOptionPane.showMessageDialog(null, "Template SOAPIE Sukses Tersimpan");
                    TEvaluasi.requestFocus();
