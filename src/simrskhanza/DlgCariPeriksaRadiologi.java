...
public class DlgCariPeriksaRadiologi extends javax.swing.JDialog {
    ...
    private String kamar,namakamar,pemeriksaan="",pilihan="",status="",finger="",teleradiologihasil = "";
    private OrthancViewerHybridSplitRad dicomViewer=new OrthancViewerHybridSplitRad(null,false);
    ...
    public DlgCariPeriksaRadiologi(java.awt.Frame parent, boolean modal) {
        ...
        try {            
            teleradiologihasil = koneksiDB.TELERADHASIL();
        } catch (Exception e) {
            teleradiologihasil = koneksiDB.TELERADHASIL();
    ...
    private void initComponents() {
        ...
        ppDicomImage = new javax.swing.JMenuItem();
        ...
        ppDicomImage.setBackground(new java.awt.Color(255, 255, 254));
        ppDicomImage.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        ppDicomImage.setForeground(new java.awt.Color(50, 50, 50));
        ppDicomImage.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        ppDicomImage.setText("Tampilkan Hasil Pemeriksaan + DICOM");
        ppDicomImage.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        ppDicomImage.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        ppDicomImage.setName("ppDicomImage"); // NOI18N
        ppDicomImage.setPreferredSize(new java.awt.Dimension(220, 26));
        ppDicomImage.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                ppDicomImageBtnPrintActionPerformed(evt);
            }
        });
        jPopupMenu1.add(ppDicomImage);
        ...
        BtnTeleRad.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/Froyoshark-Enkel-Telegram.512.png"))); // NOI18N
        BtnTeleRad.setMnemonic('U');
        BtnTeleRad.setText("dr Rad");
        BtnTeleRad.setToolTipText("Alt+U");
        BtnTeleRad.setName("BtnTeleRad"); // NOI18N
        BtnTeleRad.setPreferredSize(new java.awt.Dimension(100, 30));
        BtnTeleRad.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnTeleRadActionPerformed(evt);
            }
        });
        FormPass2.add(BtnTeleRad);
...
private void tbDokterKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_tbDokterKeyPressed
   if(tabMode.getRowCount()!=0){
    ...
    private void ppDicomImageBtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ppDicomImageBtnPrintActionPerformed
        this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
        if(tabMode.getRowCount()==0){
            JOptionPane.showMessageDialog(null,"Maaf, data sudah habis...!!!!");
            TCari.requestFocus();
            ...
            if(Kd2.getText().equals("")){
                ...
                try {
                    String noRekammedis= tbDokter.getValueAt(tbDokter.getSelectedRow(),1).toString().split(" ")[0];
                    dicomViewer.setPasien(tbDokter.getValueAt(tbDokter.getSelectedRow(),0).toString(),tbDokter.getValueAt(tbDokter.getSelectedRow(),3).toString(),tbDokter.getValueAt(tbDokter.getSelectedRow(),4).toString(),true);
                    dicomViewer.tampilDicomServer(tbDokter.getValueAt(tbDokter.getSelectedRow(),3).toString().replaceAll("-", ""),tbDokter.getValueAt(tbDokter.getSelectedRow(),3).toString().replaceAll("-", ""),noRekammedis, tbDokter.getValueAt(tbDokter.getSelectedRow(),0).toString());
        ...
        this.setCursor(Cursor.getDefaultCursor());
    }//GEN-LAST:event_ppDicomImageBtnPrintActionPerformed
            ...
            if (Kd2.getText().equals("") || Petugas.getText().equals("")) {
                ...
                try {
                    ps = koneksi.prepareStatement(
                        ...
                        + "reg_periksa.no_rawat, gambar_radiologi.tgl_periksa, gambar_radiologi.jam, hasil_radiologi.hasil "
                        ...
                        + "WHERE reg_periksa.no_rawat = ? AND gambar_radiologi.tgl_periksa = ? AND gambar_radiologi.jam = ? "
                    ...
                    while (rs.next()) {
                        try {
                            String imageUrl = "http://" + koneksiDB.HOSTHYBRIDWEB() + "/" + koneksiDB.HYBRIDWEB() + "/radiologi/" + rs.getString("lokasi_gambar");
                            String destinationFolder = "tmpWA/";
                            ...
                            String filePath = "tmpWA/" + rs.getString("lokasi_gambar").toString().replaceAll("pages/upload/", "");
                            String FileName = rs.getString("lokasi_gambar").toString().replaceAll("pages/upload/", "");
                            KirimWaGambar(FileName, "media/",noWa+"@c.us","NODEJS");
                            HapusGambar();
    ...
    private void BtnTeleRadActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnTeleRadActionPerformed
        this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
        if (tabMode.getRowCount() == 0) {
            JOptionPane.showMessageDialog(null, "Maaf, data sudah habis...!!!!");
            TCari.requestFocus();
                ...
                try {
                    ...
                    while (rs.next()) {
                        try {
                            ...
                            String filePath = "tmpWA/" + rs.getString("lokasi_gambar").toString().replaceAll("pages/upload/", "");
                            String FileName = rs.getString("lokasi_gambar").toString().replaceAll("pages/upload/", "");
                            KirimWaGambar(FileName, "media/",teleradiologihasil+"@t.us","TELEGRAM");
                            HapusGambar();
        ...
        this.setCursor(Cursor.getDefaultCursor());
    }//GEN-LAST:event_BtnTeleRadActionPerformed
    ...
    */
    ...
    private widget.Button BtnTeleRad;
    ...
    private javax.swing.JMenuItem ppDicomImage;
    ...
    private void KirimWaGambar(String FileName, String docpath,String nomor,String engine) {
        try {
            koneksiwa = koneksiDBWa.condb();
            File file = new File("tmpWA/" + FileName);
            ...
            if (response.getStatusLine().getStatusCode() == 200) {
                JOptionPane.showMessageDialog(null, "Pesan Berhasil di Antrikan di Wa/ Tele Gateway!", "Sukses", JOptionPane.INFORMATION_MESSAGE);
            } else {
            ...
            String pesan = "==========================\n"
                    + akses.getnamars() + "\n"
                    + "==========================\n"
                    + "Yth.,"+tbDokter.getValueAt(tbDokter.getSelectedRow(), 6)+"\n\n"
                    + "Dengan hormat,\n"
                    + "Bersama ini kami sampaikan gambar radiologi atas nama:\n"
                    ...
                    + "Hormat kami,\n"
                    + "Petugas Radiologi:"+akses.getkode();
            ...
            try {
                ...
                ps.setString(2, nomor);  // NOWA/ ID TELE
