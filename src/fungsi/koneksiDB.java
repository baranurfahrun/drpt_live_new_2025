...
public class koneksiDB {
    ...
    public static String GRUPWA() {
        try {
            prop.loadFromXML(new FileInputStream("setting/database.xml"));
            var = EnkripsiAES.decrypt(prop.getProperty("GRUPWA"));
        } catch (Exception e) {
            var = "";
        }
        return var;
    ...
    public static String NOTIFWAINV() {
        try {
            prop.loadFromXML(new FileInputStream("setting/database.xml"));
            var = prop.getProperty("NOTIFWAINV");
        } catch (Exception e) {
            var = "";
        }
        return var;
    ...
    public static String IDGROUPWAINV() {
        try {
            prop.loadFromXML(new FileInputStream("setting/database.xml"));
            var = prop.getProperty("IDGROUPWAINV");
        } catch (Exception e) {
            var = "";
        }
        return var;
