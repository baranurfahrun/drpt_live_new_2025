...
public final class RMPenilaianAwalMedisRalanGeriatri extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        TglAsuhan.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "24-01-2024 04:52:24" }));
        ...
        BtnAmbilDataKeperawatan.setText("Ambil data Awal Keperawatan Geriatri");
    ...
    private void BtnAmbilDataKeperawatanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnAmbilDataKeperawatanActionPerformed
        try {
            ps = koneksi.prepareStatement(
                "SELECT penilaian_awal_keperawatan_ralan_geriatri.td, penilaian_awal_keperawatan_ralan_geriatri.nadi, penilaian_awal_keperawatan_ralan_geriatri.rr, "
                + "penilaian_awal_keperawatan_ralan_geriatri.suhu, penilaian_awal_keperawatan_ralan_geriatri.gcs, penilaian_awal_keperawatan_ralan_geriatri.bb, "
                + "penilaian_awal_keperawatan_ralan_geriatri.tb, penilaian_awal_keperawatan_ralan_geriatri.keluhan_utama, penilaian_awal_keperawatan_ralan_geriatri.rpd, "
                + "penilaian_awal_keperawatan_ralan_geriatri.rpk, penilaian_awal_keperawatan_ralan_geriatri.rpo, penilaian_awal_keperawatan_ralan_geriatri.alergi "
                + "FROM penilaian_awal_keperawatan_ralan_geriatri where "
                + "penilaian_awal_keperawatan_ralan_geriatri.no_rawat = ?");
    ...
    */
    ...
    private void isRawat() {
        ...
        if(Sequel.cariInteger("select count(no_rawat) from penilaian_awal_keperawatan_ralan_geriatri where no_rawat='"+TNoRw.getText()+"' ")>0){ 
            Suhu.setText(Sequel.cariIsi("select suhu from penilaian_awal_keperawatan_ralan_geriatri where no_rawat=?",TNoRw.getText())); 
            TD.setText(Sequel.cariIsi("select td from penilaian_awal_keperawatan_ralan_geriatri where no_rawat=?",TNoRw.getText())); 
            Nadi.setText(Sequel.cariIsi("select nadi from penilaian_awal_keperawatan_ralan_geriatri where no_rawat=?",TNoRw.getText())); 
            RR.setText(Sequel.cariIsi("select rr from penilaian_awal_keperawatan_ralan_geriatri where no_rawat=?",TNoRw.getText())); 
            KeluhanUtama.setText(Sequel.cariIsi("select keluhan_utama from penilaian_awal_keperawatan_ralan_geriatri where no_rawat=?",TNoRw.getText())); 
            RPO.setText(Sequel.cariIsi("select rpo_penggunaan_obat_lainnya from penilaian_awal_keperawatan_ralan_geriatri where no_rawat=?",TNoRw.getText())); 
            Alergi.setText(Sequel.cariIsi("select ket_alergi_obat from penilaian_awal_keperawatan_ralan_geriatri where no_rawat=?",TNoRw.getText())); 
        }
    }
