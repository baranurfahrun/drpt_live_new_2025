...
public final class RMPenilaianAwalMedisRalanPsikiatrik extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        BtnAmbilDataKeperawatan.setText("Ambil data Awal Keperawatan Psikatrik");
    ...
    private void BtnAmbilDataKeperawatanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnAmbilDataKeperawatanActionPerformed
        try {
            ps = koneksi.prepareStatement(
                "SELECT p.no_rawat, p.keluhan_utama, p.rkd_keluhan, p.rkd_sakit_sejak, p.rkd_berobat, p.rkd_hasil_pengobatan, "
                + "p.fp_putus_obat, p.ket_putus_obat, p.td, p.nadi, p.gcs, p.rr, p.suhu, p.bb, p.tb FROM penilaian_awal_keperawatan_ralan_psikiatri p where "
                + "p.no_rawat = ?");
            ...
            try {
                ...
                while (rs.next()) {
                    ...
                    RPS.setText(rs.getString("rkd_sakit_sejak"));
