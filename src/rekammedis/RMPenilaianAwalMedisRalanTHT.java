...
import freehand.DlgMarkingImageAssMedisTht;
...
public final class RMPenilaianAwalMedisRalanTHT extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        scrollPane5.setBounds(124, 300, 720, 73);
        ...
        PanelWall.setBounds(74, 430, 780, 270);
        ...
        TglAsuhan.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "25-09-2024 17:20:57" }));
        ...
        BtnMarking.setBounds(330, 390, 160, 30);
        ...
        BtnAmbilDataKeperawatan.setText("Ambil data Awal Keperawatan ");
    ...
    private void BtnMarkingActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnMarkingActionPerformed
        DlgMarkingImageAssMedisTht form=new DlgMarkingImageAssMedisTht(null,false);
        ...
        form.addWindowListener(new WindowListener() {
            ...
            @Override
            public void windowClosed(WindowEvent e) {
                urlImage=Sequel.cariIsi("select url_image from asesmen_medis_mata_image_marking where no_rawat='"+TNoRw.getText()+"' ");
    ...
    private void BtnAmbilDataKeperawatanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnAmbilDataKeperawatanActionPerformed
        try {
            ps = koneksi.prepareStatement(
                "SELECT penilaian_awal_keperawatan_ralan.td, penilaian_awal_keperawatan_ralan.nadi, penilaian_awal_keperawatan_ralan.rr, "
                ...
                + "FROM penilaian_awal_keperawatan_ralan where "
