...
import whoantro.AnthroResult;
import whoantro.WHOAnthroCalculator;
import whoantro.WHOAnthroPopup;
...
import whoantro.WHOAnthroPopup;
import whoantro.WHOAnthroPopupFactory;
import whoantro.AnthroResult;
...
public final class RMPenilaianAwalMedisRalanAnak extends javax.swing.JDialog {
    ...
    private WHOAnthroCalculator whoCalculator;
    ...
    private void initComponents() {
        ...
        BtnAmbilDataKeperawatan = new widget.Button();
        jLabel14 = new widget.Label();
        txtLingkarKepala = new widget.TextBox();
        BtnHitungZScore = new widget.Button();
        ...
        TglLahir.setBounds(630, 10, 110, 23);
        ...
        TglAsuhan.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "25-07-2025 21:52:47" }));
        ...
        BtnAmbilDataKeperawatan.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/search_page.png"))); // NOI18N
        BtnAmbilDataKeperawatan.setMnemonic('S');
        BtnAmbilDataKeperawatan.setText("Ambil data Awal Keperawatan Anak");
        BtnAmbilDataKeperawatan.setToolTipText("Alt+S");
        BtnAmbilDataKeperawatan.setName("BtnAmbilDataKeperawatan"); // NOI18N
        BtnAmbilDataKeperawatan.setPreferredSize(new java.awt.Dimension(100, 30));
        BtnAmbilDataKeperawatan.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnAmbilDataKeperawatanActionPerformed(evt);
            }
        });
        BtnAmbilDataKeperawatan.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                BtnAmbilDataKeperawatanKeyPressed(evt);
            }
        });
        FormInput.add(BtnAmbilDataKeperawatan);
        BtnAmbilDataKeperawatan.setBounds(860, 90, 270, 30);

        jLabel14.setText("Lingkar Kepala:");
        jLabel14.setName("jLabel14"); // NOI18N
        FormInput.add(jLabel14);
        jLabel14.setBounds(870, 260, 80, 23);

        txtLingkarKepala.setFocusTraversalPolicyProvider(true);
        txtLingkarKepala.setName("txtLingkarKepala"); // NOI18N
        txtLingkarKepala.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                txtLingkarKepalaKeyPressed(evt);
            }
        });
        FormInput.add(txtLingkarKepala);
        txtLingkarKepala.setBounds(960, 260, 45, 23);

        BtnHitungZScore.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/who.png"))); // NOI18N
        BtnHitungZScore.setMnemonic('S');
        BtnHitungZScore.setText("Hitung Z.Score - WHO Anthro");
        BtnHitungZScore.setToolTipText("Alt+S");
        BtnHitungZScore.setName("BtnHitungZScore"); // NOI18N
        BtnHitungZScore.setPreferredSize(new java.awt.Dimension(150, 30));
        BtnHitungZScore.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnHitungZScoreActionPerformed(evt);
            }
        });
        BtnHitungZScore.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                BtnHitungZScoreKeyPressed(evt);
            }
        });
        FormInput.add(BtnHitungZScore);
        BtnHitungZScore.setBounds(860, 290, 220, 50);

        jLabel27.setText("Umur:");
        jLabel27.setName("jLabel27"); // NOI18N
        FormInput.add(jLabel27);
        jLabel27.setBounds(860, 10, 40, 23);

        Umur.setEditable(false);
        Umur.setHighlighter(null);
        Umur.setName("Umur"); // NOI18N
        FormInput.add(Umur);
        Umur.setBounds(900, 10, 110, 23);
    ...
    private void BtnAmbilDataKeperawatanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnAmbilDataKeperawatanActionPerformed
        try {
            ps = koneksi.prepareStatement(
                    "SELECT penilaian_awal_keperawatan_ralan_bayi.no_rawat, penilaian_awal_keperawatan_ralan_bayi.td, penilaian_awal_keperawatan_ralan_bayi.nadi, "
                    + "penilaian_awal_keperawatan_ralan_bayi.rr, penilaian_awal_keperawatan_ralan_bayi.suhu, penilaian_awal_keperawatan_ralan_bayi.gcs, "
                    + "penilaian_awal_keperawatan_ralan_bayi.bb, penilaian_awal_keperawatan_ralan_bayi.tb, penilaian_awal_keperawatan_ralan_bayi.keluhan_utama, "
                    + "penilaian_awal_keperawatan_ralan_bayi.rpd, penilaian_awal_keperawatan_ralan_bayi.rpk, penilaian_awal_keperawatan_ralan_bayi.rpo, "
                    + "penilaian_awal_keperawatan_ralan_bayi.alergi FROM penilaian_awal_keperawatan_ralan_bayi where "
                    + "penilaian_awal_keperawatan_ralan_bayi.no_rawat = ?");
    ...
    }//GEN-LAST:event_BtnAmbilDataKeperawatanActionPerformed

    private void BtnAmbilDataKeperawatanKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnAmbilDataKeperawatanKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_BtnAmbilDataKeperawatanKeyPressed

    private void txtLingkarKepalaKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtLingkarKepalaKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_txtLingkarKepalaKeyPressed

    private void BtnHitungZScoreActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHitungZScoreActionPerformed
        try {
            // Ambil data dari form existing
            String noRawat = TNoRw.getText().trim();
            String noRm = TNoRM.getText().trim();
            String namaPasien = TPasien.getText().trim();
            String tanggalLahir = TglLahir.getText().trim();
            String jenisKelamin = Jk.getText().trim();
            String beratBadan = BB.getText().trim();
            String tinggiBadan = TB.getText().trim();
            String lingkarKepala = txtLingkarKepala.getText().trim();

            // Debug info
        /*    System.out.println("=== DEBUG WHO ANTHRO DATA ===");
            ...
            System.out.println("BB: " + beratBadan);
            System.out.println("TB: " + tinggiBadan);
            System.out.println("LK: " + lingkarKepala);
            System.out.println("============================="); */

            // Buka popup WHO Anthro Calculator
            openWHOAnthroPopup(noRawat, noRm, namaPasien, tanggalLahir, jenisKelamin,
                    beratBadan, tinggiBadan, lingkarKepala);

        } catch (Exception e) {
            JOptionPane.showMessageDialog(this,
                    "Error membuka WHO Anthro Calculator: " + e.getMessage(),
                    "Error", JOptionPane.ERROR_MESSAGE);
            e.printStackTrace();
        }


    }//GEN-LAST:event_BtnHitungZScoreActionPerformed
    private boolean validateAnthroInput(String bb, String tb, String lk, String tglLahir, String jk) {
        // Validasi Berat Badan
        if (bb.isEmpty()) {
            JOptionPane.showMessageDialog(this, "Berat Badan harus diisi untuk perhitungan Z-Score!",
        ...
        if (tb.isEmpty()) {
            JOptionPane.showMessageDialog(this, "Tinggi Badan harus diisi untuk perhitungan Z-Score!",
                    "Data Tidak Lengkap", JOptionPane.WARNING_MESSAGE);
            return false;
        }
        ...
        if (lk.isEmpty()) {
            JOptionPane.showMessageDialog(this, "Lingkar Kepala harus diisi untuk perhitungan Z-Score!",
                    "Data Tidak Lengkap", JOptionPane.WARNING_MESSAGE);
        ...
        if (tglLahir.isEmpty()) {
            JOptionPane.showMessageDialog(this, "Tanggal Lahir harus diisi untuk perhitungan Z-Score!",
                    "Data Tidak Lengkap", JOptionPane.WARNING_MESSAGE);
            return false;
        }

        // Validasi Jenis Kelamin
        if (jk.equals("-- Pilih --") || jk.isEmpty()) {
            JOptionPane.showMessageDialog(this, "Jenis Kelamin harus dipilih untuk perhitungan Z-Score!",
                    "Data Tidak Lengkap", JOptionPane.WARNING_MESSAGE);
            return false;
        }
        ...
        try {
            double bbValue = Double.parseDouble(bb);
            double tbValue = Double.parseDouble(tb);
            double lkValue = Double.parseDouble(lk);

            if (bbValue <= 0 || bbValue > 50) {
                JOptionPane.showMessageDialog(this, "Berat Badan harus antara 0.1 - 50 kg!",
                        "Data Tidak Valid", JOptionPane.WARNING_MESSAGE);
                return false;
            }

            if (tbValue <= 0 || tbValue > 200) {
                JOptionPane.showMessageDialog(this, "Tinggi Badan harus antara 1 - 200 cm!",
                        "Data Tidak Valid", JOptionPane.WARNING_MESSAGE);
                return false;
            }

            if (lkValue <= 0 || lkValue > 70) {
                JOptionPane.showMessageDialog(this, "Lingkar Kepala harus antara 1 - 70 cm!",
                        "Data Tidak Valid", JOptionPane.WARNING_MESSAGE);
                return false;
            }

        } catch (NumberFormatException e) {
            JOptionPane.showMessageDialog(this, "Format angka tidak valid! Pastikan BB, TB, dan LK berupa angka.",
    ...
    // 5. Method untuk membuka popup WHO Anthro
    private void openWHOAnthroPopup(String noRawat, String noRm, String namaPasien, String tanggalLahir,
            String jenisKelamin, String beratBadan, String tinggiBadan, String lingkarKepala) {
        WHOAnthroPopup popup = null;

        try {
            // Cek apakah class WHO Anthro tersedia
            try {
                Class.forName("whoantro.WHOAnthroPopupFactory");
                Class.forName("whoantro.WHOAnthroPopup");
            } catch (ClassNotFoundException e) {
                JOptionPane.showMessageDialog(this,
                        "❌ Class WHO Anthro tidak ditemukan!\n"
                        + "Pastikan file WHOAnthroPopup.java dan WHOAnthroPopupFactory.java\n"
                        + "sudah dikompilasi dengan benar dalam package whoantro.",
                        "Class Not Found", JOptionPane.ERROR_MESSAGE);
                return;
            }

            // Validasi data dasar terlebih dahulu
            if (!validateBasicData(noRawat, tanggalLahir, jenisKelamin, beratBadan, tinggiBadan, lingkarKepala)) {
                return;
            }

            // Dapatkan parent frame
            JFrame parentFrame = getParentFrame();

            // Gunakan Factory untuk membuat popup
            popup = whoantro.WHOAnthroPopupFactory.createPopupFromForm(
                    parentFrame,
                    noRawat, noRm, namaPasien, tanggalLahir, jenisKelamin,
                    beratBadan, tinggiBadan, lingkarKepala
            );

            // Jika popup berhasil dibuat (validasi lolos)
            if (popup != null) {
                // Tampilkan popup
                popup.setLocationRelativeTo(this);
                popup.setVisible(true);

                // Handle hasil setelah popup ditutup
                handlePopupResult(popup);
            } else {
                // Popup null karena validasi gagal - pesan error sudah ditampilkan oleh Factory
                System.out.println("Popup creation failed - validation error");
            }
            ...
            JOptionPane.showMessageDialog(this,
                    "❌ Error: " + e.getMessage() + "\n\n"
                    + "Pastikan:\n"
                    + "1. File WHOAnthroPopup.java sudah dikompilasi\n"
                    + "2. File WHOAnthroPopupFactory.java sudah dikompilasi\n"
                    + "3. Package whoantro sudah benar\n"
                    + "4. Import statement sudah ditambahkan",
                    "Error", JOptionPane.ERROR_MESSAGE);
            e.printStackTrace();
        }
    }
    ...
    private JFrame getParentFrame() {
        try {
            // Coba dapatkan parent window
            java.awt.Window parentWindow = SwingUtilities.getWindowAncestor(this);
            if (parentWindow instanceof JFrame) {
                return (JFrame) parentWindow;
            } else if (parentWindow != null) {
                // Jika parent bukan JFrame, cari JFrame terdekat
                java.awt.Container parent = parentWindow.getParent();
                while (parent != null) {
            ...
            System.err.println("Error getting parent frame: " + e.getMessage());
        }

        // Return null jika tidak ada JFrame parent
        return null;
    }

    private boolean validateBasicData(String noRawat, String tanggalLahir, String jenisKelamin,
            String beratBadan, String tinggiBadan, String lingkarKepala) {
        java.util.List<String> missingFields = new java.util.ArrayList<>();

        if (noRawat == null || noRawat.trim().isEmpty()) {
            missingFields.add("No. Rawat");
        }
        ...
        if (beratBadan == null || beratBadan.trim().isEmpty()) {
            missingFields.add("Berat Badan");
        }
        if (tinggiBadan == null || tinggiBadan.trim().isEmpty()) {
            missingFields.add("Tinggi Badan");
        }
        if (lingkarKepala == null || lingkarKepala.trim().isEmpty()) {
            missingFields.add("Lingkar Kepala");
        }

        if (!missingFields.isEmpty()) {
            StringBuilder message = new StringBuilder("Data berikut harus diisi:\n\n");
        ...
        try {
            ...
            JOptionPane.showMessageDialog(this,
                    "Format data BB, TB, dan LK harus berupa angka!\n\n"
                    + "Contoh: 15.5 (bukan 15,5)",
    ...
    private void handlePopupResult(WHOAnthroPopup popup) {
        try {
            if (popup.getDialogResult() == whoantro.WHOAnthroPopup.RESULT_OK) {
                whoantro.AnthroResult result = popup.getCalculationResult();
                if (result != null) {
                    // Tampilkan hasil singkat
                    showZScoreResults(result);

                    // Update form jika ada field khusus
                    updateFormWithZScoreResults(result);

                    // Log hasil
                    logZScoreCalculation(result);
                } else {
                    JOptionPane.showMessageDialog(this,
                            "⚠️ Hasil perhitungan tidak tersedia.",
                            "Warning", JOptionPane.WARNING_MESSAGE);
                }
            } else {
                System.out.println("User cancelled WHO Anthro dialog");
            }
        } catch (Exception e) {
            JOptionPane.showMessageDialog(this,
                    "Error handling popup result: " + e.getMessage(),
                    "Error", JOptionPane.ERROR_MESSAGE);
            e.printStackTrace();
        }
    }

    private void showZScoreResults(whoantro.AnthroResult result) {
        StringBuilder message = new StringBuilder();
        message.append("📊 HASIL Z-SCORE WHO\n");
        message.append("═".repeat(30)).append("\n\n");

        message.append(String.format("• BB/U  : %.2f (%s)\n",
                result.getZScoreBBU(), result.getStatusBBU()));
        message.append(String.format("• PB/U  : %.2f (%s)\n",
                result.getZScorePBU(), result.getStatusPBU()));
        message.append(String.format("• BB/PB : %.2f (%s)\n",
                result.getZScoreBBPB(), result.getStatusBBPB()));
        message.append(String.format("• BMI/U : %.2f (%s)\n",
                result.getZScoreBMIU(), result.getStatusBMIU()));
        message.append(String.format("• LK/U  : %.2f (%s)\n",
                result.getZScoreLKU(), result.getStatusLKU()));

        // Check for alerts
        boolean hasAlert = checkNutritionalAlerts(result);
        if (hasAlert) {
            message.append("\n⚠️ Ada indikator yang memerlukan perhatian!");
        } else {
            message.append("\n✅ Semua indikator dalam batas normal.");
        }

        JOptionPane.showMessageDialog(this, message.toString(),
                "Hasil Z-Score WHO", JOptionPane.INFORMATION_MESSAGE);
    }

    private boolean checkNutritionalAlerts(whoantro.AnthroResult result) {
        return Math.abs(result.getZScoreBBU()) > 2
                || Math.abs(result.getZScorePBU()) > 2
                || Math.abs(result.getZScoreBBPB()) > 2
                || Math.abs(result.getZScoreBMIU()) > 2
                || Math.abs(result.getZScoreLKU()) > 2;
    }

    private void updateFormWithZScoreResults(whoantro.AnthroResult result) {
        try {
            // Jika form memiliki field khusus untuk Z-Score, update di sini
            // Contoh (sesuaikan dengan field yang ada):
            /*
        if (txtZScoreBBU != null) {
            txtZScoreBBU.setText(String.format("%.2f", result.getZScoreBBU()));
        }
        // dst...
             */

            System.out.println("Form updated with Z-Score results");
        } catch (Exception e) {
            System.err.println("Error updating form: " + e.getMessage());
        }
    }

    private void logZScoreCalculation(whoantro.AnthroResult result) {
        try {
            System.out.println("=== Z-SCORE CALCULATION LOG ===");
            System.out.println("No Rawat: " + TNoRw.getText());
            System.out.println("Pasien: " + TPasien.getText());
            System.out.println("BB/U: " + String.format("%.2f", result.getZScoreBBU()));
            System.out.println("PB/U: " + String.format("%.2f", result.getZScorePBU()));
            System.out.println("BB/PB: " + String.format("%.2f", result.getZScoreBBPB()));
            System.out.println("BMI/U: " + String.format("%.2f", result.getZScoreBMIU()));
            System.out.println("LK/U: " + String.format("%.2f", result.getZScoreLKU()));
    ...
    private void openWHOAnthroPopupAdvanced(String noRawat, String noRm, String namaPasien,
            String tanggalLahir, String jenisKelamin,
            String beratBadan, String tinggiBadan, String lingkarKepala) {
        try {
            JFrame parentFrame = (JFrame) SwingUtilities.getWindowAncestor(this);

            // Opsi 1: Menggunakan createPopupSafe dengan warning
            WHOAnthroPopup popup = WHOAnthroPopupFactory.createPopupSafe(
                    parentFrame, noRawat, noRm, namaPasien, tanggalLahir, jenisKelamin,
                    beratBadan, tinggiBadan, lingkarKepala, true // show warning jika data tidak lengkap
            );
            ...
            if (popup != null) {
                ...
                if (popup.getDialogResult() == WHOAnthroPopup.RESULT_OK) {
                    AnthroResult result = popup.getCalculationResult();
                    handleZScoreResults(result);
                }
            }
    ...
    /**
     * Handle hasil Z-Score dengan lebih detail
     */
    private void handleZScoreResults(AnthroResult result) {
        if (result == null) {
            return;
        }
        ...
        try {
            ...
            message.append(String.format("• BB/U (Berat/Umur): %.2f (%s)\n",
                    result.getZScoreBBU(), result.getStatusBBU()));
            message.append(String.format("• PB/U (Panjang/Umur): %.2f (%s)\n",
                    result.getZScorePBU(), result.getStatusPBU()));
            message.append(String.format("• BB/PB (Berat/Panjang): %.2f (%s)\n",
                    result.getZScoreBBPB(), result.getStatusBBPB()));
            message.append(String.format("• BMI/U (IMT/Umur): %.2f (%s)\n",
                    result.getZScoreBMIU(), result.getStatusBMIU()));
            message.append(String.format("• LK/U (LingkarKepala/Umur): %.2f (%s)\n",
                    result.getZScoreLKU(), result.getStatusLKU()));

            // Check for any concerning values
            boolean hasAlert = checkForNutritionalAlerts(result);
            if (hasAlert) {
                message.append("\n⚠️ Perhatian: Ada indikator yang memerlukan perhatian khusus!");
            } else {
                message.append("\n✅ Semua indikator dalam batas normal.");
            }
            ...
            // Log hasil untuk tracking
            logZScoreResults(result);

        } catch (Exception e) {
            System.err.println("Error handling Z-Score results: " + e.getMessage());
        }
    }
     ...
     */
    private boolean checkForNutritionalAlerts(AnthroResult result) {
        return result.getZScoreBBU() < -2 || result.getZScoreBBU() > 2
                || result.getZScorePBU() < -2 || result.getZScorePBU() > 2
                || result.getZScoreBBPB() < -2 || result.getZScoreBBPB() > 2
                || result.getZScoreBMIU() < -2 || result.getZScoreBMIU() > 2
                || result.getZScoreLKU() < -2 || result.getZScoreLKU() > 2;
    }

    /**
     * Log Z-Score results untuk tracking
     */
    private void logZScoreResults(AnthroResult result) {
        try {
            System.out.println("=== Z-SCORE CALCULATION LOG ===");
            System.out.println("No Rawat: " + TNoRw.getText());
            System.out.println("Pasien: " + TPasien.getText());
            ...
            System.err.println("Error logging Z-Score results: " + e.getMessage());
        }
    }

// 6. Method untuk notifikasi hasil Z-Score
    private void showZScoreNotification(AnthroResult result) {
        StringBuilder message = new StringBuilder();
        message.append("Hasil Z-Score berhasil dihitung!\n\n");
        message.append("BB/U: ").append(String.format("%.2f", result.getZScoreBBU()))
                .append(" (").append(result.getStatusBBU()).append(")\n");
        message.append("PB/U: ").append(String.format("%.2f", result.getZScorePBU()))
                .append(" (").append(result.getStatusPBU()).append(")\n");
        message.append("LK/U: ").append(String.format("%.2f", result.getZScoreLKU()))
                .append(" (").append(result.getStatusLKU()).append(")");

        JOptionPane.showMessageDialog(this, message.toString(),
                "Z-Score WHO Berhasil Dihitung", JOptionPane.INFORMATION_MESSAGE);
    }

// 7. Method untuk integrasi dengan database (optional)
    private void saveZScoreToDatabase(String noRawat, AnthroResult result) {
        try {
            // Contoh query untuk menyimpan hasil Z-Score
            String sql = "INSERT INTO zscore_results (no_rawat, bb_u, pb_u, bb_pb, bmi_u, lk_u, "
                    + "status_bb_u, status_pb_u, status_bb_pb, status_bmi_u, status_lk_u, "
                    + "tanggal_hitung) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, NOW())";

            // Implementation database save
            // PreparedStatement ps = connection.prepareStatement(sql);
            // ps.setString(1, noRawat);
            // ps.setDouble(2, result.getZScoreBBU());
            // ... dst
            // ps.executeUpdate();
            System.out.println("Z-Score results saved to database for patient: " + noRawat);

        } catch (Exception e) {
            System.err.println("Error saving Z-Score to database: " + e.getMessage());
        }
    }

// 8. Helper method untuk parsing tanggal lahir
    private int[] parseAgeFromBirthDate(String tanggalLahir) {
        try {
    ...
    private void initWHOAnthroCalculator() {
        try {
            Connection conn = koneksiDB.condb();
            whoCalculator = new WHOAnthroCalculator(conn);
            System.out.println("WHO Anthro Calculator initialized: " + whoCalculator.getDataSourceInfo());
        } catch (Exception e) {
            System.out.println("Warning: WHO Anthro Calculator using fallback data");
            whoCalculator = new WHOAnthroCalculator(); // fallback tanpa database
        }
    }

    /*   private boolean saveZScoreToDatabase(String noRawat, AnthroResult result) {
        Connection conn = koneksiDB.condb();
        if (conn == null) {
        ...
        try {
            ...
            String tglLahir = extractTanggalLahir();
            String jenisKelamin = extractJenisKelamin();
           saveZScoreToDatabase double beratBadan = Double.parseDouble(Bb.getText().trim());
            double tinggiBadan = Double.parseDouble(Tb.getText().trim());
            double lingkarKepala = Double.parseDouble(TxtLingkarKepala.getText().trim());

            // Hitung umur
            int[] umur = calculateAge(tglLahir);
            int umurTahun = umur[0];
            int umurBulan = umur[1];
            int umurTotalBulan = umurTahun * 12 + umurBulan;

            // Convert jenis kelamin
            char jk = jenisKelamin.toLowerCase().contains("laki") ? 'L' : 'P';

            // Get current date and time
            java.sql.Date tanggalPeriksa = new java.sql.Date(System.currentTimeMillis());
            java.sql.Time jamPeriksa = new java.sql.Time(System.currentTimeMillis());
            java.sql.Date tanggalLahirDate = convertStringToDate(tglLahir);

            // Generate rekomendasi
            String rekomendasi = generateRekomendasi(result);

            // Siapkan SQL
            String sql = "INSERT INTO zscore_who_anthro ("
                    + "no_rawat, tanggal_periksa, jam_periksa, tanggal_lahir, "
                    + "umur_tahun, umur_bulan, umur_total_bulan, jenis_kelamin, "
                    + "berat_badan, tinggi_badan, lingkar_kepala, "
                    + "zscore_bb_u, zscore_pb_u, zscore_bb_pb, zscore_bmi_u, zscore_lk_u, "
                    + "status_bb_u, status_pb_u, status_bb_pb, status_bmi_u, status_lk_u, "
                    + "status_keseluruhan, has_malnutrition, has_severe_malnutrition, "
                    + "rekomendasi, petugas) VALUES ("
                    + "?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
            ...
            // Set parameters
            ps.setString(1, noRawat);
            ps.setDate(2, tanggalPeriksa);
            ps.setTime(3, jamPeriksa);
            ps.setDate(4, tanggalLahirDate);
            ps.setInt(5, umurTahun);
            ps.setInt(6, umurBulan);
            ps.setInt(7, umurTotalBulan);
            ps.setString(8, String.valueOf(jk));
            ps.setDouble(9, beratBadan);
            ps.setDouble(10, tinggiBadan);
            ps.setDouble(11, lingkarKepala);
            ps.setDouble(12, result.getZScoreBBU());
            ps.setDouble(13, result.getZScorePBU());
            ps.setDouble(14, result.getZScoreBBPB());
            ps.setDouble(15, result.getZScoreBMIU());
            ps.setDouble(16, result.getZScoreLKU());
            ps.setString(17, result.getStatusBBU());
            ps.setString(18, result.getStatusPBU());
            ps.setString(19, result.getStatusBBPB());
            ps.setString(20, result.getStatusBMIU());
            ps.setString(21, result.getStatusLKU());
            ps.setString(22, result.getOverallStatus());
            ps.setString(23, result.hasMalnutrition() ? "Ya" : "Tidak");
            ps.setString(24, result.hasSevereMalnutrition() ? "Ya" : "Tidak");
            ps.setString(25, rekomendasi);
            ps.setString(26, var.getkode()); // menggunakan var dari sistem yang ada
            ...
            if (rowsAffected > 0) {
                JOptionPane.showMessageDialog(rootPane,
                        "Data Z-Score WHO berhasil disimpan ke database!",
                        "Simpan Berhasil", JOptionPane.INFORMATION_MESSAGE);
                return true;
            } else {
                JOptionPane.showMessageDialog(rootPane,
                        "Gagal menyimpan data Z-Score ke database!",
                        "Simpan Gagal", JOptionPane.WARNING_MESSAGE);
                return false;
            }
    ...
    private void loadZScoreHistory(String noRawat) {
        Connection conn = koneksiDB.condb();
        if (conn == null) {
            JOptionPane.showMessageDialog(rootPane, "Koneksi database tidak tersedia!");
            return;
        }

        try {
            String sql = "SELECT * FROM zscore_who_anthro WHERE no_rawat = ? ORDER BY tanggal_periksa DESC LIMIT 5";
            PreparedStatement ps = conn.prepareStatement(sql);
            ps.setString(1, noRawat);
            ResultSet rs = ps.executeQuery();

            StringBuilder history = new StringBuilder();
            history.append("=== RIWAYAT Z-SCORE WHO ANTHRO ===\n\n");

            int count = 0;
            while (rs.next() && count < 5) {
                count++;
                history.append("Tanggal: ").append(rs.getDate("tanggal_periksa")).append("\n");
                history.append("BB/U: ").append(String.format("%.2f", rs.getDouble("zscore_bb_u")))
                        .append(" (").append(rs.getString("status_bb_u")).append(")\n");
                history.append("PB/U: ").append(String.format("%.2f", rs.getDouble("zscore_pb_u")))
                        .append(" (").append(rs.getString("status_pb_u")).append(")\n");
                history.append("Status: ").append(rs.getString("status_keseluruhan")).append("\n");
                history.append("-".repeat(40)).append("\n");
            }

            if (count == 0) {
                history.append("Belum ada riwayat Z-Score untuk pasien ini.");
            }
            ...
            JOptionPane.showMessageDialog(rootPane, scrollPane,
                    "Riwayat Z-Score WHO", JOptionPane.INFORMATION_MESSAGE);

        } catch (SQLException e) {
            JOptionPane.showMessageDialog(rootPane,
                    "Error mengambil riwayat: " + e.getMessage(),
                    "Database Error", JOptionPane.ERROR_MESSAGE);
        }
    }

// =====================================================
// 4. METHOD UNTUK CHECK DUPLIKASI DATA HARI INI
// =====================================================
    private boolean isZScoreExistsToday(String noRawat) {
        Connection conn = koneksiDB.condb();
        if (conn == null) {
            return false;
        }
        ...
        try {
            String sql = "SELECT COUNT(*) as count FROM zscore_who_anthro WHERE no_rawat = ? AND DATE(tanggal_periksa) = CURDATE()";
            PreparedStatement ps = conn.prepareStatement(sql);
            ps.setString(1, noRawat);
            ResultSet rs = ps.executeQuery();
    ...
    private void BtnHitungZScoreKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnHitungZScoreKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_BtnHitungZScoreKeyPressed
    ...
    private widget.Button BtnAmbilDataKeperawatan;
    private widget.Button BtnBatal;
    private widget.Button BtnCari;
    private widget.Button BtnDokter;
    private widget.Button BtnEdit;
    private widget.Button BtnHapus;
    private widget.Button BtnHitungZScore;
    ...
    private widget.TextBox txtLingkarKepala;
    ...
    private void isRawat() {
        try {
            ps = koneksi.prepareStatement(
                    "select reg_periksa.no_rkm_medis,concat(reg_periksa.umurdaftar,' ',reg_periksa.sttsumur)as umur,pasien.nm_pasien, if(pasien.jk='L','Laki-Laki','Perempuan') as jk,pasien.tgl_lahir,reg_periksa.tgl_registrasi "
                    + "from reg_periksa inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "
    ...
    private void isOtomatis() {
        try {
            ps = koneksi.prepareStatement(
                    "SELECT penilaian_awal_keperawatan_ralan_bayi.no_rawat, penilaian_awal_keperawatan_ralan_bayi.td, penilaian_awal_keperawatan_ralan_bayi.nadi, "
                    + "penilaian_awal_keperawatan_ralan_bayi.rr, penilaian_awal_keperawatan_ralan_bayi.suhu, penilaian_awal_keperawatan_ralan_bayi.gcs, "
                    + "penilaian_awal_keperawatan_ralan_bayi.bb, penilaian_awal_keperawatan_ralan_bayi.tb FROM penilaian_awal_keperawatan_ralan_bayi "
                    + "where penilaian_awal_keperawatan_ralan_bayi.no_rawat=?");
            try {
                ps.setString(1, TNoRw.getText());
                rs = ps.executeQuery();
                if (rs.next()) {
