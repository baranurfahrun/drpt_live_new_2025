...
public final class RMPenilaianAwalMedisRalanNeurologi extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        BtnAmbilDataKeperawatan1 = new widget.Button();
        ...
        BtnAmbilDataKeperawatan1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/search_page.png"))); // NOI18N
        BtnAmbilDataKeperawatan1.setMnemonic('S');
        BtnAmbilDataKeperawatan1.setText("Ambil data Awal Keperawatan ");
        BtnAmbilDataKeperawatan1.setToolTipText("Alt+S");
        BtnAmbilDataKeperawatan1.setName("BtnAmbilDataKeperawatan1"); // NOI18N
        BtnAmbilDataKeperawatan1.setPreferredSize(new java.awt.Dimension(100, 30));
        BtnAmbilDataKeperawatan1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnAmbilDataKeperawatan1ActionPerformed(evt);
            }
        });
        BtnAmbilDataKeperawatan1.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                BtnAmbilDataKeperawatan1KeyPressed(evt);
            }
        });
        FormInput.add(BtnAmbilDataKeperawatan1);
        BtnAmbilDataKeperawatan1.setBounds(860, 90, 270, 30);
    ...
    private void BtnAmbilDataKeperawatan1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnAmbilDataKeperawatan1ActionPerformed
        try {
            ps = koneksi.prepareStatement(
    ...
    }//GEN-LAST:event_BtnAmbilDataKeperawatan1ActionPerformed

    private void BtnAmbilDataKeperawatan1KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnAmbilDataKeperawatan1KeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_BtnAmbilDataKeperawatan1KeyPressed
    ...
    */
    ...
    private widget.Button BtnAmbilDataKeperawatan1;
