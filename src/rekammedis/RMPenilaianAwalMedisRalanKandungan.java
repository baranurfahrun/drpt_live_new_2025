...
public final class RMPenilaianAwalMedisRalanKandungan extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        BtnAmbilAwalKebidanan = new widget.Button();
        ...
        TglAsuhan.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "24-01-2024 04:43:43" }));
        ...
        BtnAmbilAwalKebidanan.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/search_page.png"))); // NOI18N
        BtnAmbilAwalKebidanan.setMnemonic('S');
        BtnAmbilAwalKebidanan.setText("Ambi dari Awal Kebidanan");
        BtnAmbilAwalKebidanan.setToolTipText("Alt+S");
        BtnAmbilAwalKebidanan.setName("BtnAmbilAwalKebidanan"); // NOI18N
        BtnAmbilAwalKebidanan.setPreferredSize(new java.awt.Dimension(100, 30));
        BtnAmbilAwalKebidanan.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnAmbilAwalKebidananActionPerformed(evt);
            }
        });
        BtnAmbilAwalKebidanan.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                BtnAmbilAwalKebidananKeyPressed(evt);
            }
        });
        FormInput.add(BtnAmbilAwalKebidanan);
        BtnAmbilAwalKebidanan.setBounds(860, 90, 220, 30);
    ...
    private void BtnAmbilAwalKebidananActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnAmbilAwalKebidananActionPerformed
        try {
            ps = koneksi.prepareStatement("SELECT penilaian_awal_keperawatan_kebidanan.no_rawat, penilaian_awal_keperawatan_kebidanan.td, "
                + "penilaian_awal_keperawatan_kebidanan.nadi, penilaian_awal_keperawatan_kebidanan.rr, penilaian_awal_keperawatan_kebidanan.suhu, "
                + "penilaian_awal_keperawatan_kebidanan.gcs, penilaian_awal_keperawatan_kebidanan.tfu, penilaian_awal_keperawatan_kebidanan.tbj, "
                + "penilaian_awal_keperawatan_kebidanan.bjj, penilaian_awal_keperawatan_kebidanan.keluhan_utama, penilaian_awal_keperawatan_kebidanan.usia_kehamilan, "
                + "penilaian_awal_keperawatan_kebidanan.hpht, penilaian_awal_keperawatan_kebidanan.g, penilaian_awal_keperawatan_kebidanan.p, "
                + "penilaian_awal_keperawatan_kebidanan.a,penilaian_awal_keperawatan_kebidanan.tb,penilaian_awal_keperawatan_kebidanan.bb, penilaian_awal_keperawatan_kebidanan.tp "
            ...
            try {
                ...
                while(rs.next()){
                    ...
                    RPS.setText("G"+rs.getString("g")+" P"+rs.getString("p")+" A"+rs.getString("a")+"\n HPHT: "+rs.getString("hpht")+", Usia Kehamilan:"+rs.getString("usia_kehamilan")+", Taksiran Persalinan: "+rs.getString("tp"));
    ...
    }//GEN-LAST:event_BtnAmbilAwalKebidananActionPerformed

    private void BtnAmbilAwalKebidananKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnAmbilAwalKebidananKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_BtnAmbilAwalKebidananKeyPressed
    ...
    */
    ...
    private widget.Button BtnAmbilAwalKebidanan;
    ...
    private void isRawat() {
        ...
        if(Sequel.cariInteger("select count(no_rawat) from penilaian_awal_keperawatan_kebidanan where no_rawat='"+TNoRw.getText()+"' ")>0){ 
            Suhu.setText(Sequel.cariIsi("select suhu from penilaian_awal_keperawatan_kebidanan where no_rawat=?",TNoRw.getText())); 
            TD.setText(Sequel.cariIsi("select td from penilaian_awal_keperawatan_kebidanan where no_rawat=?",TNoRw.getText())); 
            BB.setText(Sequel.cariIsi("select bb from penilaian_awal_keperawatan_kebidanan where no_rawat=?",TNoRw.getText())); 
            TB.setText(Sequel.cariIsi("select tb from penilaian_awal_keperawatan_kebidanan where no_rawat=?",TNoRw.getText())); 
            Nadi.setText(Sequel.cariIsi("select nadi from penilaian_awal_keperawatan_kebidanan where no_rawat=?",TNoRw.getText())); 
            RR.setText(Sequel.cariIsi("select rr from penilaian_awal_keperawatan_kebidanan where no_rawat=?",TNoRw.getText())); 
            GCS.setText(Sequel.cariIsi("select gcs from penilaian_awal_keperawatan_kebidanan where no_rawat=?",TNoRw.getText())); 
            KeluhanUtama.setText(Sequel.cariIsi("select keluhan_utama from penilaian_awal_keperawatan_kebidanan where no_rawat=?",TNoRw.getText())); 
        }
    }
