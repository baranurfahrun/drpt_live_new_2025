...
public final class BPJSDataSEP extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        TanggalPulang.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "19-11-2025 10:29:15" }));
        ...
        TanggalKematian.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "19-11-2025" }));
        ...
        TanggalRujukKeluar.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "19-11-2025" }));
        ...
        TanggalKunjungRujukan.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "19-11-2025" }));
        ...
        TanggalSEP.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "19-11-2025" }));
        ...
        TanggalRujuk.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "19-11-2025" }));
        ...
        NmPenyakit.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                NmPenyakitActionPerformed(evt);
            }
        });
        ...
        TanggalKKL.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "19-11-2025" }));
        ...
        NoLP.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                NoLPActionPerformed(evt);
            }
        });
        ...
        DTPCariInternal.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "19-11-2025" }));
        ...
        DTPCariInternal2.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "19-11-2025" }));
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if (TNoRw.getText().trim().equals("") || TPasien.getText().trim().equals("")) {
            ...
            Valid.textKosong(NoTelp, "No Telpon Harus Format Awalnya 08,10-13 digit"); // bara
            ...
            if (no_peserta.trim().equals("")) {
                ...
                if (cekViaBPJSKartu.informasi.equals("OK")) {
                    if (cekViaBPJSKartu.statusPesertaketerangan.equals("AKTIF")) {
                        ...
                        // Set No.Telp dengan validasi
                        String noTelpBPJS = cekViaBPJSKartu.mrnoTelepon;
                        if (noTelpBPJS != null && !noTelpBPJS.trim().equals("") && !noTelpBPJS.equals("null") && !noTelpBPJS.equals("0") && !noTelpBPJS.equals("-")) {
                            NoTelp.setText(noTelpBPJS);
                        } else {
                            // Fallback: ambil dari database lokal
                            String noTelpDB = Sequel.cariIsi("select pasien.no_tlp from pasien where pasien.no_rkm_medis=?", TNoRM.getText());
                            if (noTelpDB != null && !noTelpDB.trim().equals("") && !noTelpDB.equals("0") && !noTelpDB.equals("-")) {
                                NoTelp.setText(noTelpDB);
                            } else {
                                NoTelp.setText("");
                            }
                        }
    ...
    private void TNoRMActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_TNoRMActionPerformed
        // Auto-fill No.Telp berdasarkan No.RM pasien
        String noRM = TNoRM.getText().trim();
        if (!noRM.equals("")) {
            try {
                PreparedStatement ps = koneksi.prepareStatement("select no_tlp from pasien where no_rkm_medis=?");
                ps.setString(1, noRM);
                ResultSet rs = ps.executeQuery();
                if (rs.next()) {
                    String noTelepon = rs.getString("no_tlp");
                    if (noTelepon != null && !noTelepon.trim().equals("") && !noTelepon.equals("0") && !noTelepon.equals("-")) {
                ...
                System.out.println("Error getting phone number from No.RM: " + e);
                NoTelp.setText("");
            }
        }
    ...
    private void NmPenyakitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_NmPenyakitActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_NmPenyakitActionPerformed
    ...
    private void NoLPActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_NoLPActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_NoLPActionPerformed
    ...
    private void isRawat() {
        ...
        // Auto-fill No.Telp berdasarkan no_rawat menggunakan JOIN query untuk menghindari masalah timing
        if (!TNoRw.getText().trim().equals("")) {
            try {
                PreparedStatement ps = koneksi.prepareStatement(
                    "select p.no_tlp from reg_periksa r " +
                ...
                System.out.println("Error getting phone number: " + e);
            }
        }
    }
    ...
    private void getData() {
        if (tbDataSEP.getSelectedRow() != -1) {
            ...
            // Auto-fill No.Telp dari tabel pasien jika kosong atau tidak valid
            String noTelpDariSEP = tbDataSEP.getValueAt(tbDataSEP.getSelectedRow(), 31).toString();
            if (noTelpDariSEP == null || noTelpDariSEP.trim().equals("") || noTelpDariSEP.equals("0") || noTelpDariSEP.equals("-")) {
                String noRM = TNoRM.getText().trim();
                if (!noRM.equals("")) {
                    try {
                        PreparedStatement ps = koneksi.prepareStatement("select no_tlp from pasien where no_rkm_medis=?");
                        ...
                        System.out.println("Error getting phone number in getData: " + e);
                    }
                }
            }
    ...
    private void getDataInternal() {
        if (tbDataSEPInternal.getSelectedRow() != -1) {
            ...
            // Auto-fill No.Telp dari tabel pasien jika kosong atau tidak valid
            String noTelpDariSEP = tbDataSEPInternal.getValueAt(tbDataSEPInternal.getSelectedRow(), 31).toString();
            if (noTelpDariSEP == null || noTelpDariSEP.trim().equals("") || noTelpDariSEP.equals("null") || noTelpDariSEP.equals("0") || noTelpDariSEP.equals("-")) {
                String noRM = TNoRM.getText().trim();
                if (!noRM.equals("")) {
                    try {
                        PreparedStatement ps = koneksi.prepareStatement("select no_tlp from pasien where no_rkm_medis=?");
                        ...
                        System.out.println("Error getting phone number in getDataInternal: " + e);
                    }
                }
            }
                    ...
                    if (!NoRujukan.getText().equals("")) {
                        try {
                            ...
                            koneksi.prepareStatement(
                                    "insert into log_add_antrian values('0','" + Valid.SetTgl(TanggalSEP.getSelectedItem() + "") + "','" + TNoRw.getText() + "','addantrian-onsite','khanza','" + utc + "','" + TPasien.getText() + "','" + TNoRw.getText() + "',"
    ...
    // METHOD UTAMA - PEMISAHAN PROSES YANG TETAP MENGGUNAKAN LOGIKA ASLI
    public boolean SimpanAntrianOnSite() {
        statusantrean = true;

        // SKENARIO 1: Jika data sudah ada di referensi_mobilejkn_bpjs
        if (Sequel.cariInteger("select count(referensi_mobilejkn_bpjs.no_rawat) from referensi_mobilejkn_bpjs where referensi_mobilejkn_bpjs.no_rawat=?", TNoRw.getText()) == 1) {
            statusantrean = prosesAntrianExisting();
        }

        // SKENARIO 2: Jika data belum ada di referensi_mobilejkn_bpjs
        if (Sequel.cariInteger("select count(referensi_mobilejkn_bpjs.no_rawat) from referensi_mobilejkn_bpjs where referensi_mobilejkn_bpjs.no_rawat=?", TNoRw.getText()) == 0) {
            statusantrean = prosesAntrianBaru();
        }

        return statusantrean;
    }

// METHOD TERPISAH UNTUK ANTRIAN YANG SUDAH ADA
    private boolean prosesAntrianExisting() {
        ...
        try {
            ...
            while (rs2.next()) {
                // STEP 1: Kirim Antrian ke BPJS
                boolean antrianSuccess = kirimAntrianExisting(rs2);

                if (antrianSuccess) {
                    // STEP 2: Tunggu sebentar untuk memastikan antrian terdaftar di BPJS
                    Thread.sleep(2000); // Tunggu 2 detik

                    // STEP 3: Kirim Task ID 3
                    executeTaskId3(rs2.getString("nobooking"), rs2.getString("tanggalperiksa"),
                            rs2.getString("nm_pasien"), rs2.getString("nm_poli"));
                } else {
                    success = false;
                }
            }
            ...
            success = false;
            System.out.println("ERROR prosesAntrianExisting: " + e.getMessage());
            e.printStackTrace();
        } finally {
...
// METHOD TERPISAH UNTUK ANTRIAN BARU
    private boolean prosesAntrianBaru() {
        if ((!NoRujukan.getText().equals("")) || (!NoSKDP.getText().equals(""))) {

            // Tentukan jenis kunjungan - SESUAI LOGIKA ASLI
            determineJenisKunjungan();

            // Setup jadwal dokter - SESUAI LOGIKA ASLI
            if (!setupJadwalDokter()) {
                return false;
            }

            // STEP 1: Kirim Antrian Baru ke BPJS
            boolean antrianSuccess = kirimAntrianBaru();
            ...
            if (antrianSuccess) {
                ...
                // STEP 3: Kirim Task ID 3
                executeTaskId3(TNoRw.getText(), Valid.SetTgl(TanggalSEP.getSelectedItem() + ""),
                        TPasien.getText(), NmPoli.getText());
...
// METHOD HELPER UNTUK LOG ANTRIAN ACTION
    private void logAntrianAction(String tanggal, String nobooking, String action, String namaPasien, String noRawat, String namaPoli) {
        try {
            koneksi.prepareStatement(
                    "insert into log_add_antrian values('0','" + tanggal + "','" + nobooking + "','" + action + "','khanza','" + utc + "','" + namaPasien + "','" + noRawat + "',"
                    + "'" + namaPoli + "','" + root + "','" + nameNode.path("code").asText() + "','" + requestJson + "','" + headers + "','" + URL + "')").executeUpdate();

            System.out.println("Log antrian action berhasil disimpan: " + action);
        } catch (Exception e) {
            System.out.println("ERROR log antrian action: " + e.getMessage());
        }
    }

// METHOD HELPER UNTUK DETERMINE JENIS KUNJUNGAN - SESUAI LOGIKA ASLI
    private void determineJenisKunjungan() {
        if (TujuanKunjungan.getSelectedItem().toString().trim().equals("0. Normal") && FlagProsedur.getSelectedItem().toString().trim().equals("") && Penunjang.getSelectedItem().toString().trim().equals("") && AsesmenPoli.getSelectedItem().toString().trim().equals("")) {
            if (AsalRujukan.getSelectedIndex() == 0) {
                jeniskunjungan = "1";
            } else {
        ...
        System.out.println("Jenis kunjungan ditentukan: " + jeniskunjungan);
    }

// METHOD HELPER UNTUK SETUP JADWAL DOKTER - SESUAI LOGIKA ASLI
    private boolean setupJadwalDokter() {
        try {
            day = cal.get(Calendar.DAY_OF_WEEK);
            switch (day) {
                case 1:
            ...
            System.out.println("ERROR setup jadwal: " + e.getMessage());
            e.printStackTrace();
            return false;
        } finally {
...
// METHOD HELPER UNTUK CLOSE RESOURCES
...
// METHOD EXECUTE TASK ID 3 (YANG SUDAH DIPERBAIKI SEBELUMNYA)
    private void executeTaskId3(String kodebooking, String tanggalRegistrasi, String namaPasien, String namaPoli) {
        try {
            System.out.println("=== MULAI EXECUTE TASK ID 3 ===");
            System.out.println("Kodebooking: " + kodebooking);

            LocalDateTime now = LocalDateTime.now();
            DateTimeFormatter formatter = DateTimeFormatter.ofPattern("yyyy-MM-dd HH:mm:ss");
            String datajam = now.format(formatter);
            Date parsedDateTask = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss").parse(datajam);

            System.out.println("Menjalankan WS taskid mulai tunggu poli Mobile JKN Pasien BPJS");

            HttpHeaders headersTask = new HttpHeaders();
            headersTask.setContentType(MediaType.APPLICATION_JSON);
            headersTask.add("x-cons-id", koneksiDB.CONSIDAPIMOBILEJKN());
            String utcTask = String.valueOf(api.GetUTCdatetimeAsString());
            headersTask.add("x-timestamp", utcTask);
            headersTask.add("x-signature", api.getHmac(utcTask));
            headersTask.add("user_key", koneksiDB.USERKEYAPIMOBILEJKN());

            String requestJsonTask = "{"
                    + "\"kodebooking\": \"" + kodebooking + "\","
                    + "\"taskid\": \"3\","
                    + "\"waktu\": \"" + parsedDateTask.getTime() + "\""
                    + "}";

            System.out.println("JSON Request Task ID 3: " + requestJsonTask);

            HttpEntity requestEntityTask = new HttpEntity(requestJsonTask, headersTask);
            String URLTask = koneksiDB.URLAPIMOBILEJKN() + "/antrean/updatewaktu";
            System.out.println("URL Task ID 3: " + URLTask);

            String responseBodyTask = api.getRest().exchange(URLTask, HttpMethod.POST, requestEntityTask, String.class).getBody();
            JsonNode rootTask = mapper.readTree(responseBodyTask);
            JsonNode nameNodeTask = rootTask.path("metadata");

            String responseCodeTask = nameNodeTask.path("code").asText();
            String responseMessageTask = nameNodeTask.path("message").asText();

            System.out.println("Response WS BPJS Task ID 3: " + responseCodeTask + " " + responseMessageTask);

            if (!responseCodeTask.equals("200")) {
                System.out.println("Response code bukan 200, menghapus dari referensi_mobilejkn_bpjs_taskid");
                Sequel.queryu2("delete from referensi_mobilejkn_bpjs_taskid where taskid='3' and no_rawat='" + kodebooking + "'");
            }

            // SIMPAN LOG TASK ID 3
            try {
                System.out.println("=== SIMPAN LOG TASK ID 3 ===");

                String insertSQL = "INSERT INTO log_add_antrian VALUES(?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
                PreparedStatement psLog = koneksi.prepareStatement(insertSQL);

                psLog.setString(1, "0");
                psLog.setString(2, tanggalRegistrasi);
                psLog.setString(3, kodebooking);
                psLog.setString(4, "3");
                psLog.setString(5, "khanza");
                psLog.setString(6, utcTask);
                psLog.setString(7, namaPasien);
                psLog.setString(8, kodebooking);
                psLog.setString(9, namaPoli);
                psLog.setString(10, rootTask.toString());
                psLog.setString(11, responseCodeTask);
                psLog.setString(12, requestJsonTask);
                psLog.setString(13, headersTask.toString());
                psLog.setString(14, URLTask);

                int logResult = psLog.executeUpdate();
                psLog.close();

                System.out.println("=== BERHASIL SIMPAN LOG TASK ID 3 ===");
                System.out.println("Rows affected: " + logResult);

            } catch (Exception logEx) {
                System.out.println("ERROR simpan log Task ID 3: " + logEx.getMessage());
                logEx.printStackTrace();
            }

        } catch (Exception ex) {
            System.out.println("ERROR execute Task ID 3: " + ex.getMessage());
            ex.printStackTrace();
        }
    }

    private boolean kirimAntrianExisting(ResultSet rs2) {
        try {
            headers = new HttpHeaders();
            headers.setContentType(MediaType.APPLICATION_JSON);
            headers.add("x-cons-id", koneksiDB.CONSIDAPIMOBILEJKN());
            ...
            // MENGGUNAKAN LOGIKA ASLI - SESUAI KODE ORIGINAL
            requestJson = "{"
            ...
            System.out.println("=== KIRIM ANTRIAN EXISTING (LOGIKA ASLI) ===");
            System.out.println("JSON : " + requestJson);
            ...
            System.out.println("Response Add Antrian Existing: " + responseCode + " " + nameNode.path("message").asText());
            ...
            if (responseCode.equals("200")) {
                ...
                logAntrianAction(rs2.getString("tanggalperiksa"), rs2.getString("nobooking"), "addantrian-mjkn",
                        rs2.getString("nm_pasien"), rs2.getString("no_rawat"), rs2.getString("nm_poli"));
                return true;
            }
            ...
            System.out.println("ERROR kirimAntrianExisting: " + e.getMessage());
            e.printStackTrace();
            return false;
        }
    }

    // METHOD UNTUK KIRIM ANTRIAN BARU (MENGGUNAKAN LOGIKA ASLI)
    private boolean kirimAntrianBaru() {
        try {
            headers = new HttpHeaders();
            headers.setContentType(MediaType.APPLICATION_JSON);
            headers.add("x-cons-id", koneksiDB.CONSIDAPIMOBILEJKN());
            ...
            String nomorReferensi = jeniskunjungan.equals("3") ? NoSKDP.getText() : NoRujukan.getText();
            ...
            System.out.println("=== KIRIM ANTRIAN BARU (LOGIKA ASLI) ===");
            System.out.println("Jenis Kunjungan: " + jeniskunjungan);
            System.out.println("JSON : " + requestJson);
            ...
            String responseCode = nameNode.path("code").asText();
            System.out.println("Response Add Antrian Baru: " + responseCode + " " + nameNode.path("message").asText());

            if (responseCode.equals("200")) {
                String referensiSimpan = jeniskunjungan.equals("3") ? NoSKDP.getText() : NoRujukan.getText();
                Sequel.menyimpantf2("referensi_addantrian_bpjs_onsite", "?,?,?,?,?", "Addantrian Onsite", 5, new String[]{
                    TNoRM.getText(), TNoRw.getText(), referensiSimpan, "Sudah", TNoRw.getText()});

                logAntrianAction(Valid.SetTgl(TanggalSEP.getSelectedItem() + ""), TNoRw.getText(), "addantrian-onsite",
                        TPasien.getText(), TNoRw.getText(), NmPoli.getText());
                return true;
            }
            ...
            System.out.println("ERROR kirimAntrianBaru: " + e.getMessage());
            e.printStackTrace();
            return false;
        }
    }
