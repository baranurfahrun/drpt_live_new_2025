 ...
 * @author perpustakaan
 */
public final class BPJSDataSEP_THB extends javax.swing.JDialog {
...
//    private Connection koneksibpjs = koneksiDBBpjs.condb();
    ...
    private String prb = "", no_peserta = "", link = "", ADDANTRIANAPIMOBILEJKN = "no", requestJson, URL = "", query = "", utc = "", user = "", kddokter = "", tglkkl = "0000-00-00", penunjang = "", kodedokterreg = "", kodepolireg = "",
            jammulai = "", jamselesai = "", datajam = "", jeniskunjungan = "", hari = "", nomorreg = "", respon = "200",nobooking="";
     ...
     * @param modal
     */
    public BPJSDataSEP_THB(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        TanggalPulang.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "04-09-2024 18:31:32" }));
        ...
        TanggalKematian.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "04-09-2024" }));
        ...
        TanggalRujukKeluar.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "04-09-2024" }));
        ...
        TanggalKunjungRujukan.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "04-09-2024" }));
        ...
        AsesmenPoli.addPropertyChangeListener(new java.beans.PropertyChangeListener() {
            public void propertyChange(java.beans.PropertyChangeEvent evt) {
                AsesmenPoliPropertyChange(evt);
            }
        });
        ...
        btnRiwayatRujukan.setBounds(780, 70, 110, 23);
        ...
        DTPCariInternal.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "04-09-2024" }));
        ...
        DTPCariInternal2.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "04-09-2024" }));
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if (TNoRw.getText().trim().equals("") || TPasien.getText().trim().equals("")) {
            ...
            Valid.textKosong(NoTelp, "No Telpon Harus Format Awalnya 08,10-13 digit");
        } else {
    ...
    private void AsesmenPoliPropertyChange(java.beans.PropertyChangeEvent evt) {//GEN-FIRST:event_AsesmenPoliPropertyChange
        
    }//GEN-LAST:event_AsesmenPoliPropertyChange

    private void NoSKDPPropertyChange(java.beans.PropertyChangeEvent evt) {//GEN-FIRST:event_NoSKDPPropertyChange

    }//GEN-LAST:event_NoSKDPPropertyChange
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            BPJSDataSEP_THB dialog = new BPJSDataSEP_THB(new javax.swing.JFrame(), true);
            ...
            if ((!NoRujukan.getText().isEmpty()) || (!NoSKDP.getText().isEmpty())) {
                if (TujuanKunjungan.getSelectedItem().toString().trim().equals(
                        ...
                        && FlagProsedur.getSelectedItem().toString().trim().
                                isEmpty()
                        && Penunjang.getSelectedItem().toString().trim().
                                isEmpty()
                        && AsesmenPoli.getSelectedItem().toString().trim().
                                isEmpty()) {
                    if (AsalRujukan.getSelectedIndex() == 0 && (NoSKDP.getText().
                            isEmpty())) {
                        jeniskunjungan = "1";
                    } else {
                        if (AsalRujukan.getSelectedIndex() == 1 && (NoSKDP.
                                getText().isEmpty())) {
                            jeniskunjungan = "4";
                        }
                    }
