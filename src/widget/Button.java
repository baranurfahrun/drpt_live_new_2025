...
public class Button extends JButton {
    ...
    private void addMouseEffects() {
        ...
        this.addMouseListener(new MouseAdapter() {
            ...
            public void mouseEntered(MouseEvent e) {
                setBackground(new Color(251, 243, 185));  // Warna abu-abu saat disentuh
            }
    ...
    protected void paintComponent(Graphics g) {
        ...
        /**
     * Dummy method agar kompatibel dengan pemanggilan lama.
     * Tidak melakukan apa-apa karena efek glass tidak digunakan di sini.
     */
    public void setRoundRect(boolean round) {
        // Tidak digunakan. Disediakan agar kompatibel.
    }

    /**
     * Dummy method agar kompatibel dengan pemanggilan lama.
     * Tidak melakukan apa-apa karena tidak menggunakan efek glass.
     */
