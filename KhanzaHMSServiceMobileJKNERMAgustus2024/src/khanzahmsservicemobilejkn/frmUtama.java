                ...
                if (detik.equals("01") && ((nilai_menit % 5) == 0)) {
                    ...
                    try {
                        ...
                        ps = koneksi.prepareStatement(
                                ...
                                + "referensi_mobilejkn_bpjs.kuotajkn,referensi_mobilejkn_bpjs.sisakuotanonjkn,referensi_mobilejkn_bpjs.kuotanonjkn,reg_periksa.tgl_registrasi "
                            ...
                            while (rs.next()) {
                                try {
                                    ...
                                    koneksibpjs.prepareStatement(
                                            "insert into log_add_antrian values('0','" + rs.getString("tgl_registrasi") + "','" + rs.getString("nobooking") + "','addantrian','admin','" + utc + "','" + rs.getString("nm_pasien") + "','" + rs.getString("no_rawat") + "',"
                        ...
                        ps = koneksi.prepareStatement(
                                ...
                                + "referensi_mobilejkn_bpjs.kodepoli,referensi_mobilejkn_bpjs.pasienbaru,referensi_mobilejkn_bpjs.kodedokter,referensi_mobilejkn_bpjs.jampraktek,"
                                + "referensi_mobilejkn_bpjs.nomorantrean,referensi_mobilejkn_bpjs.angkaantrean,referensi_mobilejkn_bpjs.estimasidilayani,referensi_mobilejkn_bpjs.sisakuotajkn,"
                                + "referensi_mobilejkn_bpjs.kuotajkn,referensi_mobilejkn_bpjs.sisakuotanonjkn,referensi_mobilejkn_bpjs.kuotanonjkn,reg_periksa.tgl_registrasi,reg_periksa.kd_dokter "
                                + "FROM referensi_mobilejkn_bpjs INNER JOIN reg_periksa ON referensi_mobilejkn_bpjs.no_rawat=reg_periksa.no_rawat "
                                + "INNER JOIN pasien ON reg_periksa.no_rkm_medis=pasien.no_rkm_medis "
                                + "INNER JOIN poliklinik ON reg_periksa.kd_poli=poliklinik.kd_poli "
                                + "INNER JOIN dokter ON reg_periksa.kd_dokter=dokter.kd_dokter "
                                    ...
                                    if (!datajam.equals("")) {
                                        if (Sequel.menyimpantf2("referensi_mobilejkn_bpjs_taskid", "?,?,?", "task id", 3, new String[]{rs.getString("no_rawat"), "3", datajam}) == true) {
                                            ...
                                            try {
                                                ...
                                                TeksArea.append("respon WS BPJS : " + nameNode.path("code").asText() + " " + nameNode.path("message").asText() + "\n");
                                                koneksibpjs.prepareStatement(
                                                        "insert into log_add_antrian values('0','" + rs.getString("tgl_registrasi") + "','" + rs.getString("nobooking") + "','3','admin','" + utc + "','" + rs.getString("nm_pasien") + "','" + rs.getString("no_rawat") + "',"
                                                        + "'" + rs.getString("nm_poli") + "','" + root + "','" + nameNode.path("code").asText() + "','" + requestJson + "','" + headers + "','" + URL + "')").executeUpdate();
                                            } catch (Exception ex) {
                                                System.out.println("Notifikasi Bridging : " + ex);
                                            }
                                    ...
                                    if (!datajam.equals("")) {
                                        if (Sequel.menyimpantf2("referensi_mobilejkn_bpjs_taskid", "?,?,?", "task id", 3, new String[]{rs.getString("no_rawat"), "4", datajam}) == true) {
                                            ...
                                            try {
                                                ...
                                                TeksArea.append("respon WS BPJS : " + nameNode.path("code").asText() + " " + nameNode.path("message").asText() + "\n");
                                                koneksibpjs.prepareStatement(
                                                        "insert into log_add_antrian values('0','" + rs.getString("tgl_registrasi") + "','" + rs.getString("nobooking") + "','4','admin','" + utc + "','" + rs.getString("nm_pasien") + "','" + rs.getString("no_rawat") + "',"
                                                        + "'" + rs.getString("nm_poli") + "','" + root + "','" + nameNode.path("code").asText() + "','" + requestJson + "','" + headers + "','" + URL + "')").executeUpdate();
                                            } catch (Exception ex) {
                                                System.out.println("Notifikasi Bridging : " + ex);
                                            }
                                    ...
                                    if (!datajam.equals("")) {
                                        if (Sequel.menyimpantf2("referensi_mobilejkn_bpjs_taskid", "?,?,?", "task id", 3, new String[]{rs.getString("no_rawat"), "5", datajam}) == true) {
                                            ...
                                            try {
                                                ...
                                                TeksArea.append("respon WS BPJS : " + nameNode.path("code").asText() + " " + nameNode.path("message").asText() + "\n");
                                                koneksibpjs.prepareStatement(
                                                        "insert into log_add_antrian values('0','" + rs.getString("tgl_registrasi") + "','" + rs.getString("nobooking") + "','5','admin','" + utc + "','" + rs.getString("nm_pasien") + "','" + rs.getString("no_rawat") + "',"
                                                        + "'" + rs.getString("nm_poli") + "','" + root + "','" + nameNode.path("code").asText() + "','" + requestJson + "','" + headers + "','" + URL + "')").executeUpdate();
                                            } catch (Exception ex) {
                                                System.out.println("Notifikasi Bridging : " + ex);
                                            }
                                ...
                                if (task6.equals("")) {
                                    ...
                                    if (!noresep.equals("")) {
                                        try {
                                            ...
                                            TeksArea.append("respon WS BPJS : " + nameNode.path("code").asText() + " " + nameNode.path("message").asText() + "\n");
                                            koneksibpjs.prepareStatement(
                                                    "insert into log_add_antrian values('0','" + rs.getString("tgl_registrasi") + "','" + rs.getString("nobooking") + "','addantrianfarmasi','admin','" + utc + "','" + rs.getString("nm_pasien") + "','" + rs.getString("no_rawat") + "',"
                                                    + "'" + rs.getString("nm_poli") + "','" + root + "','" + nameNode.path("code").asText() + "','" + requestJson + "','" + headers + "','" + URL + "')").executeUpdate();
                                        } catch (Exception ex) {
                                            System.out.println("Notifikasi Bridging : " + ex);
                                        }
                                    ...
                                    if (!datajam.equals("")) {
                                        if (Sequel.menyimpantf2("referensi_mobilejkn_bpjs_taskid", "?,?,?", "task id", 3, new String[]{rs.getString("no_rawat"), "6", datajam}) == true) {
                                            ...
                                            try {
                                                ...
                                                TeksArea.append("respon WS BPJS : " + nameNode.path("code").asText() + " " + nameNode.path("message").asText() + "\n");
                                                koneksibpjs.prepareStatement(
                                                        "insert into log_add_antrian values('0','" + rs.getString("tgl_registrasi") + "','" + rs.getString("nobooking") + "','6','admin','" + utc + "','" + rs.getString("nm_pasien") + "','" + rs.getString("no_rawat") + "',"
                                                        + "'" + rs.getString("nm_poli") + "','" + root + "','" + nameNode.path("code").asText() + "','" + requestJson + "','" + headers + "','" + URL + "')").executeUpdate();
                                            } catch (Exception ex) {
                                                System.out.println("Notifikasi Bridging : " + ex);
                                            }
                                    ...
                                    if (!datajam.equals("")) {
                                        if (Sequel.menyimpantf2("referensi_mobilejkn_bpjs_taskid", "?,?,?", "task id", 3, new String[]{rs.getString("no_rawat"), "7", datajam}) == true) {
                                            ...
                                            try {
                                                ...
                                                TeksArea.append("respon WS BPJS : " + nameNode.path("code").asText() + " " + nameNode.path("message").asText() + "\n");
                                                koneksibpjs.prepareStatement(
                                                        "insert into log_add_antrian values('0','" + rs.getString("tgl_registrasi") + "','" + rs.getString("nobooking") + "','7','admin','" + utc + "','" + rs.getString("nm_pasien") + "','" + rs.getString("no_rawat") + "',"
                                                        + "'" + rs.getString("nm_poli") + "','" + root + "','" + nameNode.path("code").asText() + "','" + requestJson + "','" + headers + "','" + URL + "')").executeUpdate();
                                            } catch (Exception ex) {
                                                System.out.println("Notifikasi Bridging : " + ex);
                                            }
                                    ...
                                    if (!datajam.equals("")) {
                                        if (Sequel.menyimpantf2("referensi_mobilejkn_bpjs_taskid", "?,?,?", "task id", 3, new String[]{rs.getString("no_rawat"), "99", datajam}) == true) {
                                            ...
                                            try {
                                                ...
                                                TeksArea.append("respon WS BPJS : " + nameNode.path("code").asText() + " " + nameNode.path("message").asText() + "\n");
                                                koneksibpjs.prepareStatement(
                                                        "insert into log_add_antrian values('0','" + rs.getString("tgl_registrasi") + "','" + rs.getString("nobooking") + "','addbatal','admin','" + utc + "','" + rs.getString("nm_pasien") + "','" + rs.getString("no_rawat") + "',"
                                                        + "'" + rs.getString("nm_poli") + "','" + root + "','" + nameNode.path("code").asText() + "','" + requestJson + "','" + headers + "','" + URL + "')").executeUpdate();
                                            } catch (Exception ex) {
                                                System.out.println("Notifikasi Bridging : " + ex);
                                            }
                        ...
                        //pasien BPJS Non Mobile JKN
                        TeksArea.append("Menjalankan WS tambah antrian Mobile JKN Pasien BPJS Non Mobile JKN/ Onsite\n");
                        ps = koneksi.prepareStatement(
                                "select reg_periksa.no_reg,reg_periksa.no_rawat,reg_periksa.tgl_registrasi,reg_periksa.kd_dokter,dokter.nm_dokter,reg_periksa.kd_poli,poliklinik.nm_poli,reg_periksa.stts_daftar,reg_periksa.no_rkm_medis,reg_periksa.kd_pj,reg_periksa.tgl_registrasi,pasien.nm_pasien,pasien.no_ktp,pasien.no_tlp "
                                + "from reg_periksa inner join dokter on reg_periksa.kd_dokter=dokter.kd_dokter inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis inner join poliklinik on reg_periksa.kd_poli=poliklinik.kd_poli where reg_periksa.tgl_registrasi between '" + Tanggal1.getText() + "' and '" + Tanggal2.getText() + "' "
                                                ...
                                                if (!datajam.equals("")) {
                                                    if (Sequel.menyimpantf2("referensi_mobilejkn_bpjs_taskid", "?,?,?", "task id", 3, new String[]{rs.getString("no_rawat"), "3", datajam}) == true) {
                                                        ...
                                                        try {
                                                            ...
                                                            TeksArea.append("respon WS BPJS : " + nameNode.path("code").asText() + " " + nameNode.path("message").asText() + "\n");
                                                            koneksibpjs.prepareStatement(
                                                                    "insert into log_add_antrian values('0','" + rs.getString("tgl_registrasi") + "','" + rs.getString("no_rawat") + "','3','admin','" + utc + "','" + rs.getString("nm_pasien") + "','" + rs.getString("no_rawat") + "',"
                                                                    + "'" + rs.getString("nm_poli") + "','" + root + "','" + nameNode.path("code").asText() + "','" + requestJson + "','" + headers + "','" + URL + "')").executeUpdate();
                                                        } catch (Exception ex) {
                                                            System.out.println("Notifikasi Bridging : " + ex);
                                                        }
                                                ...
                                                if (!datajam.equals("")) {
                                                    if (Sequel.menyimpantf2("referensi_mobilejkn_bpjs_taskid", "?,?,?", "task id", 3, new String[]{rs.getString("no_rawat"), "4", datajam}) == true) {
                                                        ...
                                                        try {
                                                            ...
                                                            TeksArea.append("respon WS BPJS : " + nameNode.path("code").asText() + " " + nameNode.path("message").asText() + "\n");
                                                            koneksibpjs.prepareStatement(
                                                                    "insert into log_add_antrian values('0','" + rs.getString("tgl_registrasi") + "','" + rs.getString("no_rawat") + "','4','admin','" + utc + "','" + rs.getString("nm_pasien") + "','" + rs.getString("no_rawat") + "',"
                                                                    + "'" + rs.getString("nm_poli") + "','" + root + "','" + nameNode.path("code").asText() + "','" + requestJson + "','" + headers + "','" + URL + "')").executeUpdate();
                                                        } catch (Exception ex) {
                                                            System.out.println("Notifikasi Bridging : " + ex);
                                                        }
                                                ...
                                                if (!datajam.equals("")) {
                                                    if (Sequel.menyimpantf2("referensi_mobilejkn_bpjs_taskid", "?,?,?", "task id", 3, new String[]{rs.getString("no_rawat"), "5", datajam}) == true) {
                                                        ...
                                                        try {
                                                            ...
                                                            TeksArea.append("respon WS BPJS : " + nameNode.path("code").asText() + " " + nameNode.path("message").asText() + "\n");
                                                            koneksibpjs.prepareStatement(
                                                                    "insert into log_add_antrian values('0','" + rs.getString("tgl_registrasi") + "','" + rs.getString("no_rawat") + "','5','admin','" + utc + "','" + rs.getString("nm_pasien") + "','" + rs.getString("no_rawat") + "',"
                                                                    + "'" + rs.getString("nm_poli") + "','" + root + "','" + nameNode.path("code").asText() + "','" + requestJson + "','" + headers + "','" + URL + "')").executeUpdate();
                                                        } catch (Exception ex) {
                                                            System.out.println("Notifikasi Bridging : " + ex);
                                                        }
                                            ...
                                            if (task6.equals("")) {
                                                ...
                                                if (!noresep.equals("")) {
                                                    try {
                                                        ...
                                                        TeksArea.append("respon WS BPJS : " + nameNode.path("code").asText() + " " + nameNode.path("message").asText() + "\n");
                                                        koneksibpjs.prepareStatement(
                                                                "insert into log_add_antrian values('0','" + rs.getString("tgl_registrasi") + "','" + rs.getString("no_rawat") + "','addantrianfarmasi','admin','" + utc + "','" + rs.getString("nm_pasien") + "','" + rs.getString("no_rawat") + "',"
                                                                + "'" + rs.getString("nm_poli") + "','" + root + "','" + nameNode.path("code").asText() + "','" + requestJson + "','" + headers + "','" + URL + "')").executeUpdate();
                                                ...
                                                if (!datajam.equals("")) {
                                                    if (Sequel.menyimpantf2("referensi_mobilejkn_bpjs_taskid", "?,?,?", "task id", 3, new String[]{rs.getString("no_rawat"), "6", datajam}) == true) {
                                                        ...
                                                        try {
                                                            ...
                                                            TeksArea.append("respon WS BPJS : " + nameNode.path("code").asText() + " " + nameNode.path("message").asText() + "\n");
                                                            koneksibpjs.prepareStatement(
                                                                    "insert into log_add_antrian values('0','" + rs.getString("tgl_registrasi") + "','" + rs.getString("no_rawat") + "','6','admin','" + utc + "','" + rs.getString("nm_pasien") + "','" + rs.getString("no_rawat") + "',"
                                                                    + "'" + rs.getString("nm_poli") + "','" + root + "','" + nameNode.path("code").asText() + "','" + requestJson + "','" + headers + "','" + URL + "')").executeUpdate();
                                                        } catch (Exception ex) {
                                                            System.out.println("Notifikasi Bridging : " + ex);
                                                        }
                                                ...
                                                if (!datajam.equals("")) {
                                                    if (Sequel.menyimpantf2("referensi_mobilejkn_bpjs_taskid", "?,?,?", "task id", 3, new String[]{rs.getString("no_rawat"), "7", datajam}) == true) {
                                                        ...
                                                        try {
                                                            ...
                                                            TeksArea.append("respon WS BPJS : " + nameNode.path("code").asText() + " " + nameNode.path("message").asText() + "\n");
                                                            koneksibpjs.prepareStatement(
                                                                    "insert into log_add_antrian values('0','" + rs.getString("tgl_registrasi") + "','" + rs.getString("no_rawat") + "','7','admin','" + utc + "','" + rs.getString("nm_pasien") + "','" + rs.getString("no_rawat") + "',"
                                                                    + "'" + rs.getString("nm_poli") + "','" + root + "','" + nameNode.path("code").asText() + "','" + requestJson + "','" + headers + "','" + URL + "')").executeUpdate();
                                                        } catch (Exception ex) {
                                                            System.out.println("Notifikasi Bridging : " + ex);
                                                        }
                                                ...
                                                if (!datajam.equals("")) {
                                                    if (Sequel.menyimpantf2("referensi_mobilejkn_bpjs_taskid", "?,?,?", "task id", 3, new String[]{rs.getString("no_rawat"), "99", datajam}) == true) {
                                                        ...
                                                        try {
                                                            ...
                                                            TeksArea.append("respon WS BPJS : " + nameNode.path("code").asText() + " " + nameNode.path("message").asText() + "\n");
                                                            koneksibpjs.prepareStatement(
                                                                    "insert into log_add_antrian values('0','" + rs.getString("tgl_registrasi") + "','" + rs.getString("no_rawat") + "','batal','admin','" + utc + "','" + rs.getString("nm_pasien") + "','" + rs.getString("no_rawat") + "',"
                                                                    + "'" + rs.getString("nm_poli") + "','" + root + "','" + nameNode.path("code").asText() + "','" + requestJson + "','" + headers + "','" + URL + "')").executeUpdate();
                        ...
                        ps = koneksi.prepareStatement(
                                "select reg_periksa.no_reg,reg_periksa.no_rawat,reg_periksa.tgl_registrasi,reg_periksa.kd_dokter,dokter.nm_dokter,reg_periksa.kd_poli,poliklinik.nm_poli,reg_periksa.stts_daftar,reg_periksa.no_rkm_medis,reg_periksa.kd_pj,reg_periksa.tgl_registrasi,pasien.nm_pasien "
                                + "from reg_periksa inner join dokter on reg_periksa.kd_dokter=dokter.kd_dokter inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis inner join poliklinik on reg_periksa.kd_poli=poliklinik.kd_poli where reg_periksa.tgl_registrasi between '" + Tanggal1.getText() + "' and '" + Tanggal2.getText() + "' "
                                + "and reg_periksa.no_rawat not in (select referensi_mobilejkn_bpjs.no_rawat from referensi_mobilejkn_bpjs where referensi_mobilejkn_bpjs.tanggalperiksa between '" + Tanggal1.getText() + "' and '" + Tanggal2.getText() + "') "
                                + "order by concat(reg_periksa.tgl_registrasi,' ',reg_periksa.jam_reg)");
                        try {
