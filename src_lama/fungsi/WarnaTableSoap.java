...
public class WarnaTableSoap extends DefaultTableCellRenderer {
    @Override
    public Component getTableCellRendererComponent(JTable table, Object value, boolean isSelected, boolean hasFocus, int row, int column){
        ...
        if (table.getColumnCount() > 25) {
            ...
            if (pemeriksa != null) {
                ...
                if (dokterParamedis.contains("dr")) {
                    component.setBackground(new Color(0, 255, 0)); // Warna latar hijau untuk "dr"
                    component.setForeground(new Color(0, 0, 0)); // Warna teks hitam
                } else {
                    component.setBackground(new Color(37, 99, 235)); // Warna latar  untuk yang bukan "dr"
                    component.setForeground(new Color(255, 255, 255)); // Warna teks putih agar kontras
                }
            }
        }
        ...
        if (isSelected) {
            component.setBackground(new Color(245, 188, 30)); // Warna  untuk baris yang dipilih
