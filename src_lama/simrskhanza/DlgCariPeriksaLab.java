...
import digitalsignature.DlgViewPdfLabPK;
...
public class DlgCariPeriksaLab extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        MnCetakHasilLabTTE = new javax.swing.JMenuItem();
        ...
        MnInputObatBHP = new javax.swing.JMenuItem();
        ...
        MnCetakHasilLabTTE.setBackground(new java.awt.Color(255, 255, 254));
        MnCetakHasilLabTTE.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        MnCetakHasilLabTTE.setForeground(new java.awt.Color(50, 50, 50));
        MnCetakHasilLabTTE.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        MnCetakHasilLabTTE.setText("Model 1");
        MnCetakHasilLabTTE.setActionCommand("Model 1 TTE");
        MnCetakHasilLabTTE.setName("MnCetakHasilLabTTE"); // NOI18N
        MnCetakHasilLabTTE.setPreferredSize(new java.awt.Dimension(100, 26));
        MnCetakHasilLabTTE.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                MnCetakHasilLabTTEActionPerformed(evt);
            }
        });
        MnCetakLab.add(MnCetakHasilLabTTE);
        ...
        MnInputObatBHP.setBackground(new java.awt.Color(255, 255, 254));
        MnInputObatBHP.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        MnInputObatBHP.setForeground(new java.awt.Color(50, 50, 50));
        MnInputObatBHP.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        MnInputObatBHP.setText("Input Alkes/ BHP");
        MnInputObatBHP.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        MnInputObatBHP.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        MnInputObatBHP.setName("MnInputObatBHP"); // NOI18N
        MnInputObatBHP.setPreferredSize(new java.awt.Dimension(190, 26));
        MnInputObatBHP.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                MnInputObatBHPBtnPrintActionPerformed(evt);
            }
        });
        jPopupMenu1.add(MnInputObatBHP);
        ...
        ppKirimWaLabPasien.setText("Kirim WA Lab Pasien");
...
private void tbDokterKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_tbDokterKeyPressed
   if(tabMode.getRowCount()!=0){
    ...
    private void MnInputObatBHPBtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnInputObatBHPBtnPrintActionPerformed
    if(tabMode.getRowCount()==0){
            JOptionPane.showMessageDialog(null,"Maaf, data sudah habis...!!!!");
            TCari.requestFocus();
        }else if(tbDokter.getSelectedRow()<= -1){
            ...
            if(Kd2.getText().equals("")){
                ...
                if(Sequel.cariInteger("select count(no_rawat) from stok_obat_pasien where no_rawat=? ",Kd2.getText())>0){
                    DlgCariObat3 dlgobt=new DlgCariObat3(null,false);
                    dlgobt.setNoRm(Kd2.getText(),kdmem.getText(),nmmem.getText(),new Date());
    ...
    }//GEN-LAST:event_MnInputObatBHPBtnPrintActionPerformed

    private void MnCetakHasilLabTTEActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnCetakHasilLabTTEActionPerformed
        if(tbDokter.getSelectedRow()>-1){
            this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
            FileName=tbDokter.getValueAt(tbDokter.getSelectedRow(),0).toString().replaceAll("/","_")+"LabPk.pdf";
            DlgViewPdfLabPK berkas=new DlgViewPdfLabPK(null,true);
            if(Sequel.cariInteger("select count(no_rawat) from berkas_tte_labpk where no_rawat='"+tbDokter.getValueAt(tbDokter.getSelectedRow(),0).toString()+"'")>0){
                berkas.tampilPdf(FileName,"berkastte/laboratorium");
                berkas.setButton(false);
            }else{
                createPdf(FileName);
                berkas.tampilPdfLocal(FileName,"local","berkastte/laboratorium",tbDokter.getValueAt(tbDokter.getSelectedRow(),0).toString());
            };
    ...
    }//GEN-LAST:event_MnCetakHasilLabTTEActionPerformed
    ...
    private void ppUploadPDFBtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ppUploadPDFBtnPrintActionPerformed
        FileName = "LAB_" + tbDokter.getValueAt(tbDokter.getSelectedRow(), 0).toString().replaceAll("/", "") + "_" + tbDokter.getValueAt(tbDokter.getSelectedRow(), 1).toString().replaceAll("[/()\\-:, ]", "")+"_"+tbDokter.getValueAt(tbDokter.getSelectedRow(), 3).toString();
        CreatePDF(FileName);
    ...
    */
    ...
    private javax.swing.JMenuItem MnCetakHasilLabTTE;
    ...
    private javax.swing.JMenuItem MnInputObatBHP;
                    ...
                    while(rs.next()){
                        ...
                        try {
                            ...
                            if(rspermintaan.next()){
                                ...
                                Valid.MyReportPDFWithName("rptPeriksaLabTTE.jasper","report","tempfile",FileName,"::[ Pemeriksaan Laboratorium ]::",param);   
                            }
                        } catch (Exception e) {
                            System.out.println("Notif : "+e);
                        } finally{
