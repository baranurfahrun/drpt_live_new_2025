...
import bridging.koneksiDBADAMLAB;
...
public class DlgCariPermintaanLab extends javax.swing.JDialog {
    ...
    private Connection koneksiadamlab; 
    ...
    private void initComponents() {
        ...
        TanggalPulang.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "10-03-2024 17:55:16" }));
        ...
        BtnKirimAdamLab.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/item.png"))); // NOI18N
        BtnKirimAdamLab.setText("Kirim Permintaan ke ADAMLAB");
        BtnKirimAdamLab.setFocusPainted(false);
        BtnKirimAdamLab.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        BtnKirimAdamLab.setGlassColor(new java.awt.Color(255, 255, 255));
        BtnKirimAdamLab.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        BtnKirimAdamLab.setMargin(new java.awt.Insets(1, 1, 1, 1));
        BtnKirimAdamLab.setName("BtnKirimAdamLab"); // NOI18N
        BtnKirimAdamLab.setPreferredSize(new java.awt.Dimension(190, 23));
        BtnKirimAdamLab.setRoundRect(false);
        BtnKirimAdamLab.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnKirimAdamLabActionPerformed(evt);
            }
        });
        FormMenu.add(BtnKirimAdamLab);

        BtnAmbilAdamLab.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/item.png"))); // NOI18N
        BtnAmbilAdamLab.setText("Ambil Hasil dari ADAMLAB");
        BtnAmbilAdamLab.setFocusPainted(false);
        BtnAmbilAdamLab.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        BtnAmbilAdamLab.setGlassColor(new java.awt.Color(255, 255, 255));
        BtnAmbilAdamLab.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        BtnAmbilAdamLab.setMargin(new java.awt.Insets(1, 1, 1, 1));
        BtnAmbilAdamLab.setName("BtnAmbilAdamLab"); // NOI18N
        BtnAmbilAdamLab.setPreferredSize(new java.awt.Dimension(190, 23));
        BtnAmbilAdamLab.setRoundRect(false);
        BtnAmbilAdamLab.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnAmbilAdamLabActionPerformed(evt);
            }
        });
        FormMenu.add(BtnAmbilAdamLab);

        BtnInputAlkesBHP.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/item.png"))); // NOI18N
        BtnInputAlkesBHP.setText("Input Alkes/ BHP");
        BtnInputAlkesBHP.setFocusPainted(false);
        BtnInputAlkesBHP.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        BtnInputAlkesBHP.setGlassColor(new java.awt.Color(255, 255, 255));
        BtnInputAlkesBHP.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        BtnInputAlkesBHP.setMargin(new java.awt.Insets(1, 1, 1, 1));
        BtnInputAlkesBHP.setName("BtnInputAlkesBHP"); // NOI18N
        BtnInputAlkesBHP.setPreferredSize(new java.awt.Dimension(190, 23));
        BtnInputAlkesBHP.setRoundRect(false);
        BtnInputAlkesBHP.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnInputAlkesBHPActionPerformed(evt);
            }
        });
        FormMenu.add(BtnInputAlkesBHP);
...
if(TabPilihRawat.getSelectedIndex()==0){
            ...
            if(!NoRawat.equals("")){
                ...
                if(NoPermintaan.trim().equals("")||DiagnosaKlinis.trim().equals("")){
                    ...
                    param.put("diagnosa",DiagnosaKlinis);
                //    param.put("namakamar",namakamar);
                    param.put("namakamar",tbLabRanap.getValueAt(tbLabRanap.getSelectedRow(), 11).toString());
                    param.put("jam",JamPermintaan);
                    param.put("namars",akses.getnamars());
                    param.put("alamatrs",akses.getalamatrs());
                    param.put("kotars",akses.getkabupatenrs());
    ...
    private void BtnKirimAdamLabActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnKirimAdamLabActionPerformed
        if(TabPilihRawat.getSelectedIndex()==0){
            if(TabRawatJalan.getSelectedIndex()==0){
                if(!NoRawat.equals("")){
                    if(NoPermintaan.trim().equals("")||DiagnosaKlinis.trim().equals("")){
    ...
    }//GEN-LAST:event_BtnKirimAdamLabActionPerformed

    private void BtnAmbilAdamLabActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnAmbilAdamLabActionPerformed
      if(TabPilihRawat.getSelectedIndex()==0){
            if(TabRawatJalan.getSelectedIndex()==0){
                if(!NoRawat.equals("")){
                    if(NoPermintaan.trim().equals("")||DiagnosaKlinis.trim().equals("")){
    ...
    }//GEN-LAST:event_BtnAmbilAdamLabActionPerformed
        ...
        if(TabPilihRawat.getSelectedIndex()==0){
            if(!NoRawat.equals("")){
                ...
                if(NoPermintaan.trim().equals("")||DiagnosaKlinis.trim().equals("")){
                    ...
                    try {
                        koneksiadamlab=koneksiDBADAMLAB.condb();
                        ps=koneksi.prepareStatement(
                            "select permintaan_lab.noorder,permintaan_lab.no_rawat,reg_periksa.no_rkm_medis,pasien.nm_pasien,permintaan_lab.tgl_permintaan,pasien.tgl_lahir,"+
                            "permintaan_lab.jam_permintaan,pasien.alamat,kelurahan.nm_kel,kecamatan.nm_kec,kabupaten.nm_kab,propinsi.nm_prop,pasien.email,"+
                            "pasien.jk,permintaan_lab.dokter_perujuk,dokter.nm_dokter,reg_periksa.kd_poli,pasien.tmp_lahir,permintaan_lab.status,"+
                        ...
                        try {
                            ...
                            rs=ps.executeQuery();
                            if(rs.next()){
                                koneksiadamlab.prepareStatement(
                                ...
                                try {
                                    ...
                                    rs2=ps2.executeQuery();
                                    while(rs2.next()){
                                        koneksiadamlab.prepareStatement("insert into tindakan values('"+rs2.getString("noorder")+"','"+rs2.getString("kd_jenis_prw")+"','"+rs2.getString("nm_perawatan")+"')").executeUpdate();
                                    }
                                } catch (Exception e) {
                                    System.out.println("Notif : "+e);
                                } finally{
    ...
    private void BtnInputAlkesBHPActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnInputAlkesBHPActionPerformed
    if(tabMode.getRowCount()==0){
            JOptionPane.showMessageDialog(null,"Maaf, data sudah habis...!!!!");
            TCari.requestFocus();
        }else if(tbLabRalan.getSelectedRow()<= -1){
            ...
            if(NoRawat.equals("")){
                ...
                if(Sequel.cariInteger("select count(no_rawat) from stok_obat_pasien where no_rawat=? ",NoRawat)>0){
                    ...
                    dlgobt.setNoRm(NoRawat,norm,Sequel.cariIsi("select pasien.nm_pasien from pasien where pasien.no_rkm_medis=?",norm),new Date());
    ...
    }//GEN-LAST:event_BtnInputAlkesBHPActionPerformed
    ...
    */
    ...
    private widget.Button BtnAmbilAdamLab;
    ...
    private widget.Button BtnInputAlkesBHP;
    private widget.Button BtnKeluar;
    private widget.Button BtnKirim;
    private widget.Button BtnKirimAdamLab;
        ...
        ActionListener taskPerformer = (ActionEvent e) -> {
            if(aktif==true){
                ...
                if(detik.equals("05")){
                    ...
                    if(permintaanbaru>0){
                        try {
                            music = new BackgroundMusic("./suara/pk.mp3");
                            music.start();
                        } catch (Exception ex) {
