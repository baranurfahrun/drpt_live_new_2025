...
public class DlgPermintaanKonsultasiMedik extends javax.swing.JDialog {
            ...
            public void windowClosed(WindowEvent e) {
                ...
                if (dokter.getTable().getSelectedRow() != -1) {
                    if (i == 1) {
                        ...
                        Object hp = dokter.getTable().getValueAt(dokter.getTable().getSelectedRow(), 8);
                        NoHapeWa = (hp == null) ? "" : hp.toString().trim();
                        if (NoHapeWa.equals("0")) {
                            NoHapeWa = "";    
                        }
                        if (NoHapeWa.startsWith("0")) {
                            NoHapeWa = "62" + NoHapeWa.substring(1);
                        }
    ...
    private void initComponents() {
        ...
        BtnRiwayatKonsul = new widget.Button();
        BtnKonsulJawab = new widget.Button();
        BtnDocumentKonsul = new widget.Button();
        ...
        NoPermintaanJawaban.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                NoPermintaanJawabanActionPerformed(evt);
            }
        });
        ...
        NoPermintaan.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                NoPermintaanActionPerformed(evt);
            }
        });
        ...
        BtnRiwayatKonsul.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/preview-16x16.png"))); // NOI18N
        BtnRiwayatKonsul.setMnemonic('4');
        BtnRiwayatKonsul.setText("Riwayat Perawatan");
        BtnRiwayatKonsul.setToolTipText("");
        BtnRiwayatKonsul.setGlassColor(new java.awt.Color(255, 255, 255));
        BtnRiwayatKonsul.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        BtnRiwayatKonsul.setName("BtnRiwayatKonsul"); // NOI18N
        BtnRiwayatKonsul.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnRiwayatKonsulActionPerformed(evt);
            }
        });
        FormInput.add(BtnRiwayatKonsul);
        BtnRiwayatKonsul.setBounds(660, 220, 140, 30);

        BtnKonsulJawab.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/mail_receive.png"))); // NOI18N
        BtnKonsulJawab.setMnemonic('4');
        BtnKonsulJawab.setText("Jawaban Konsul");
        BtnKonsulJawab.setToolTipText("");
        BtnKonsulJawab.setGlassColor(new java.awt.Color(255, 255, 255));
        BtnKonsulJawab.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        BtnKonsulJawab.setName("BtnKonsulJawab"); // NOI18N
        BtnKonsulJawab.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnKonsulJawabActionPerformed(evt);
            }
        });
        FormInput.add(BtnKonsulJawab);
        BtnKonsulJawab.setBounds(800, 220, 140, 30);

        BtnDocumentKonsul.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/file-edit-16x16.png"))); // NOI18N
        BtnDocumentKonsul.setMnemonic('4');
        BtnDocumentKonsul.setText("Documentasi Konsul");
        BtnDocumentKonsul.setToolTipText("");
        BtnDocumentKonsul.setGlassColor(new java.awt.Color(255, 255, 255));
        BtnDocumentKonsul.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        BtnDocumentKonsul.setName("BtnDocumentKonsul"); // NOI18N
        BtnDocumentKonsul.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnDocumentKonsulActionPerformed(evt);
            }
        });
        FormInput.add(BtnDocumentKonsul);
        BtnDocumentKonsul.setBounds(940, 220, 150, 30);
...
// bara
    ...
    private String getNoWaDokter(String kdDokter) {
        String no = Sequel.cariIsi("select ifnull(no_telp,'') from dokter where kd_dokter=?", kdDokter);
        if (no == null) {
            no = "";
        }
    ...
    private void kirimWa(String nowa, String pesan, String tanggalJam) {
        ...
        try {
            ...
            String sql = "INSERT INTO wa_outbox (NOWA,PESAN,TANGGAL_JAM,STATUS,SOURCE,SENDER,SUCCESS,RESPONSE,REQUEST,TYPE,FILE) "
                    + "VALUES (?,?,?,?,?,?,?,?,?,?,?)";
            psWa = koneksiwa.prepareStatement(sql);
            psWa.setString(1, nowa + "@c.us");
            psWa.setString(2, pesan);
            psWa.setString(3, tanggalJam);
            psWa.setString(4, "ANTRIAN");
            psWa.setString(5, "KHANZA");
            psWa.setString(6, "NODEJS");
            psWa.setString(7, "");
            psWa.setString(8, "");
            psWa.setString(9, "");
            psWa.setString(10, "TEXT");
            psWa.setString(11, "");
            psWa.executeUpdate();
        } catch (Exception e) {
            System.out.println("Notif WA Jawaban : " + e);
            JOptionPane.showMessageDialog(null, "Gagal mengirim WA jawaban: " + e.getMessage());
        } finally {
            try {
                if (psWa != null) {
                    psWa.close();
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        ...
        if (KdDokter.getText().equals(KdDokterDikonsuli.getText())) {
        ...
        if (DiagnosaKerja.getText().trim().equals("")) {
            Valid.textKosong(DiagnosaKerja, "Diagnosa Kerja");
            return;
        }
        if (UraianKonsultasi.getText().trim().equals("")) {
            Valid.textKosong(UraianKonsultasi, "Uraian Konsultasi");
            return;
        }

        // bara
        String tanggalJam = Valid.SetTgl(TanggalPermintaan.getSelectedItem() + "") + " "
        ...
        if (nowa.equals("")) {
            JOptionPane.showMessageDialog(null, "Nomor WA dokter dikonsuli kosong. Pilih dokter yang ada nomor WA-nya.");
            return;
        }
        String headerRs
                = akses.getnamars() + "\n"
                + "\n0xF0 0x9F 0x8F 0xA5 " + akses.getalamatrs() + " " + akses.getkabupatenrs() + " " + akses.getpropinsirs()
                + "\n0xF0 0x9F 0x93 0xB1 " + akses.getkontakrs()
        ...
        String pesan
                ...
                + "No.Permintaan : " + NoPermintaan.getText() + "\n"
                + "No.Rawat      : " + NoRw.getText() + "\n"
                + "Pasien        : *" + NmPasien.getText() + " (" + NoRM.getText() + ")*\n"
                + "Tanggal       : " + TanggalPermintaan.getSelectedItem() + "\n"
                + "Permintaan    : " + Permintaan.getSelectedItem().toString() + "\n"
                + "Dokter Konsul : " + NmDokter.getText() + " [" + KdDokter.getText() + "]\n"
                + "Dikonsuli     : " + NmDokterDikonsuli.getText() + " [" + KdDokterDikonsuli.getText() + "]\n"
                + "Diagnosa Kerja: *" + DiagnosaKerja.getText() + "*\n"
                + "*Uraian Konsultasi:*\n" + UraianKonsultasi.getText();
        PreparedStatement psWa = null;
        try {
            koneksiwa = koneksiDBWa.condb();
            ...
            System.out.println("Notif WA : " + e);
            JOptionPane.showMessageDialog(null, "Gagal mengirim WA: " + e.getMessage());
            return;
        } finally {
            try {
                if (psWa != null) {
        ...
        if (Sequel.menyimpantf(
                ...
                new String[]{
                    ...
                    DiagnosaKerja.getText(),
                    UraianKonsultasi.getText()
                }
        ) == true) {

            JOptionPane.showMessageDialog(null, "Pesan terkirim dan data tersimpan.");
            R1.setSelected(true);
            tampil();
            emptTeks();
        } else {
            JOptionPane.showMessageDialog(null, "Pesan WA sudah terkirim, namun simpan data konsultasi gagal.");
        }
...
private void ChkInputActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ChkInputActionPerformed
    ...
    private void BtnSimpanJawabanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanJawabanActionPerformed
        ...
        if (JawabanDiagnosaKerja.getText().trim().equals("")) {
            Valid.textKosong(JawabanDiagnosaKerja, "Jawaban Diagnosa Kerja");
            return;
        }
        if (NoPermintaanJawaban.getText().trim().equals("")) {
            Valid.textKosong(NoPermintaanJawaban, "No.Permintaan dijawab");
            return;
        }
        if (JawabanKonsultasi.getText().trim().equals("")) {
        ...
        String tanggalJamJawab = Valid.SetTgl(TanggalJawab.getSelectedItem() + "") + " "
                + TanggalJawab.getSelectedItem().toString().substring(11, 19);
        boolean ok;
        String ada = Sequel.cariIsi(
                "select no_permintaan from jawaban_konsultasi_medik where no_permintaan=?",
                NoPermintaan.getText()
        );
        ...
        if (ada.equals("")) {
            ok = Sequel.menyimpantf(
                    ...
                    new String[]{
                        NoPermintaan.getText(),
                        tanggalJamJawab,
                        JawabanDiagnosaKerja.getText(),
                        JawabanKonsultasi.getText()
                    }
            );
        } else {
            ok = Sequel.mengedittf(
                    "jawaban_konsultasi_medik",
                    "no_permintaan=?",
                    "tanggal=?,diagnosa_kerja=?,uraian_jawaban=?",
                    4,
                    new String[]{
                        tanggalJamJawab,
                        JawabanDiagnosaKerja.getText(),
        ...
        if (ok) {
            String nowaKonsul = getNoWaDokter(KdDokter.getText());
            if (nowaKonsul != null && !nowaKonsul.isEmpty()) {
                String pesanJawaban
                        = "*" + akses.getnamars() + "*\n"
                        + akses.getalamatrs() + "\n"
                        + akses.getkontakrs() +  "\n"
                        + "===========================================\n"
                        + "*JAWABAN KONSULTASI MEDIK*\n"
                        + "No.Permintaan : " + NoPermintaan.getText() + "\n"
                        + "Tanggal Jawab : " + tanggalJamJawab + "\n"
                        + "Peminta       : " + NmDokter.getText() + "\n"
                        + "Dikonsuli     : " + NmDokterDikonsuli.getText() + "\n"
                        + "-------------------------------------------\n"
                        + "*Diagnosa Kerja (Jawaban):*\n" + JawabanDiagnosaKerja.getText() + "\n\n"
                        + "*Uraian Jawaban:*\n" + JawabanKonsultasi.getText() + "\n"
                        + "===========================================";
                kirimWa(nowaKonsul, pesanJawaban, tanggalJamJawab);
            } else {
                JOptionPane.showMessageDialog(null, "Nomor WA dokter peminta kosong, WA tidak dikirim.");
            }
            JOptionPane.showMessageDialog(null, "Jawaban tersimpan & WA terkirim.");
            R2.setSelected(true);
            tampil();
            emptTeks();
            WindowInput.dispose();
    ...
    private void BtnRiwayatKonsulActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnRiwayatKonsulActionPerformed
        if (tabMode.getRowCount() == 0) {
            JOptionPane.showMessageDialog(null, "Maaf, table masih kosong...!!!!");
            TCari.requestFocus();
        } else {
    ...
    }//GEN-LAST:event_BtnRiwayatKonsulActionPerformed

    private void BtnKonsulJawabActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnKonsulJawabActionPerformed
        if (tabMode.getRowCount() == 0) {
            JOptionPane.showMessageDialog(null, "Maaf, table masih kosong...!!!!");
            TCari.requestFocus();
        } else {
    ...
    }//GEN-LAST:event_BtnKonsulJawabActionPerformed

    private void BtnDocumentKonsulActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnDocumentKonsulActionPerformed
        if (tabMode.getRowCount() == 0) {
            JOptionPane.showMessageDialog(null, "Maaf, table masih kosong...!!!!");
            TCari.requestFocus();
        } else {
    ...
    }//GEN-LAST:event_BtnDocumentKonsulActionPerformed

    private void NoPermintaanJawabanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_NoPermintaanJawabanActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_NoPermintaanJawabanActionPerformed
    ...
    private void NoPermintaanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_NoPermintaanActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_NoPermintaanActionPerformed
    ...
    private widget.Button BtnDocumentKonsul;
    ...
    private widget.Button BtnKonsulJawab;
    private widget.Button BtnPrint;
    private widget.Button BtnRiwayatKonsul;
