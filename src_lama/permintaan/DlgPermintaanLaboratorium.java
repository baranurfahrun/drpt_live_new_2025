...
public final class DlgPermintaanLaboratorium extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        panelGlass11.setPreferredSize(new java.awt.Dimension(44, 450));
        ...
        BtnCari2.setBounds(1230, 10, 28, 23);
        ...
        Scroll1.setPreferredSize(new java.awt.Dimension(452, 450));
        ...
        Scroll.setBounds(790, 32, 580, 390);
        ...
        TanggalPA.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "22-07-2025" }));
        ...
        TanggalBahan.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "22-07-2025" }));
...
private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
    ...
    // bara
    private void tbTarifPKMouseClicked(java.awt.event.MouseEvent evt) {
        if (tabMode2.getRowCount() != 0) {
            try {
                Valid.tabelKosong(tabMode);
                tampil();

                // Opsional: berikan pilihan kepada user
                int pilihan = JOptionPane.showConfirmDialog(this,
                        "Apakah Anda ingin memilih semua pemeriksaan?",
                        "Konfirmasi",
