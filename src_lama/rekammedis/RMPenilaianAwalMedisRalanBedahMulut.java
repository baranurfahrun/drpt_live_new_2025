...
public final class RMPenilaianAwalMedisRalanBedahMulut extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        TglAsuhan.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "24-01-2024 04:49:42" }));
        ...
        BtnAmbilDataKeperawatan.setText("Ambil data Awal Keperawatan Gigi");
    ...
    private void BtnAmbilDataKeperawatanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnAmbilDataKeperawatanActionPerformed
        try {
            ps = koneksi.prepareStatement(
                "SELECT penilaian_awal_keperawatan_gigi.td, penilaian_awal_keperawatan_gigi.nadi, penilaian_awal_keperawatan_gigi.rr, "
                + "penilaian_awal_keperawatan_gigi.suhu, penilaian_awal_keperawatan_gigi.bb, penilaian_awal_keperawatan_gigi.tb, "
                + "penilaian_awal_keperawatan_gigi.keluhan_utama, penilaian_awal_keperawatan_gigi.riwayat_penyakit, "
                + "penilaian_awal_keperawatan_gigi.ket_riwayat_penyakit, penilaian_awal_keperawatan_gigi.alergi, "
                + "penilaian_awal_keperawatan_gigi.riwayat_perawatan_gigi, penilaian_awal_keperawatan_gigi.ket_riwayat_perawatan_gigi, "
                + "penilaian_awal_keperawatan_gigi.obat_yang_diminum_saatini FROM penilaian_awal_keperawatan_gigi where "
                + "penilaian_awal_keperawatan_gigi.no_rawat = ?");
            ...
            try {
                ...
                while (rs.next()) {
                    ...
                    RPS.setText(rs.getString("riwayat_penyakit"));
    ...
    */
    ...
    private void isRawat() {
        ...
        if(Sequel.cariInteger("select count(no_rawat) from penilaian_awal_keperawatan_gigi where no_rawat='"+TNoRw.getText()+"' ")>0){ 
            Suhu.setText(Sequel.cariIsi("select suhu from penilaian_awal_keperawatan_gigi where no_rawat=?",TNoRw.getText())); 
            TD.setText(Sequel.cariIsi("select td from penilaian_awal_keperawatan_gigi where no_rawat=?",TNoRw.getText())); 
            BB.setText(Sequel.cariIsi("select bb from penilaian_awal_keperawatan_gigi where no_rawat=?",TNoRw.getText())); 
            TB.setText(Sequel.cariIsi("select tb from penilaian_awal_keperawatan_gigi where no_rawat=?",TNoRw.getText())); 
            Nadi.setText(Sequel.cariIsi("select nadi from penilaian_awal_keperawatan_gigi where no_rawat=?",TNoRw.getText())); 
            RR.setText(Sequel.cariIsi("select rr from penilaian_awal_keperawatan_gigi where no_rawat=?",TNoRw.getText())); 
            KeluhanUtama.setText(Sequel.cariIsi("select keluhan_utama from penilaian_awal_keperawatan_gigi where no_rawat=?",TNoRw.getText())); 
            RPK.setText(Sequel.cariIsi("select riwayat_penyakit from penilaian_awal_keperawatan_gigi where no_rawat=?",TNoRw.getText())); 
            Alergi.setText(Sequel.cariIsi("select alergi from penilaian_awal_keperawatan_gigi where no_rawat=?",TNoRw.getText())); 
        }
