    ...
    public RMHasilPemeriksaanEcho(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null, new Object[]{
          ...
          @Override public boolean isCellEditable(int rowIndex, int colIndex){return false;}
            ...
            "F Sistolik LV", "F Diastolic LV", "Kontraktilitas RV", "Dimensi Ruang Jantung",
            "Hipertrofi Ventrikel Kiri", "Analisa Segmental", "eRAP",
            "Mitral", "Tricuspid", "Aorta", "Pulmonal", "Lain-lain", "Kesimpulan"
        }) {
            @Override
        ...
        // TAMBAHKAN: Setup Custom Header Renderer untuk Grouped Header
        setupCustomHeaderRenderer();

        // Setup column widths untuk 20 kolom (bukan 21)
        for (i = 0; i < 20; i++) {
            ...
            if (i == 0) {
                ...
                column.setPreferredWidth(120); // F Sistolik LV
            } else if (i == 8) {
                column.setPreferredWidth(120); // F Diastolic LV
            } else if (i == 9) {
                column.setPreferredWidth(130); // Kontraktilitas RV
            } else if (i == 10) {
                column.setPreferredWidth(140); // Dimensi Ruang Jantung
            } else if (i == 11) {
                column.setPreferredWidth(150); // Hipertrofi Ventrikel Kiri
            } else if (i == 12) {
                column.setPreferredWidth(130); // Analisa Segmental
            } else if (i == 13) {
                column.setPreferredWidth(70);  // eRAP
            } else if (i == 14) {
                column.setPreferredWidth(80);  // Mitral (Grup Katup)
            } else if (i == 15) {
                column.setPreferredWidth(80);  // Tricuspid (Grup Katup)
            } else if (i == 16) {
                column.setPreferredWidth(80);  // Aorta (Grup Katup)
            } else if (i == 17) {
                column.setPreferredWidth(80);  // Pulmonal (Grup Katup)
            } else if (i == 18) {
...
// TAMBAHKAN METHOD INI SETELAH CONSTRUCTOR:
        ...
        tbObat.getTableHeader().setDefaultRenderer(new javax.swing.table.DefaultTableCellRenderer() {
            ...
            public java.awt.Component getTableCellRendererComponent(
                ...
                switch (column) {
                    ...
                    case 18:
                    case 19:
                        // Kolom terakhir - tampilkan nama kolom biasa
                        headerText = "<html><center><b>" + value.toString() + "</b></center></html>";
                        break;
                    default:
                        headerText = "<html><center><b>" + value.toString() + "</b></center></html>";
    ...
    private void initComponents() {
        ...
        Tanggal.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "01-08-2025 15:08:23" }));
        ...
        jLabel41.setBounds(0, 370, 135, 23);
        ...
        AnalisaSegmental.setBounds(140, 370, 585, 23);
        ...
        jLabel44.setBounds(0, 460, 135, 23);
        ...
        jLabel46.setBounds(0, 430, 135, 23);
        ...
        LainLain.setBounds(140, 430, 585, 23);

        jLabel47.setText("Hipertrofi Ventrikel Kiri :");
        jLabel47.setName("jLabel47"); // NOI18N
        jLabel47.setPreferredSize(new java.awt.Dimension(68, 14));
        FormInput.add(jLabel47);
        jLabel47.setBounds(0, 200, 135, 23);
        ...
        Pulmonal.setBounds(180, 340, 550, 23);
        ...
        if (tabMode.getRowCount() == 0) {
            ...
            try {
                ...
                htmlContent.append(
                        ...
                        + "<td valign='middle' bgcolor='#FFFAF8' align='center'><b>Nama Dokter</b></td>"
                        + "<td valign='middle' bgcolor='#FFFAF8' align='center'><b>Tanggal</b></td>"
                        + "<td valign='middle' bgcolor='#FFFAF8' align='center'><b>F Sistolik LV</b></td>"
                        + "<td valign='middle' bgcolor='#FFFAF8' align='center'><b>F Diastolic LV</b></td>"
                        + "<td valign='middle' bgcolor='#FFFAF8' align='center'><b>Kontraktilitas RV</b></td>"
                        + "<td valign='middle' bgcolor='#FFFAF8' align='center'><b>Dimensi Ruang Jantung</b></td>"
                        + "<td valign='middle' bgcolor='#FFFAF8' align='center'><b>Hipertrofi Ventrikel Kiri</b></td>"
                        + "<td valign='middle' bgcolor='#FFFAF8' align='center'><b>Analisa Segmental</b></td>"
                ...
                for (i = 0; i < tabMode.getRowCount(); i++) {
                    htmlContent.append(
                            ...
                            // TAMBAHAN - 5 data kolom baru: bara
                            + "<td valign='top'>" + tbObat.getValueAt(i, 14).toString() + "</td>"
                            + "<td valign='top'>" + tbObat.getValueAt(i, 15).toString() + "</td>"
        ...
        this.setCursor(Cursor.getDefaultCursor());
                ...
                for (i = 0; i < tabMode.getRowCount(); i++) {
                    htmlContent.append(
                            ...
                            + "<td valign='top'>" + tbObat.getValueAt(i, 7).toString() + "</td>" // F Sistolik LV
                            + "<td valign='top'>" + tbObat.getValueAt(i, 8).toString() + "</td>" // F Diastolic LV
                            + "<td valign='top'>" + tbObat.getValueAt(i, 9).toString() + "</td>" // Kontraktilitas RV
                            + "<td valign='top'>" + tbObat.getValueAt(i, 10).toString() + "</td>" // Dimensi Ruang Jantung
                            + "<td valign='top'>" + tbObat.getValueAt(i, 11).toString() + "</td>" // Hipertrofi Ventrikel Kiri
                            + "<td valign='top'>" + tbObat.getValueAt(i, 12).toString() + "</td>" // Analisa Segmental
                            + "<td valign='top'>" + tbObat.getValueAt(i, 13).toString() + "</td>" // eRAP
                            + "<td valign='top'>" + tbObat.getValueAt(i, 14).toString() + "</td>" // Mitral
                            + "<td valign='top'>" + tbObat.getValueAt(i, 15).toString() + "</td>" // Tricuspid
                            + "<td valign='top'>" + tbObat.getValueAt(i, 16).toString() + "</td>" // Aorta
                            + "<td valign='top'>" + tbObat.getValueAt(i, 17).toString() + "</td>" // Pulmonal
                            + "<td valign='top'>" + tbObat.getValueAt(i, 18).toString() + "</td>" // Lain-lain
                            + "<td valign='top'>" + tbObat.getValueAt(i, 19).toString() + "</td>" // Kesimpulan
                            + "</tr>");
                }
    ...
    private void MnPenilaianMedisActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnPenilaianMedisActionPerformed
        ...
        if (tbObat.getSelectedRow() > -1) {
            ...
            // PERBAIKAN: Query sesuai struktur database yang benar (tanpa field 'katup')
            Valid.MyReportqry("rptCetakHasilPemeriksaanECHO.jasper", "report", "::[ Formulir Hasil Pemeriksaan ECHOCARDIOGRAFI ]::",
                    "select reg_periksa.no_rawat,pasien.no_rkm_medis,pasien.nm_pasien,pasien.tgl_lahir,hasil_pemeriksaan_echo.tanggal,"
                    + "hasil_pemeriksaan_echo.kd_dokter,dokter.nm_dokter,"
                    + "hasil_pemeriksaan_echo.sistolik,hasil_pemeriksaan_echo.diastolic,hasil_pemeriksaan_echo.kontraktilitas,hasil_pemeriksaan_echo.dimensi_ruang,"
                    + "hasil_pemeriksaan_echo.analisa_segmental,hasil_pemeriksaan_echo.erap,"
                    // SESUAIKAN: Field baru sesuai struktur database
                    + "hasil_pemeriksaan_echo.hipertrofi_ventrikel_kiri,hasil_pemeriksaan_echo.mitral,"
                    + "hasil_pemeriksaan_echo.tricuspid,hasil_pemeriksaan_echo.aorta,hasil_pemeriksaan_echo.pulmonal,"
                    + "hasil_pemeriksaan_echo.lain_lain,hasil_pemeriksaan_echo.kesimpulan "
                    + "from reg_periksa inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "
    ...
    public void tampil() {
        ...
        try {
            String sql = "select reg_periksa.no_rawat,pasien.no_rkm_medis,pasien.nm_pasien,pasien.tgl_lahir,"
                    ...
                    + "hasil_pemeriksaan_echo.sistolik,hasil_pemeriksaan_echo.diastolic,"
                    + "hasil_pemeriksaan_echo.kontraktilitas,hasil_pemeriksaan_echo.dimensi_ruang,"
                    + "COALESCE(hasil_pemeriksaan_echo.hipertrofi_ventrikel_kiri,'') as hipertrofi_ventrikel_kiri,"
                    + "hasil_pemeriksaan_echo.analisa_segmental,hasil_pemeriksaan_echo.erap,"
                    + "COALESCE(hasil_pemeriksaan_echo.mitral,'') as mitral,"
                    + "COALESCE(hasil_pemeriksaan_echo.tricuspid,'') as tricuspid,"
                    + "COALESCE(hasil_pemeriksaan_echo.aorta,'') as aorta,"
                    + "COALESCE(hasil_pemeriksaan_echo.pulmonal,'') as pulmonal,"
                    + "hasil_pemeriksaan_echo.lain_lain,hasil_pemeriksaan_echo.kesimpulan "
                    + "from reg_periksa inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "
                    + "inner join hasil_pemeriksaan_echo on reg_periksa.no_rawat=hasil_pemeriksaan_echo.no_rawat "
                    + "inner join dokter on hasil_pemeriksaan_echo.kd_dokter=dokter.kd_dokter where "
                    + "hasil_pemeriksaan_echo.tanggal between ? and ?";

            if (!TCari.getText().trim().equals("")) {
                sql += " and (reg_periksa.no_rawat like ? or pasien.no_rkm_medis like ? or pasien.nm_pasien like ? or "
                        + "hasil_pemeriksaan_echo.kd_dokter like ? or dokter.nm_dokter like ?)";
            }
            sql += " order by hasil_pemeriksaan_echo.tanggal";
            ...
            while (rs.next()) {
                tabMode.addRow(new Object[]{
                    ...
                    // Kolom 7-10: Pemeriksaan Individual
                    rs.getString("sistolik"), // 7
                    rs.getString("diastolic"), // 8
                    rs.getString("kontraktilitas"), // 9
                    rs.getString("dimensi_ruang"), // 10

                    // Kolom 11-13: Field Tambahan
                    rs.getString("hipertrofi_ventrikel_kiri"), // 11
                    rs.getString("analisa_segmental"), // 12
                    rs.getString("erap"), // 13

                    // Kolom 14-17: Grup Katup-katup Jantung
                    rs.getString("mitral"), // 14
                    rs.getString("tricuspid"), // 15
                    rs.getString("aorta"), // 16
                    rs.getString("pulmonal"), // 17

                    // Kolom 18-19: Lain-lain & Kesimpulan
                    rs.getString("lain_lain"), // 18
                    rs.getString("kesimpulan") // 19
                });
            }
        } catch (Exception e) {
            System.out.println("Notifikasi : " + e);
...
// SEKALIGUS UPDATE METHOD getData() UNTUK SESUAI URUTAN KOLOM: // bara
    private void getData() {
        if (tbObat.getSelectedRow() != -1) {
            ...
            // Kolom 7-10: Pemeriksaan Individual
            Sistolik.setText(tbObat.getValueAt(row, 7).toString());
            Diastolik.setText(tbObat.getValueAt(row, 8).toString());
            Kontraktilitas.setText(tbObat.getValueAt(row, 9).toString());
            Dimensi.setText(tbObat.getValueAt(row, 10).toString());

            // Kolom 11-13: Field Tambahan
            HipertrofiVentrikelKiri.setText(tbObat.getValueAt(row, 11).toString());
            AnalisaSegmental.setText(tbObat.getValueAt(row, 12).toString());
            Erap.setText(tbObat.getValueAt(row, 13).toString());

            // Kolom 14-17: Grup Katup-katup Jantung
            Mitral.setText(tbObat.getValueAt(row, 14).toString());
            Tricuspid.setText(tbObat.getValueAt(row, 15).toString());
            Aorta.setText(tbObat.getValueAt(row, 16).toString());
            Pulmonal.setText(tbObat.getValueAt(row, 17).toString());

            // Kolom 18-19: Lain-lain & Kesimpulan  
            LainLain.setText(tbObat.getValueAt(row, 18).toString());
            Kesimpulan.setText(tbObat.getValueAt(row, 19).toString());
        }
    }

// UPDATE METHOD simpan() SESUAI URUTAN: // bara
    private void simpan() {
        if (Sequel.menyimpantf("hasil_pemeriksaan_echo",
                "?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?", "No.Rawat", 16, new String[]{
                    // Urutan sesuai CREATE TABLE struktur database
                    ...
                    Sistolik.getText(), // sistolik
                    Diastolik.getText(), // diastolic
                    Kontraktilitas.getText(), // kontraktilitas
                    Dimensi.getText(), // dimensi_ruang
                    AnalisaSegmental.getText(), // analisa_segmental
                    Erap.getText(), // erap
                    LainLain.getText(), // lain_lain
                    Kesimpulan.getText(), // kesimpulan
                    HipertrofiVentrikelKiri.getText(), // hipertrofi_ventrikel_kiri
            ...
            // Tambah ke tabel display (20 kolom)
            tabMode.addRow(new Object[]{
                ...
                Dimensi.getText(), HipertrofiVentrikelKiri.getText(),
...
//        Katup.setText("");
     ...
     */
// ALTERNATIF: Jika masih ada data lama dengan katup gabungan, gunakan ini:
    private void getDataWithBackwardCompatibility() {
        if (tbObat.getSelectedRow() != -1) {
            ...
            // Kolom 14-17: Grup Katup-katup Jantung
            // Cek apakah data katup terpisah sudah ada
            String mitralData = tbObat.getValueAt(row, 14).toString();
            String tricuspidData = tbObat.getValueAt(row, 15).toString();
            String aortaData = tbObat.getValueAt(row, 16).toString();
            String pulmonalData = tbObat.getValueAt(row, 17).toString();

            // Jika semua field katup kosong, coba cek data lama (jika masih ada kolom katup gabungan)
            if (mitralData.isEmpty() && tricuspidData.isEmpty()
                    && aortaData.isEmpty() && pulmonalData.isEmpty()) {

                // Cek apakah ada data katup gabungan (backward compatibility)
                // Ini hanya jika Anda masih punya data lama dalam format gabungan
                try {
                    // Asumsi: cari di database langsung untuk data katup lama
                    String katupLama = Sequel.cariIsi(
                            "SELECT katup FROM hasil_pemeriksaan_echo WHERE no_rawat=?",
                            tbObat.getValueAt(row, 0).toString()
                    );

                    if (!katupLama.isEmpty() && katupLama.contains(";")) {
                        String[] katupArray = katupLama.split(";");
                        if (katupArray.length >= 4) {
                            Mitral.setText(katupArray[0].trim());
                            Tricuspid.setText(katupArray[1].trim());
                            Aorta.setText(katupArray[2].trim());
                            Pulmonal.setText(katupArray[3].trim());
                        }
                    } else {
                        // Jika tidak ada data lama, kosongkan
                        Mitral.setText("");
                        Tricuspid.setText("");
                        Aorta.setText("");
                        Pulmonal.setText("");
                ...
                // Gunakan data dari kolom terpisah
                Mitral.setText(mitralData);
                Tricuspid.setText(tricuspidData);
                Aorta.setText(aortaData);
                Pulmonal.setText(pulmonalData);
            }
    ...
    private void ganti() {
        if (Sequel.mengedittf("hasil_pemeriksaan_echo", "no_rawat=?",
                "no_rawat=?,tanggal=?,kd_dokter=?,sistolik=?,diastolic=?,kontraktilitas=?,dimensi_ruang=?,"
                + "analisa_segmental=?,erap=?,lain_lain=?,kesimpulan=?,hipertrofi_ventrikel_kiri=?,mitral=?,tricuspid=?,aorta=?,pulmonal=?",
                16, new String[]{
            ...
            tbObat.setValueAt(Dimensi.getText(), selectedRow, 10);
            tbObat.setValueAt(HipertrofiVentrikelKiri.getText(), selectedRow, 11);
            tbObat.setValueAt(AnalisaSegmental.getText(), selectedRow, 12);
            tbObat.setValueAt(Erap.getText(), selectedRow, 13);
            tbObat.setValueAt(Mitral.getText(), selectedRow, 14);
            tbObat.setValueAt(Tricuspid.getText(), selectedRow, 15);
            tbObat.setValueAt(Aorta.getText(), selectedRow, 16);
            tbObat.setValueAt(Pulmonal.getText(), selectedRow, 17);
            tbObat.setValueAt(LainLain.getText(), selectedRow, 18);
            tbObat.setValueAt(Kesimpulan.getText(), selectedRow, 19);
...
// ALTERNATIF: Jika tidak yakin dengan struktur, gunakan ini untuk debug
    private void gantiWithDebug() {
        ...
        if (Sequel.mengedittf("hasil_pemeriksaan_echo", "no_rawat=?",
                "no_rawat=?,tanggal=?,kd_dokter=?,sistolik=?,diastolic=?,kontraktilitas=?,dimensi_ruang=?,katup=?,"
                + "analisa_segmental=?,erap=?,hipertrofi_ventrikel_kiri=?,mitral=?,tricuspid=?,aorta=?,pulmonal=?,lain_lain=?,kesimpulan=?",
                17, new String[]{
                    TNoRw.getText(),
                    ...
                    Sistolik.getText(),
                    Diastolik.getText(),
                    Kontraktilitas.getText(),
                    Dimensi.getText(),
                    String.join("; ", Mitral.getText(), Tricuspid.getText(), Aorta.getText(), Pulmonal.getText()),
                    AnalisaSegmental.getText(),
                    Erap.getText(),
                    HipertrofiVentrikelKiri.getText(),
                    Mitral.getText(),
                    Tricuspid.getText(),
                    Aorta.getText(),
                    Pulmonal.getText(),
            ...
            try {
                // Update satu per satu dengan debug
                String[] values = {
                    TNoRw.getText(), TNoRM.getText(), TPasien.getText(), TglLahir.getText(),
                    KdDokter.getText(), NmDokter.getText(),
                    Valid.SetTgl(Tanggal.getSelectedItem() + "") + " " + Tanggal.getSelectedItem().toString().substring(11, 19),
                    Sistolik.getText(), Diastolik.getText(), Kontraktilitas.getText(), Dimensi.getText(),
                    HipertrofiVentrikelKiri.getText(), AnalisaSegmental.getText(), Erap.getText(),
                    Mitral.getText(), Tricuspid.getText(), Aorta.getText(), Pulmonal.getText(),
                    LainLain.getText(), Kesimpulan.getText()
                };
    ...
    private void simpanAlternatif() {
        ...
        if (Sequel.menyimpantf("hasil_pemeriksaan_echo",
                "?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?", "No.Rawat", 16, new String[]{
                    ...
                    Kontraktilitas.getText(), // kontraktilitas
                    Dimensi.getText(), // dimensi_ruang
                    // Jika masih ada field katup lama di database
                    String.join("; ", Mitral.getText(), Tricuspid.getText(),
                            Aorta.getText(), Pulmonal.getText()), // katup (gabungan)
                    AnalisaSegmental.getText(), // analisa_segmental
                    Erap.getText(), // erap
                    HipertrofiVentrikelKiri.getText(), // hipertrofi_ventrikel_kiri
                    Mitral.getText(), // mitral
            ...
            // Tambah ke tabel dengan struktur 20 kolom yang benar
            tabMode.addRow(new Object[]{
                TNoRw.getText(), TNoRM.getText(), TPasien.getText(), TglLahir.getText(),
                KdDokter.getText(), NmDokter.getText(),
                Valid.SetTgl(Tanggal.getSelectedItem() + "") + " "
...
// METHOD UNTUK CEK STRUKTUR DATABASE
    private void cekStrukturDatabase() {
        try {
            ...
            ps = koneksi.prepareStatement("DESCRIBE hasil_pemeriksaan_echo");
            rs = ps.executeQuery();
            System.out.println("=== STRUKTUR DATABASE hasil_pemeriksaan_echo ===");
            while (rs.next()) {
