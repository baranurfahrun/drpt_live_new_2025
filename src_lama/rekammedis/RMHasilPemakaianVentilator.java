 ...
 * @author perpustakaan
 */
public final class RMHasilPemakaianVentilator extends javax.swing.JDialog {
     ...
     * @param modal
     */
    public RMHasilPemakaianVentilator(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        internalFrame1.getAccessibleContext().setAccessibleName("::[ Hasil Pemakaian Ventilator ]::");
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            RMHasilPemakaianVentilator dialog = new RMHasilPemakaianVentilator(new javax.swing.JFrame(), true);
