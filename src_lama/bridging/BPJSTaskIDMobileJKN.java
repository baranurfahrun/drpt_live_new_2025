  ...
  //  private  Connection koneksibpjs=koneksiDBBpjs.condb();
    ...
    public BPJSTaskIDMobileJKN(java.awt.Frame parent, boolean modal) {
        ...
        tabMode2 = new DefaultTableModel(null, new String[]{
            "No","Tanggal Registrasi","Kode Booking","Task Id","Petugas","Waktu","Nama","No Rawat","Poli","Respon",
            "Kode Respon","Header","Complete Url Request","Url"
        }){
             @Override public boolean isCellEditable(int rowIndex, int colIndex){return false;}
        };
    ...
    private void initComponents() {
        ...
        TabRawat.addTab("::[ Task ID Mobile JKN ]::", internalFrame1);
        ...
        TabRawat.addTab("::[ Log Add Antrian ]::", internalFrame2);
        ...
        getContentPane().add(panelGlass9, java.awt.BorderLayout.PAGE_END);
...
//            tampil2();
    ...
    */
        ...
        try{
            ...
            try {
                ...
                while(rs.next()){
                    ...
                    //    System.out.println(api.getHmac(utc));
    ...
    public void tampil2(){
        ...
        try {
            ps2=koneksibpjs.prepareStatement("select * from log_add_antrian where log_add_antrian.tgl_registrasi between ? and ? "+
                (TCari.getText().equals("")?"": "and (log_add_antrian.no_rawat like ? or log_add_antrian.kd_booking like ? or log_add_antrian.nama like ?)")+ "order by log_add_antrian.tgl_registrasi");
            ...
            try {
                ...
                while(rs2.next()){
                    tabMode2.addRow(new Object[]{
                        i, rs2.getString("tgl_registrasi"),rs2.getString("kd_booking"),rs2.getString("taskid"),
                        rs2.getString("petugas"),rs2.getString("waktu"),rs2.getString("nama"),rs2.getString("no_rawat"),rs2.getString("poli"),
                        rs2.getString("respon"),rs2.getString("kode_respon"),rs2.getString("header"),rs2.getString("complete_url_request"),rs2.getString("url")
                            });
                        i++;
                    } 
                }catch (Exception ex) {
